...
Процедура ОбработкаВнешнегоСобытия(Источник, Событие, Данные)
	...
	// ИнтеграцияГОСИС
	Если ПараметрыПриложения["ПодключаемоеОборудованиеСобытиеОбработаноДанныеИС"] <> Неопределено
		И ПараметрыПриложения["ПодключаемоеОборудованиеСобытиеОбработаноДанныеИС"][Данные] <> Неопределено Тогда
...
Процедура ОбработкаВыбораШаблонаСообщенияСистемыВзаимодействия(Обсуждение, СтандартнаяОбработка)

#Если МобильныйКлиент Тогда
	Выполнить("МессенджерыКлиент.ОбработкаВыбораШаблонаСообщенияСистемыВзаимодействия(Обсуждение,
		|СтандартнаяОбработка)");
#Иначе
	МессенджерыКлиент.ОбработкаВыбораШаблонаСообщенияСистемыВзаимодействия(Обсуждение, СтандартнаяОбработка);
#КонецЕсли

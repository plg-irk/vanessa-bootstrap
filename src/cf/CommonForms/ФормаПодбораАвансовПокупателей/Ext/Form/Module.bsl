...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Подбор Тогда
		...
		Заголовок = СодержанияПроводок.ВосстановлениеАванса();
	КонецЕсли;
...
Процедура ЗаполнитьАвансы()
	...
	|
	|
	|	СУММА(ВЫБОР КОГДА ЕСТЬNULL(РасчетыСПокупателямиОстатки.СуммаРег, 0) = 0 ИЛИ НЕ &УчетВалютныхОпераций ТОГДА 

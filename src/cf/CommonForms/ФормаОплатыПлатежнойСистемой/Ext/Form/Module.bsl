...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ВидОплаты = Перечисления.СпособыОплатыЭквайринг.ОплатаОнлайн Тогда
	...
	Если НастройкиИнтеграции <> Неопределено Тогда
		...
		Если Не ПереданныеПараметры.ВидОперацииПродажа Тогда
			...
			Если ЗначениеЗаполнено(ПараметрыВозврата.ВидОплатыВозврата) Тогда
				...
				Если ПараметрыВозврата.ВидОплатыВозврата = Перечисления.ВидыБезналичныхОплат.СБП Тогда
...
Процедура ОтменитьОперациюВозврата(ДокументВозврата, Интеграция)
	...
	Если РезультатОперации.СтатусОперации = НастройкиПлатежныхСистемКлиентСервер.СтатусОперацииОтменена() Тогда

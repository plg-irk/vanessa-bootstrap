...
Процедура СоздатьНачисленияОплатыДолейРКиСН() Экспорт
	...
	Запрос.УстановитьПараметр("КатегорииНачисленийИлиНеоплаченногоВремени", КатегорииНачисленийДляВыделенияРКиСН());

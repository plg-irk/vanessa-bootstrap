...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Возврат", ТолькоВозвраты) Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru = 'Расходные накладные: возвраты'");
	...
	Список.Параметры.УстановитьЗначениеПараметра("НеУчитывается", НеУчитывается());
	...
	ИнтеграцияИСМПУНФ.ДобавитьЭлементСостояниеГИСМТПриСоздании(ЭтотОбъект);
...
&НаСервере
Функция ПроверитьКлючевыеРеквизитыДокументовПоступления(Знач МассивДокументов, Знач ТипДокументаПроверки = "Приход")
...
Процедура ЗаполнитьНастройкиДинамическогоСписка(Знач ИмяТаблицы, Знач ИмяКоманды)
	...
	Если ПустаяСтрока(Заголовок) Тогда
		ЗаголовокФормы = НСтр("ru = 'Расходная накладная'");
	Иначе
...
&НаКлиентеНаСервереБезКонтекста
Функция НеУчитывается()
	Возврат НСтр("ru = 'Не учитывается'");
КонецФункции

...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если КурсИКратность.ВыполненаУстановкаКурсаДляКорректировок Тогда
...
Процедура ОбработатьСуммыДоКорректировки()
	...
	ИсправлениеКорректировки = ЗначениеЗаполнено(ИсправляемыйДокументРеализации) И (ТипЗнч(
		ИсправляемыйДокументРеализации) = Тип("ДокументСсылка.КорректировкаРеализации")) И (ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
            ИсправляемыйДокументРеализации, "ВидОперации")
	...
	Если ВидОперации = Перечисления.ВидыОперацийИсправленияПоступленияРеализации.СогласованноеИзменение Тогда
		...
		Предоплата.ЗагрузитьКолонку(Предоплата.ВыгрузитьКолонку("СуммаРасчетовДоИзменения"),
			"СуммаРасчетовДоКорректировки");
		Предоплата.ЗагрузитьКолонку(Предоплата.ВыгрузитьКолонку("СуммаПлатежаДоИзменения"),
			"СуммаПлатежаДоКорректировки");

		ПлатежныйКалендарь.ЗагрузитьКолонку(ПлатежныйКалендарь.ВыгрузитьКолонку("ДатаОплатыДоИзменения"),
			"ДатаОплатыДоКорректировки");
		ПлатежныйКалендарь.ЗагрузитьКолонку(ПлатежныйКалендарь.ВыгрузитьКолонку("ПроцентОплатыДоИзменения"),
			"ПроцентОплатыДоКорректировки");
		ПлатежныйКалендарь.ЗагрузитьКолонку(ПлатежныйКалендарь.ВыгрузитьКолонку("СуммаОплатыДоИзменения"),
			"СуммаОплатыДоКорректировки");
		ПлатежныйКалендарь.ЗагрузитьКолонку(ПлатежныйКалендарь.ВыгрузитьКолонку("СуммаНДСОплатыДоИзменения"),
			"СуммаНДСОплатыДоКорректировки");

		Если ОбщегоНазначения.ЕстьРеквизитОбъекта("СтоимостьДоставки", ИсправляемыйДокументРеализации.Метаданные()) Тогда
			ДанныеДокументаРеализации = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ИсправляемыйДокументРеализации,
				"СтоимостьДоставки, СтавкаНДСДоставки, СуммаНДСДоставки");
        
        //Доставка
			СтоимостьДоставкиДоКорректировки = ДанныеДокументаРеализации.СтоимостьДоставки;
			СтавкаНДСДоставкиДоКорректировки = ДанныеДокументаРеализации.СтавкаНДСДоставки;
			СуммаНДСДоставкиДоКорректировки = ДанныеДокументаРеализации.СуммаНДСДоставки;
	...
	ИначеЕсли Не ИсправлениеКорректировки Тогда
        ...
        //Доставка
		СтоимостьДоставкиДоКорректировки = 0;
		СтавкаНДСДоставкиДоКорректировки = 0;
		СуммаНДСДоставкиДоКорректировки = 0;

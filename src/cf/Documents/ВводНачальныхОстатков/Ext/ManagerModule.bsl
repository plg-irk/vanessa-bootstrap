...
Процедура ИнициализироватьДанныеДокументаЗапасы(ДокументСсылкаВводНачальныхОстатков, СтруктураДополнительныеСвойства)
	...
	|		ВЫБОР
	|			КОГДА
	|				ВводНачальныхОстатковЗапасы.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Склад)
	|			ИЛИ
	|				ВводНачальныхОстатковЗапасы.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Розница)
	...
	|		И ВводНачальныхОстатковЗапасы.Номенклатура.ТипНоменклатуры В (ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас),
	...
	|		ВЫБОР
	|			КОГДА
	|				ВводНачальныхОстатковЗапасыПринятые.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПриходнаяНакладная.ПриемВПереработку)
	...
	|		ВЫБОР
	|			КОГДА
	|				ТИПЗНАЧЕНИЯ(ВводНачальныхОстатковЗапасыПринятые.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|				ТОГДА ВводНачальныхОстатковЗапасыПринятые.Количество
	|			ИНАЧЕ ВводНачальныхОстатковЗапасыПринятые.Количество *
	|				ВводНачальныхОстатковЗапасыПринятые.ЕдиницаИзмерения.Коэффициент
	|		КОНЕЦ,
	|		0,
	|		0,
	|		ЗНАЧЕНИЕ(ВидДвиженияБухгалтерии.Дебет),
	...
	|		И ВводНачальныхОстатковЗапасыПринятые.Номенклатура.ТипНоменклатуры В (ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас),
	|			ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.ПодарочныйСертификат))
	|
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|		ВЫБОР
	|			КОГДА
	|				ТИПЗНАЧЕНИЯ(ВводНачальныхОстатковЗапасыПереданные.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|				ТОГДА ВводНачальныхОстатковЗапасыПереданные.Количество
	|			ИНАЧЕ ВводНачальныхОстатковЗапасыПереданные.Количество *
	|				ВводНачальныхОстатковЗапасыПереданные.ЕдиницаИзмерения.Коэффициент
	|		КОНЕЦ,
	...
	|		И ВводНачальныхОстатковЗапасыПереданные.Номенклатура.ТипНоменклатуры В
	|		(ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас), ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.ПодарочныйСертификат))) КАК
	|		ВводНачальныхОстатковЗапасы
	|
	|УПОРЯДОЧИТЬ ПО
	|	Порядок,
	|	НомерСтроки
	...
	|	ВЫБОР
	|		КОГДА
	|			ВводНачальныхОстатковЗапасыПереданные.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПередачаНаКомиссию)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ТипыПриемаПередачиТоваров.ПередачаКомиссионеру)
	|		КОГДА
	|			ВводНачальныхОстатковЗапасыПереданные.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПередачаВПереработку)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ТипыПриемаПередачиТоваров.ПередачаВПереработку)
	|		КОГДА
	|			ВводНачальныхОстатковЗапасыПереданные.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПередачаНаОтветХранение)
	...
	|	ВЫБОР
	|		КОГДА
	|			ВводНачальныхОстатковЗапасыПринятые.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПриходнаяНакладная.ПриемНаКомиссию)
	...
	|		КОГДА
	|			ВводНачальныхОстатковЗапасыПринятые.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПриходнаяНакладная.ПриемНаОтветХранение)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ТипыПриемаПередачиТоваров.ОтветственноеХранение)
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ТипПриемаПередачи,
	...
	|	ВЫБОР
	|		КОГДА
	|			ТИПЗНАЧЕНИЯ(ВводНачальныхОстатковЗапасыВРазрезеГТД.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|			ТОГДА ВводНачальныхОстатковЗапасыВРазрезеГТД.Количество
	|		ИНАЧЕ ВводНачальныхОстатковЗапасыВРазрезеГТД.Количество *
	|			ВводНачальныхОстатковЗапасыВРазрезеГТД.ЕдиницаИзмерения.Коэффициент
	|	КОНЕЦ КАК Количество
	|ИЗ
	...
	|	И ВводНачальныхОстатковЗапасыВРазрезеГТД.Номенклатура.ТипНоменклатуры В
	|	(ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас), ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.ПодарочныйСертификат))
	...
	|	ВЫБОР
	|		КОГДА
	|			ТИПЗНАЧЕНИЯ(ВводНачальныхОстатковЗапасыПереданныеВРазрезеГТД.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|			ТОГДА ВводНачальныхОстатковЗапасыПереданныеВРазрезеГТД.Количество
	|		ИНАЧЕ ВводНачальныхОстатковЗапасыПереданныеВРазрезеГТД.Количество *
	|			ВводНачальныхОстатковЗапасыПереданныеВРазрезеГТД.ЕдиницаИзмерения.Коэффициент
	|	КОНЕЦ КАК Количество,
	...
	|	И
	|		ВводНачальныхОстатковЗапасыПереданныеВРазрезеГТД.Номенклатура.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас)
	...
	|	ВЫБОР
	|		КОГДА
	|			ТИПЗНАЧЕНИЯ(ВводНачальныхОстатковЗапасыПринятыеВРазрезеГТД.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|			ТОГДА ВводНачальныхОстатковЗапасыПринятыеВРазрезеГТД.Количество
	|		ИНАЧЕ ВводНачальныхОстатковЗапасыПринятыеВРазрезеГТД.Количество *
	|			ВводНачальныхОстатковЗапасыПринятыеВРазрезеГТД.ЕдиницаИзмерения.Коэффициент
	|	КОНЕЦ КАК Количество,
	...
	|	И
	|		ВводНачальныхОстатковЗапасыПринятыеВРазрезеГТД.Номенклатура.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас)
	...
	|	ТаблицаДокумента.Сумма <> 0
	|	И ТаблицаДокумента.Ссылка = &Ссылка
	|	И ТаблицаДокумента.Номенклатура.ТипНоменклатуры В (ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас),
	|		ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.ПодарочныйСертификат))
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|	ВЫБОР
	|		КОГДА
	|			ТаблицаДокумента.Номенклатура.СчетУчетаНДСПоПриобретеннымЦенностям = ЗНАЧЕНИЕ(ПланСчетов.Управленческий.ПустаяСсылка)
	...
	|	И ТаблицаЗапасы.Номенклатура.ТипНоменклатуры В (ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас),
	|		ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.ПодарочныйСертификат))
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|ИЗ
	|	Документ.ВводНачальныхОстатков.ЗапасыВРазрезеГТД КАК ВводНачальныхОстатковЗапасыВРазрезеГТД
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ВводНачальныхОстатков.СведенияПрослеживаемости КАК
	|			ВводНачальныхОстатковСведенияПрослеживаемости
...
Процедура ИнициализироватьДанныеДокументаРасчетыПоЭквайрингу(ДокументСсылкаВводНачальныхОстатков,
	...
	|	СУММА(ВводНачальныхОстатковРасчетыПоЭквайрингу.Сумма) КАК Сумма,
	|	СУММА(ВводНачальныхОстатковРасчетыПоЭквайрингу.Комиссия) КАК Комиссия,
	|	&РасчетыПоЭквайрингу КАК СодержаниеПроводки,
	|	СУММА(ВводНачальныхОстатковРасчетыПоЭквайрингу.СуммаВал) КАК СуммаВал,
	|	СУММА(ВводНачальныхОстатковРасчетыПоЭквайрингу.КомиссияВал) КАК КомиссияВал
	|ИЗ
	...
	|	И &ВестиУчетРасчетовСБанкомЭквайрером
	|СГРУППИРОВАТЬ ПО
...
Процедура ПоляЗагрузкиДанныхИзВнешнегоИсточника(ТаблицаПолейЗагрузки, НастройкиЗагрузкиДанных) Экспорт
	...
	ИмяПоляЦенаПродажи = "ЦенаПродажи";
	...
	Если ПолноеИмяОбъектаЗаполнения = "Документ.ВводНачальныхОстатков.ТабличнаяЧасть.Запасы" Тогда
		...
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, ИмяПоляЦенаПродажи, НСтр(
...
Функция ПараметрыУказанияСерий(Объект) Экспорт
	...
	ПараметрыУказанияСерий.ПолноеИмяОбъекта = "Документ.ВводНачальныхОстатков";

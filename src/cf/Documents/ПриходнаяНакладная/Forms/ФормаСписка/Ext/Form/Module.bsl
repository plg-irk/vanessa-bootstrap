...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Возврат", ТолькоВозвраты) Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru = 'Приходные накладные: возвраты'");
	...
	Список.Параметры.УстановитьЗначениеПараметра("ЕстьРасхождения", ЕстьРасхождения());
	Список.Параметры.УстановитьЗначениеПараметра("НетРасхождений", НетРасхождений());
...
Процедура ЗаполнитьНастройкиДинамическогоСписка(Знач ИмяТаблицы, Знач ИмяКоманды)
	...
	Если ПустаяСтрока(Заголовок) Тогда
		ЗаголовокФормы = НСтр("ru = 'Приходная накладная'");
	Иначе
...
Функция ЕстьРасхождения()
	Возврат НСтр("ru = 'Есть расхождения'");
КонецФункции

&НаКлиентеНаСервереБезКонтекста
Функция НетРасхождений()
	Возврат НСтр("ru = 'Нет расхождений'");
КонецФункции

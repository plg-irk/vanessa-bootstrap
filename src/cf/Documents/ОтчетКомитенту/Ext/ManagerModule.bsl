...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаОтчетКомитенту, СтруктураДополнительныеСвойства) Экспорт
	...
	|        И
	|            ОтчетКомитенту.Договор.ДоговорОбслуживанияНаправлениеДеятельности <> ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка)
	|            ТОГДА ИСТИНА
	|        ИНАЧЕ ЛОЖЬ
	...
	|    ОтчетКомитенту.СуммаВключаетНДС
	...
	|    ВЫБОР
	|        КОГДА
	|            ОтчетКомитентуЗапасы.Номенклатура.СчетУчетаНДСПоРеализации = ЗНАЧЕНИЕ(ПланСчетов.Управленческий.ПустаяСсылка)
	...
	|                ТОГДА ОтчетКомитентуЗапасы.СуммаНДС * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность /
	|                    (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|            ИНАЧЕ ОтчетКомитентуЗапасы.СуммаНДС * ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|                (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	|        КОНЕЦ
	...
	|    ВЫРАЗИТЬ(ВЫБОР
	|        КОГДА ОтчетКомитентуЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|            ТОГДА ОтчетКомитентуЗапасы.Всего * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс *
	|                КурсыРегВалюты.Кратность)
	|        ИНАЧЕ ОтчетКомитентуЗапасы.Всего * ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|            (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	...
	|        ИНАЧЕ ВЫБОР
	|            КОГДА ОтчетКомитентуЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|                ТОГДА ОтчетКомитентуЗапасы.СуммаНДСПоступления * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность /
	|                    (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|            ИНАЧЕ ОтчетКомитентуЗапасы.СуммаНДСПоступления * ОтчетКомитентуЗапасы.Ссылка.Курс *
	|                КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	|        КОНЕЦ
	...
	|            ТОГДА ОтчетКомитентуЗапасы.СуммаНДСПоступления * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность /
	|                (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|        ИНАЧЕ ОтчетКомитентуЗапасы.СуммаНДСПоступления * ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|            (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	...
	|                    ТОГДА ОтчетКомитентуЗапасы.Сумма * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность /
	|                        (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|                ИНАЧЕ (ОтчетКомитентуЗапасы.Сумма + ОтчетКомитентуЗапасы.СуммаНДС) * КурсыРегВалюты.Курс *
	|                    КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|            КОНЕЦ
	|        ИНАЧЕ ВЫБОР
	|            КОГДА ОтчетКомитентуЗапасы.Ссылка.СуммаВключаетНДС
	|                ТОГДА ОтчетКомитентуЗапасы.Сумма * ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|                    (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	|            ИНАЧЕ (ОтчетКомитентуЗапасы.Сумма + ОтчетКомитентуЗапасы.СуммаНДС) * ОтчетКомитентуЗапасы.Ссылка.Курс *
	|                КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	|        КОНЕЦ
	...
	|        ИНАЧЕ ВЫБОР
	|            КОГДА ОтчетКомитентуЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|                ТОГДА ОтчетКомитентуЗапасы.СуммаНДСВознаграждения * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность /
	|                    (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|            ИНАЧЕ ОтчетКомитентуЗапасы.СуммаНДСВознаграждения * ОтчетКомитентуЗапасы.Ссылка.Курс *
	|                КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	|        КОНЕЦ
	...
	|            ТОГДА ВЫБОР
	|                КОГДА ОтчетКомитентуЗапасы.Ссылка.СуммаВключаетНДС
	|                    ТОГДА ОтчетКомитентуЗапасы.СуммаВознаграждения * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность /
	|                        (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|                ИНАЧЕ (ОтчетКомитентуЗапасы.СуммаВознаграждения + ОтчетКомитентуЗапасы.СуммаНДСВознаграждения) *
	|                    КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|            КОНЕЦ
	|        ИНАЧЕ ВЫБОР
	|            КОГДА ОтчетКомитентуЗапасы.Ссылка.СуммаВключаетНДС
	|                ТОГДА ОтчетКомитентуЗапасы.СуммаВознаграждения * ОтчетКомитентуЗапасы.Ссылка.Курс *
	|                    КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	|            ИНАЧЕ (ОтчетКомитентуЗапасы.СуммаВознаграждения + ОтчетКомитентуЗапасы.СуммаНДСВознаграждения) *
	|                ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс *
	|                ОтчетКомитентуЗапасы.Ссылка.Кратность)
	|        КОНЕЦ
	...
	|        ИНАЧЕ ВЫБОР
	|            КОГДА ОтчетКомитентуЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|                ТОГДА ОтчетКомитентуЗапасы.СуммаНДСВознаграждения * КурсыРегВалюты.Курс *
	|                    ОтчетКомитентуЗапасы.Ссылка.Кратность / (ОтчетКомитентуЗапасы.Ссылка.Курс *
	|                    КурсыРегВалюты.Кратность)
	...
	|    ВЫРАЗИТЬ(ВЫБОР
	|        КОГДА ОтчетКомитентуЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|            ТОГДА ОтчетКомитентуЗапасы.СуммаВознаграждения * КурсыРегВалюты.Курс *
	|                ОтчетКомитентуЗапасы.Ссылка.Кратность / (ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыРегВалюты.Кратность)
	...
	|        ИНАЧЕ ОтчетКомитентуЗапасы.СуммаВознаграждения * ОтчетКомитентуЗапасы.Ссылка.Курс /
	|            ОтчетКомитентуЗапасы.Ссылка.Кратность
	...
	|            ТОГДА ВЫБОР
	|                КОГДА ОтчетКомитентуЗапасы.Ссылка.СуммаВключаетНДС
	|                    ТОГДА ОтчетКомитентуЗапасы.Сумма * КурсыРегВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность /
	|                        (ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыРегВалюты.Кратность)
	|                ИНАЧЕ (ОтчетКомитентуЗапасы.Сумма + ОтчетКомитентуЗапасы.СуммаНДС) * КурсыРегВалюты.Курс *
	|                    ОтчетКомитентуЗапасы.Ссылка.Кратность / (ОтчетКомитентуЗапасы.Ссылка.Курс *
	|                    КурсыРегВалюты.Кратность)
	|            КОНЕЦ
	...
	|    ОтчетКомитентуЗапасы.СуммаНДС КАК СуммаНДСВалютаДокумента,
	|    ВЫРАЗИТЬ(ВЫБОР
	|        КОГДА ОтчетКомитентуЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|            ТОГДА ОтчетКомитентуЗапасы.Сумма * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс *
	|                КурсыРегВалюты.Кратность)
	|        ИНАЧЕ ОтчетКомитентуЗапасы.Сумма * ОтчетКомитентуЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|            (КурсыУпрВалюты.Курс * ОтчетКомитентуЗапасы.Ссылка.Кратность)
	...
	// НДС
    УчетНДСУНФ.СформироватьДвиженияНДСЗаписиКнигиПродажРеализация(ДокументСсылкаОтчетКомитенту, СтруктураДополнительныеСвойства);
...
Функция ДанныеДокументовРегУчет(МассивОбъектов, ИспользоватьФаксимиле, ПечатнаяФормаТолькоВРублях = Истина, Ошибки = Неопределено) Экспорт
	...
	|	ОтчетКомитентуЗапасы.Ссылка.СтавкаНДСВознаграждения КАК СтавкаНДС,
	|	0 КАК Вес,
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	Если ПравоДоступа("Использование", Метаданные.Отчеты.РеестрДокументов) Тогда
		КомандаПечати = КомандыПечати.Добавить();
		КомандаПечати.Идентификатор = "РеестрДокументовОтчетКомитенту";
...
Функция ПараметрыУказанияСерий(Объект) Экспорт
	...
	ПараметрыУказанияСерий.ПолноеИмяОбъекта = "Документ.ОтчетКомитенту";

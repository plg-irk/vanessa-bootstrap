...
Процедура ВидРасширенныйПриИзменении(Элемент, СтандартнаяОбработка)
	ИзменениеРасширенногоВида(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура КартинкаРасширенныйСписокНажатие(Элемент, СтандартнаяОбработка)
	ИзменениеРасширенногоВида(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ВидКомпактныйПриИзменении(Элемент, СтандартнаяОбработка)
	ИзменениеКомпактногоВида(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура КартинкаКомпактныйСписокНажатие(Элемент, СтандартнаяОбработка)
	ИзменениеКомпактногоВида(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ПапкиИспользоватьПриИзменении(Элемент, СтандартнаяОбработка)
	ИзменениеПапкиИспользовать(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура КартинкаСписокСПапкамиНажатие(Элемент, СтандартнаяОбработка)
	ИзменениеПапкиИспользовать(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ПапкиНеИспользоватьПриИзменении(Элемент, СтандартнаяОбработка)
	ИзменениеПапкиНеИспользовать(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура КартинкаПапкиНеИспользоватьНажатие(Элемент, СтандартнаяОбработка)
	ИзменениеПапкиНеИспользовать(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ВидПредпросмотраПисьмаСправаПриИзменении(Элемент, СтандартнаяОбработка)
	ИзменениеВидаПредпросмотраПисьмаСправа(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура КартинкаПредпросмотрСправаНажатие(Элемент, СтандартнаяОбработка)
	ИзменениеВидаПредпросмотраПисьмаСправа(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ВидПредпросмотраПисьмаСнизуПриИзменении(Элемент, СтандартнаяОбработка)
	ИзменениеВидаПредпросмотраПисьмаСнизу(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура КартинкаПредпросмотрСнизуНажатие(Элемент, СтандартнаяОбработка)
	ИзменениеВидаПредпросмотраПисьмаСнизу(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ВидПредпросмотраПисьмаНетПриИзменении(Элемент, СтандартнаяОбработка)
	ИзменениеВидаПредпросмотраПисьмаНет(СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура КартинкаНетПредпросмотраНажатие(Элемент, СтандартнаяОбработка)
	ИзменениеВидаПредпросмотраПисьмаНет(СтандартнаяОбработка);
КонецПроцедуры
...
#Область ОбработкаИзмененияНастроек

&НаКлиенте
Процедура ИзменениеРасширенногоВида(СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИзменениеКомпактногоВида(СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИзменениеПапкиИспользовать(СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИзменениеПапкиНеИспользовать(СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИзменениеВидаПредпросмотраПисьмаНет(СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИзменениеВидаПредпросмотраПисьмаСправа(СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИзменениеВидаПредпросмотраПисьмаСнизу(СтандартнаяОбработка)

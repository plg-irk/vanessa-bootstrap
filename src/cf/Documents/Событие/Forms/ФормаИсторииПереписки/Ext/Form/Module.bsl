...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(Параметры.ДокументСсылка) <> Тип("ДокументСсылка.Событие") Тогда
		Отказ = Истина;
	КонецЕсли;
...
&НаКлиенте
Процедура ОтборПисьмаПриИзменении(Элемент)
	ОбработкаПриИзмененииОтбораПоТипуСобытия();
КонецПроцедуры

&НаКлиенте
Процедура ОтборЗвонкиПриИзменении(Элемент)
	ОбработкаПриИзмененииОтбораПоТипуСобытия();
КонецПроцедуры

&НаКлиенте
Процедура ОтборSMSПриИзменении(Элемент)
	ОбработкаПриИзмененииОтбораПоТипуСобытия();
КонецПроцедуры

&НаКлиенте
Процедура ОтборВстречиПриИзменении(Элемент)
	ОбработкаПриИзмененииОтбораПоТипуСобытия();
КонецПроцедуры

&НаКлиенте
Процедура ОтборПрочееПриИзменении(Элемент)
	ОбработкаПриИзмененииОтбораПоТипуСобытия();
КонецПроцедуры
...
&НаКлиенте
Процедура ОбработкаПриИзмененииОтбораПоТипуСобытия()

...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_Файл" И Параметр.Свойство("Событие")
		...
		Если ЗначениеЗаполнено(НужнаяСтрока) Тогда
			...
			ОбработкаВложенийПриАктивизацииСтроки(Элементы.Вложения);
		КонецЕсли;
...
Процедура ВложенияПриАктивизацииСтроки(Элемент)
	...
	ОбработкаВложенийПриАктивизацииСтроки(Элемент);
...
&НаКлиенте
Процедура ОбработкаВложенийПриАктивизацииСтроки(Элемент)
...
Процедура ОткрытьВложение()
	...
	#Если ВебКлиент ИЛИ МобильныйКлиент Тогда
		ПолучитьФайлССервераАсинх(ВыбранноеВложение.АдресВоВременномХранилище, ВыбранноеВложение.Представление);
	#Иначе

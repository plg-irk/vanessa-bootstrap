...
Функция ТекстЗапросаСоставДокумента(НомераТаблиц)
	...
	|			ТОГДА СписаниеНДССостав.СчетФактура.Договор
...
Функция СписанныеАвансы(СтруктураПараметров, СписокСчетовФактур)
	...
	МассивСчетовАвансов.Добавить(ПланыСчетов.Управленческий.РасчетыПоАвансамПолученным);    // 62.02
	//МассивСчетовАвансов.Добавить(ПланыСчетов.Управленческий.РасчетыПоАвансамПолученнымВал); // 62.22
	//МассивСчетовАвансов.Добавить(ПланыСчетов.Управленческий.РасчетыПоАвансамПолученнымУЕ);  // 62.32
	//МассивСчетовАвансов = БухгалтерскийУчет.СформироватьМассивСубсчетов(МассивСчетовАвансов);
	МассивСчетовАвансов = Новый Массив;
	
	МассивСчетовСписания = Новый Массив;
	МассивСчетовСписания.Добавить(ПланыСчетов.Управленческий.ПрочиеДоходы);      // 91.01
	//СчетаСписанияАвансов = БухгалтерскийУчет.СформироватьМассивСубсчетов(МассивСчетовСписания);
	СчетаСписанияАвансов = Новый Массив;
	
	МассивСчетовСписанияНДС = Новый Массив;
	МассивСчетовСписанияНДС.Добавить(ПланыСчетов.Управленческий.ПрочиеРасходы);  // 91.02
	//СчетаСписанияНДСсАвансов = БухгалтерскийУчет.СформироватьМассивСубсчетов(МассивСчетовСписанияНДС);
	СчетаСписанияНДСсАвансов = Новый Массив;

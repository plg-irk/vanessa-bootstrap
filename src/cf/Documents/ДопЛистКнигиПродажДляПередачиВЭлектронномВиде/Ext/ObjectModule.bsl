...
Функция ОсновныеСведенияЭлектронногоПредставления()
	...
	Если ЭтоПБОЮЛ Тогда
		...
		СведенияОЮрФизЛице  = ПечатьДокументовУНФ.СведенияОЮрФизЛице(Организация, КонецКвартала(НалоговыйПериод));
...
Функция СведенияОРуководителе()
	...
	ФизЛицо = Организация.ПодписьРуководителя.ФизическоеЛицо;

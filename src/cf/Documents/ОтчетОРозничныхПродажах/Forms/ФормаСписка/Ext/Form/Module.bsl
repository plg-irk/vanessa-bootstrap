...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьВидимостьСтатусовОтчетовОРозничныхПродажах();
...
Процедура ПередЗагрузкойДанныхИзНастроекНаСервере(Настройки)
	...
	ЗаполнитьНастройкиОтбораПоКассеНаСервере(Настройки);
...
Процедура ДекорацияРазвернутьОтборыНажатие(Элемент)
	...
	СвернутьРазвернутьПанельОтборовНаКлиенте();
...
&НаСервере
Процедура ЗаполнитьНастройкиОтбораПоКассеНаСервере(Настройки)
	...
	Если КассаККМИзПараметров.Пустая() Тогда
		...
		Если ОтборКассаККМ <> НастройкаКассаККМ Тогда
			...
			КассаФискальныйРегистратор = 
				Справочники.КассыККМ.ПолучитьРеквизитыКассыККМ(ОтборКассаККМ).ТипКассы
				= Перечисления.ТипыКассККМ.ФискальныйРегистратор;
			УстановитьОтборДинамическихСписков();
		КонецЕсли;
	КонецЕсли;
...
&НаСервере
Процедура УстановитьВидимостьСтатусовОтчетовОРозничныхПродажах()
	
	ИспользуютсяСтатусы = ПолучитьФункциональнуюОпцию("ОтслеживатьСтатусыОтчетовОРозничныхПродажах");
...
&НаКлиенте
Процедура СвернутьРазвернутьПанельОтборовНаКлиенте()

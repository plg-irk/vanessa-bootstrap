...
// Параметры:
//		Увольнение - ДокументСсылка.Увольнение
//
Процедура ЗаполнитьПоУвольнениюРеглУчет(Увольнение)
	
	Реквизиты = "Дата, ДатаУвольнения, Организация, ОснованиеУвольнения, Сотрудник";
	ДанныеУвольнения = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Увольнение, Реквизиты);
	
	Организация = ДанныеУвольнения.Организация;
	Дата = ДанныеУвольнения.Дата;
	НоваяСтрока = Сотрудники.Добавить();
	НоваяСтрока.Сотрудник = ДанныеУвольнения.Сотрудник;
	НоваяСтрока.Период = ДанныеУвольнения.ДатаУвольнения;
	НоваяСтрока.ОснованиеУвольнения = ДанныеУвольнения.ОснованиеУвольнения;

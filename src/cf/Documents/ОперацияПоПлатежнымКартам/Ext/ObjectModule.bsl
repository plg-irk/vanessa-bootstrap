...
Процедура ЗаполнитьПоОперацияПоПлатежнымКартам(ДокументСсылкаОперацияПоПлатежнымКартам) Экспорт
	...
	Если ЗначенияРеквизитовОснования.СпособОплаты = Перечисления.СпособыОплатыЭквайринг.ОплатаСБП Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, ДокументСсылкаОперацияПоПлатежнымКартам, ,
			...
			|ПометкаУдаления,СсылочныйНомер,ИдентификаторПлатежнойСистемы, ИдентификаторЧекаВОчереди");
	...
	Если ДокументСсылкаОперацияПоПлатежнымКартамВидОперации =
			Перечисления.ВидыОперацийЭквайринга.ПоступлениеОплатыОтПокупателя
		Или ДокументСсылкаОперацияПоПлатежнымКартамВидОперации =
...
Процедура ЗаполнитьПоПриходнаяНакладная(ДокументСсылкаПриходнаяНакладная) Экспорт
	...
	ДокументСсылкаПриходнаяНакладнаяВидОперации = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументСсылкаПриходнаяНакладная, "ВидОперации"); 
	Если НЕ ДокументСсылкаПриходнаяНакладнаяВидОперации = Перечисления.ВидыОперацийПриходнаяНакладная.ВозвратОтПокупателя 
		И НЕ ДокументСсылкаПриходнаяНакладнаяВидОперации = Перечисления.ВидыОперацийПриходнаяНакладная.ВыкупленныеКомиссионеромТовары Тогда
		...
		|или возврат товаров выкупленных комиссионером'");
	КонецЕсли;
...
Процедура ЗаполнитьПоЗаказПокупателя(ДокументСсылкаЗаказПокупателя, НомерСтроки = Неопределено, Сумма = Неопределено) Экспорт
	...
	ДокументСсылкаЗаказПокупателя, "ОжидаетсяВыборВариантаКП, ВидОперации");
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Иначе
		...
		РеквизитыЭТ = Новый Структура("Касса,БанковскийСчетЭквайринг,Эквайрер,СчетЗатрат");
		РеквизитыЭТ = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ЭквайринговыйТерминал, РеквизитыЭТ);
		
		Если Не ЗначениеЗаполнено(РеквизитыЭТ.Касса) ИЛИ
			Не ЗначениеЗаполнено(РеквизитыЭТ.БанковскийСчетЭквайринг) ИЛИ
			Не ЗначениеЗаполнено(РеквизитыЭТ.Эквайрер) ИЛИ
			Не ЗначениеЗаполнено(РеквизитыЭТ.СчетЗатрат) 
	...
	Если ВидОперации = Перечисления.ВидыОперацийЭквайринга.ПоступлениеОплатыОтПокупателя

...
//
// Параметры:
//  СтруктураОтбора - Структура - содержит данные о физ лице, для которого
//                 необходимо найти начисления или удержания
//  Налог - Булево - если Истина, то отбираются только налоги, Ложь - налоги исключаются      
//
// Возвращаемое значение:
//  - Массив из Структура - полученные начисления или удержания.
//
...
// Параметры:
//		КадровыйПеревод - ДокументСсылка.КадровыйПеревод
//

...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	// Конец СтандартныеПодсистемы.ПодключаемыеКоманды
	Если Не Элемент.ТекущиеДанные = Неопределено И Элемент.ТекущиеДанные.Свойство("Ссылка") Тогда
		ТекущаяСсылка = Элемент.ТекущиеДанные.Ссылка;
		НаименованиеКоманды = НаименованиеКоманды(ТекущаяСсылка);
		Если НаименованиеКоманды = Неопределено Тогда
		...
		Иначе
			...
			Элементы.ФормаДокументПеремещениеЗапасовОбратноеПеремещение.Заголовок = НаименованиеКоманды;
		КонецЕсли;
	КонецЕсли;
...
&НаСервере
Функция НаименованиеКоманды(ТекущаяСсылка)
	СоответствиеНаименований = Новый Соответствие;
	СоответствиеНаименований.Вставить(Перечисления.ВидыОперацийПеремещениеЗапасов.ПередачаВЭксплуатацию,
		"Возврат из эксплуатации" );
	СоответствиеНаименований.Вставить(Перечисления.ВидыОперацийПеремещениеЗапасов.Перемещение,
		"Возврат перемещения" );
		Возврат СоответствиеНаименований.Получить(ТекущаяСсылка.ВидОперации);
КонецФункции

...
Процедура ПриЗаполненииОграниченияДоступа(Ограничение) Экспорт
	...
	|	ИЛИ СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Подразделение))
	|	И (ЗначениеРазрешено(СтруктурнаяЕдиницаПолучатель)
	|	ИЛИ СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Подразделение))";
...
//
// Параметры:
//   ТаблицаПолейЗагрузки - ТаблицаЗначений - таблица значений, которая будет наполнена колонками
...
Процедура ПоляЗагрузкиДанныхИзВнешнегоИсточника(ТаблицаПолейЗагрузки, НастройкиЗагрузкиДанных) Экспорт
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "РодительКод",
		НСтр("ru = 'Код'"), ОписаниеТиповСтрока11, ОписаниеТиповКолонка, ИмяГруппыПолейРодитель, 1, , , , , ,
		ПредставлениеГруппыРодитель);
		
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "РодительНаименование",
		НСтр("ru = 'Группа (наименование)'"), ОписаниеТиповСтрока100, 
		ОписаниеТиповКолонка, ИмяГруппыПолейРодитель, 2, , , , , , ПредставлениеГруппыРодитель);
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьХарактеристики") Тогда
		...
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
			...
			НСтр("ru = 'Характеристика (наименование)'"), ОписаниеТиповСтрока150, ОписаниеТиповКолонка,
			ИмяГруппыПолейХарактеристика, 1, , , , , , ПредставлениеГруппыХарактеристика);
			
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
			ТаблицаПолейЗагрузки, "ХарактеристикаАртикул",
			НСтр("ru = 'Характеристика (артикул)'"), ОписаниеТиповСтрока25, ОписаниеТиповКолонка,
			ИмяГруппыПолейХарактеристика, 2, , , , , , ПредставлениеГруппыХарактеристика);
			
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
			ТаблицаПолейЗагрузки, "ХарактеристикаКод", 
			НСтр("ru = 'Характеристика (код)'"), ОписаниеТиповСтрока11, ОписаниеТиповКолонка,
			ИмяГруппыПолейХарактеристика, 3, , , , , , ПредставлениеГруппыХарактеристика);
	...
	ИмяГруппыПолейРодитель = "Ячейки";
	ПредставлениеГруппыРодитель = НСтр("ru='Ячейки'");
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Ячейка",
		НСтр("ru = 'Ячейка отправитель (наименование)'"), ОписаниеТиповСтрока100, ОписаниеТиповКолонка, ИмяГруппыПолейРодитель); 
		
	ОписаниеТиповКолонка = Новый ОписаниеТипов("СправочникСсылка.Ячейки");
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "ЯчейкаПолучатель",
		НСтр("ru = 'Ячейка получатель (наименование)'"), ОписаниеТиповСтрока100, ОписаниеТиповКолонка, ИмяГруппыПолейРодитель);
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьСерииНоменклатуры") Тогда
		...
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "ИспользоватьСерииНоменклатуры", 
			НСтр("ru = 'Использовать Серии номенклатуры'"), ОписаниеТиповСтрока25, ОписаниеТиповКолонка);
	...
	Для каждого СтрокаТаблицыФормы Из ТаблицаСопоставленияДанных Цикл
		...
		Если ЕстьРозничныйСуммовойУчет Тогда
			...
			ЗагрузкаДанныхИзВнешнегоИсточникаПереопределяемый.ПреобразоватьСтрокуВЧисло(
				СтрокаТаблицыФормы.Себестоимость, СтрокаТаблицыФормы.Себестоимость_ВходящиеДанные, 0);
		КонецЕсли;
		...
		Если ИспользуетсяРезервирование И НЕ ЕстьРозничноеПеремещение Тогда
			...
			Если ДопустимыеТипыЗаказа.СодержитТип(Тип("ДокументСсылка.ЗаказПокупателя")) Тогда
				ЗагрузкаДанныхИзВнешнегоИсточникаПереопределяемый.СопоставитьЗаказ(СтрокаТаблицыФормы.ЗаказПокупателя,
					СтрокаТаблицыФормы.ЗаказПокупателя_ВходящиеДанные);
			КонецЕсли;
		КонецЕсли;
...
//
// Параметры:
//   ВидОперации - ПеречислениеСсылка.ВидыОперацийПеремещениеЗапасов - вид операции документа Перемещение запасов
//
// Возвращаемое значение:
//   Массив из Тип - массив, содержащий типы документов для поля Заказ
//
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ПодключаемыеКоманды") Тогда
		...
		КомандаСозданияНаОсновании = МодульСозданиеНаОсновании.ДобавитьКомандуСозданияНаОсновании(
			КомандыСозданияНаОсновании, Метаданные.Документы.ПеремещениеЗапасов);
...
|	ВЫБОР
|		КОГДА ТаблицаДокумента.ВозвратИзРозницыСуммовойУчет
|			ТОГДА -ВЫРАЗИТЬ(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество * КурсыЦенВалюты.Курс *
|				КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * КурсыЦенВалюты.Кратность) /
|				ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))
|		ИНАЧЕ ВЫРАЗИТЬ(ЦеныНоменклатурыПолучательСрезПоследних.Цена * ТаблицаДокумента.Количество *
|			КурсыЦенВалютыПолучатель.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс *
|			КурсыЦенВалютыПолучатель.Кратность) /
|			ЕСТЬNULL(ЦеныНоменклатурыПолучательСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))
|	КОНЕЦ КАК Сумма,
|	ВЫБОР
|		КОГДА ТаблицаДокумента.ВозвратИзРозницыСуммовойУчет
|			ТОГДА -ВЫРАЗИТЬ(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество /
|				ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))
|		ИНАЧЕ ВЫРАЗИТЬ(ЦеныНоменклатурыПолучательСрезПоследних.Цена * ТаблицаДокумента.Количество /
|			ЕСТЬNULL(ЦеныНоменклатурыПолучательСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))
|	КОНЕЦ КАК СуммаВал,
...
|ИЗ
|	ВременнаяТаблицаЗапасы КАК ТаблицаДокумента
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЦеныНоменклатуры.СрезПоследних(&МоментВремени, (ВидЦен, Номенклатура,
|			Характеристика) В
|			(ВЫБРАТЬ
|				ВременнаяТаблицаЗапасы.РозничныйВидЦенПолучатель,
|				ВременнаяТаблицаЗапасы.Номенклатура,
...
|				Константы КАК Константы)) КАК КурсыУпрВалюты
|		ПО ИСТИНА
|		ЛЕВОЕ СОЕДИНЕНИЕ КурсыЦенВалюты КАК КурсыЦенВалютыПолучатель
|		ПО ТаблицаДокумента.ВалютаЦеныПолучатель = КурсыЦенВалютыПолучатель.Валюта
|		ЛЕВОЕ СОЕДИНЕНИЕ КурсыЦенВалюты КАК КурсыЦенВалюты
|		ПО ТаблицаДокумента.ВалютаЦены = КурсыЦенВалюты.Валюта
|ГДЕ
|	(ТаблицаДокумента.ПеремещениеВРозницуСуммовойУчет
|	ИЛИ ТаблицаДокумента.ВозвратИзРозницыСуммовойУчет)
...
|	ТаблицаДокумента.СчетУчетаВРознице,
|	ТаблицаДокумента.ЗаказПокупателя,
|	СУММА(ВЫРАЗИТЬ(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество * КурсыЦенВалюты.Курс *
|		КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * КурсыЦенВалюты.Кратность) /
|		ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))),
|	СУММА(ВЫРАЗИТЬ(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество /
|		ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))),
|	-СУММА(ВЫРАЗИТЬ(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество * КурсыЦенВалюты.Курс *
|		КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * КурсыЦенВалюты.Кратность) /
|		ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))),
...
|		ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))),
|	СУММА(ВЫРАЗИТЬ(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество * КурсыЦенВалюты.Курс *
|		КурсыЦенВалютыПолучатель.Кратность / (КурсыЦенВалютыПолучатель.Курс * КурсыЦенВалюты.Кратность) /
|		ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))),
|	СУММА(ВЫРАЗИТЬ(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество * КурсыЦенВалюты.Курс *
|		КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * КурсыЦенВалюты.Кратность) /
|		ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.ЕдиницаИзмерения.Коэффициент, 1) КАК ЧИСЛО(15, 2))),
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства) Экспорт
	...
	// Интеркампани
	СформироватьТаблицаРезервыТоваровОрганизаций(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства);
	...
	// Отчетность
	СформироватьТаблицаПартииТоваровУСН(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства);
...
Функция ТекстЗапросаИнициализироватьДанные()
	...
	|		И
	|			ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоПрочимДокументам)
	|			ТОГДА ПеремещениеЗапасов.Ссылка
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ИспользоватьОрдернуюСхемуПриПеремещении
	|		И
	|			ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоСкладскимОрдерам)
	...
	|		И
	|			ПеремещениеЗапасов.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоПрочимДокументам)
	|			ТОГДА ПеремещениеЗапасов.Ссылка
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиница.ИспользоватьОрдернуюСхемуПриПеремещении
	|		И
	|			ПеремещениеЗапасов.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоСкладскимОрдерам)
	...
	|	ПеремещениеЗапасов.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.ПоСкладуВЦелом) КАК
	|		ОрдерныйСкладКОтгрузкеПоСкладуВЦелом,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.ПоСкладуВЦелом) КАК
	|		ОрдерныйСкладКПоступлениюПоСкладуВЦелом,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоПрочимДокументам) КАК
	|		ОрдерныйСкладКПоступлениюПоПрочимДокументам,
	...
	|	И ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ИспользоватьОрдернуюСхемуПриПоступлении КАК
	...
	|	ПеремещениеЗапасов.ТоварыПередаютсяВСоставеРабот КАК ТоварыПередаютсяВСоставеРабот,
	|	ЗНАЧЕНИЕ(Перечисление.ВидыЗапасовПрослеживаемыхТоваров.ТоварыПередаваемыеВСоставеРабот) КАК ВидЗапасов,
	|	ПеремещениеЗапасов.ХозяйственнаяОперация КАК ХозяйственнаяОперация
	...
	|	ВЫБОР
	|		КОГДА
	|			ПеремещениеЗапасовЗапасы.Ссылка.ПоложениеПроекта = ЗНАЧЕНИЕ(Перечисление.ПоложениеРеквизитаНаФорме.ВТабличнойЧасти)
	...
	|		И
	|			ПеремещениеЗапасовЗапасы.Ссылка.ПоложениеЯчейкиОтправителя <> Значение(Перечисление.ПоложениеРеквизитаНаФорме.ВТабличнойЧасти)
	...
	|ИЗ
	|	Документ.ПеремещениеЗапасов.ИнвентарьИХозяйственныеПринадлежности КАК
	|		ПеремещениеЗапасовИнвентарьИХозяйственныеПринадлежности
	|ГДЕ
	...
	|	ВЫБОР
	|		КОГДА
	|			ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы <> ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.РозницаСуммовойУчет)
	|		И
	|			ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.РозницаСуммовойУчет)
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ПеремещениеВРозницуСуммовойУчет,
	|	ВЫБОР
	|		КОГДА
	|			ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы <> ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Розница)
	|		И
	|			ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Розница)
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	...
	|	ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы КАК
	|		ТипСтруктурнойЕдиницыПолучатель,
	...
	|	ВЫБОР
	|		КОГДА
	|			ПеремещениеЗапасовЗапасы.Ссылка.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПеремещениеЗапасов.Перемещение)
	|		ИЛИ
	|			ПеремещениеЗапасовЗапасы.Ссылка.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПеремещениеЗапасов.ВозвратИзЭксплуатации)
	|			ТОГДА ВЫБОР
	...
	|				ИНАЧЕ ВЫБОР
	|					КОГДА
	|						ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Склад)
	|					ИЛИ
	|						ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Розница)
	|					ИЛИ
	|						ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.РозницаСуммовойУчет)
	...
	|			ИНАЧЕ ВЫБОР
	|				КОГДА
	|					ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Склад)
	|				ИЛИ
	|					ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.Розница)
	|				ИЛИ
	|					ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = ЗНАЧЕНИЕ(Перечисление.ТипыСтруктурныхЕдиниц.РозницаСуммовойУчет)
	...
	|			ПеремещениеЗапасовЗапасы.Ссылка.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПеремещениеЗапасов.Перемещение)
	|		ИЛИ
	|			ПеремещениеЗапасовЗапасы.Ссылка.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПеремещениеЗапасов.СписаниеНаРасходы)
	...
	|	ЕСТЬNULL(ПолитикиУчетаСерийРасход.ПолитикаУчетаСерий, ВЫБОР
	|		КОГДА ПеремещениеЗапасовЗапасы.Номенклатура.ИспользоватьСерииИзКатегории
	|			ТОГДА ПеремещениеЗапасовЗапасы.Номенклатура.КатегорияНоменклатуры.ПолитикаУчетаСерий
	|		ИНАЧЕ ПеремещениеЗапасовЗапасы.Номенклатура.ПолитикаУчетаСерий
	|	КОНЕЦ) КАК ПолитикаУчетаСерийРасход,
	|	ЕСТЬNULL(ПолитикиУчетаСерийПриход.ПолитикаУчетаСерий, ВЫБОР
	|		КОГДА ПеремещениеЗапасовЗапасы.Номенклатура.ИспользоватьСерииИзКатегории
	|			ТОГДА ПеремещениеЗапасовЗапасы.Номенклатура.КатегорияНоменклатуры.ПолитикаУчетаСерий
	|		ИНАЧЕ ПеремещениеЗапасовЗапасы.Номенклатура.ПолитикаУчетаСерий
	|	КОНЕЦ) КАК ПолитикаУчетаСерийПриход,
	|	ПеремещениеЗапасовЗапасы.ПрослеживаемыйТовар КАК ПрослеживаемыйТовар,
	...
	|	ВЫБОР
	|		КОГДА ВременнаяТаблицаШапка.ТоварыПередаютсяВСоставеРабот
	|			ТОГДА ВременнаяТаблицаШапка.ВидЗапасов
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	...
	|		ПО ВЫБОР
	|			КОГДА ПеремещениеЗапасовЗапасы.Номенклатура.ИспользоватьСерииИзКатегории
	|				ТОГДА ПеремещениеЗапасовЗапасы.Номенклатура.КатегорияНоменклатуры = ПолитикиУчетаСерийРасход.Владелец
	|			ИНАЧЕ ПеремещениеЗапасовЗапасы.Номенклатура = ПолитикиУчетаСерийРасход.Владелец
	|		КОНЕЦ
	...
	|		ПО ВЫБОР
	|			КОГДА ПеремещениеЗапасовЗапасы.Номенклатура.ИспользоватьСерииИзКатегории
	|				ТОГДА ПеремещениеЗапасовЗапасы.Номенклатура.КатегорияНоменклатуры = ПолитикиУчетаСерийПриход.Владелец
	|			ИНАЧЕ ПеремещениеЗапасовЗапасы.Номенклатура = ПолитикиУчетаСерийПриход.Владелец
	|		КОНЕЦ
	...
	|		ИНАЧЕ ВЫБОР
	|			КОГДА
	|				ВременнаяТаблицаЗапасы.ПолитикаУчетаСерийРасход.ТипПолитики = ЗНАЧЕНИЕ(Перечисление.ТипыПолитикУказанияСерий.УправлениеОстаткамиСерий)
	|				ТОГДА ИСТИНА
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ
	...
	|		ИНАЧЕ ВЫБОР
	|			КОГДА
	|				ВременнаяТаблицаЗапасы.ПолитикаУчетаСерийПриход.ТипПолитики = ЗНАЧЕНИЕ(Перечисление.ТипыПолитикУказанияСерий.УправлениеОстаткамиСерий)
	|				ТОГДА ИСТИНА
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ
	...
	|	ВЫБОР
	|		КОГДА
	|			СведенияПрослеживаемости.Ссылка.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПеремещениеЗапасов.ВозвратИзЭксплуатации)
...
Процедура ВыполнитьКонтроль(ДокументСсылкаПеремещениеЗапасов, ДополнительныеСвойства, Отказ, УдалениеПроведения = Ложь) Экспорт
	...
	Если СтруктураВременныеТаблицы.ДвиженияЗапасыНаСкладахИзменение
		...
		|				&МоментКонтроля,
		|				Организация В (&МассивОрганизаций)) КАК ЗапасыОстатки
		...
		Если НЕ МассивРезультатов[12].Пустой() И НЕ Отказ Тогда
			...
			КонтрольОстатковУНФ.РезервыКПередачиСУчетомОстатковПоЗапасамНаСкладах(ДокументОбъектПеремещениеЗапасов, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
...
// Таблицы значений сохраняет в свойствах структуры "ДополнительныеСвойства".
//
Процедура СформироватьТаблицаРезервыТоваровОрганизаций(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства)
	
	Если НЕ ПолучитьФункциональнуюОпцию("ПередачаТоваровМеждуОрганизациями")
		ИЛИ СтруктураДополнительныеСвойства.ДляПроведения.ВидОперации = Перечисления.ВидыОперацийПеремещениеЗапасов.ВозвратИзЭксплуатации Тогда
	...
	|	ТаблицаЗапасы.Партия КАК Партия,
	|	ТаблицаЗапасы.СтруктурнаяЕдиница КАК СтруктурнаяЕдиница,
	|	ТаблицаЗапасы.ОрдерныйСкладКОтгрузке КАК ОрдерныйСклад,
				...
				Пока СтрокаСерии.Количество <> 0 Цикл
					...
					Для каждого СтрокаТовара Из СтрокиТоваров Цикл
						...
						Если СтрокаСерии.Количество >= СтрокаТовара.Количество Тогда
							...
							СтрокаТовара.СерияСОстатком = СтрокаСерии.ОстаткиСерийНоменклатурыРасход;
						Иначе
	...
	ИнтеркампаниСервер.СформироватьТаблицаРезервыТоваровОрганизаций(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства);
...
//
// Параметры:
//  ДокументСсылкаПеремещениеЗапасов  - ДокументСсылка.ПеремещениеЗапасов - ссылка на проводимый документ
//  СтруктураДополнительныеСвойства  - Структура - поле "ДополнительныеСвойства" проводимого документа
//
Процедура СформироватьТаблицаПартииТоваровУСН(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства) Экспорт
	...
	Если СтруктураДополнительныеСвойства.ДляПроведения.ВидОперации = Перечисления.ВидыОперацийПеремещениеЗапасов.СписаниеНаРасходы Тогда
		Запрос = Новый Запрос;
		...
		Запрос.Текст = "ВЫБРАТЬ
		               |	ПеремещениеЗапасовЗапасы.Номенклатура КАК Номенклатура,
		               |	ПеремещениеЗапасовЗапасы.Количество * ЕСТЬNULL(ЕдиницыИзмерения.Коэффициент, 1) КАК Количество,
		               |	ВЫБОР
		               |		КОГДА ПеремещениеЗапасов.ПоложениеНастроекНалоговогоУчета = ЗНАЧЕНИЕ(Перечисление.ПоложениеРеквизитаНаФорме.ВТабличнойЧасти)
		               |			ТОГДА ПеремещениеЗапасовЗапасы.УчитыватьВНУ
		               |		ИНАЧЕ ПеремещениеЗапасов.УчитыватьВНУ
		               |	КОНЕЦ КАК УчитыватьВНУ
		               |ИЗ
		               |	Документ.ПеремещениеЗапасов КАК ПеремещениеЗапасов
		               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПеремещениеЗапасов.Запасы КАК ПеремещениеЗапасовЗапасы
		               |			ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ЕдиницыИзмерения КАК ЕдиницыИзмерения
		               |			ПО ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения = ЕдиницыИзмерения.Ссылка
		...
		УчетПартийУСН.ЗаполнитьДвиженияСписаниеПартий(ДокументСсылкаПеремещениеЗапасов, ПартииСписать, ТаблицаЗапасы, ТаблицаПартииТоваров);
		...
		Если ТаблицаПартииТоваров.Найти(Истина, "ОтражатьВКУДиР") <> Неопределено Тогда
			...
			СтрокаОписание.Содержание = УчетПартийУСНКлиентСервер.СодержаниеСписаниеМатериалов();
		КонецЕсли;
	КонецЕсли;
...
Функция ДанныеДокументовБланкТоварногоНаполнения(МассивОбъектов, ЭтоОтправитель)
	...
	|	ПеремещениеЗапасовЗапасы.НомерСтроки КАК НомерСтроки,
	|	ПеремещениеЗапасовЗапасы.Ссылка КАК Ссылка,
	|	ЕСТЬNULL(ШтрихкодыНоменклатуры.Штрихкод, ПеремещениеЗапасовЗапасы.Номенклатура.Штрихкод) КАК Штрихкод
	|ИЗ
	|	Документ.ПеремещениеЗапасов.Запасы КАК ПеремещениеЗапасовЗапасы
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ШтрихкодыНоменклатуры КАК ШтрихкодыНоменклатуры
	|		ПО ПеремещениеЗапасовЗапасы.Номенклатура = ШтрихкодыНоменклатуры.Номенклатура
	|		И ПеремещениеЗапасовЗапасы.Характеристика = ШтрихкодыНоменклатуры.Характеристика
	|		И ПеремещениеЗапасовЗапасы.Партия = ШтрихкодыНоменклатуры.Партия
	|ГДЕ
	|	ПеремещениеЗапасовЗапасы.Ссылка В (&МассивОбъектов)
	|
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка,
	|	НомерСтроки,
	...
	Для Каждого ДанныеДокумента Из Результат Цикл
		Для Каждого ДанныеСтроки Из ДанныеДокумента.ТаблицаЗапасы Цикл
			ПараметрыПоискаШтрихкодыНоменклатуры.Ссылка = ДанныеДокумента.Ссылка;
			ПараметрыПоискаШтрихкодыНоменклатуры.НомерСтроки = ДанныеСтроки.НомерСтроки;
			НайденныеСтроки = ШтрихкодыНоменклатуры.НайтиСтроки(ПараметрыПоискаШтрихкодыНоменклатуры);
			ПечатьДокументовУНФ.ПодобратьШтрихкодНоменклатуры(ДанныеСтроки, НайденныеСтроки);
		КонецЦикла;
	КонецЦикла;
...
Функция ПечатьТОРГ16(МассивОбъектов, ОбъектыПечати)
	...
	|	ПеремещениеЗапасов.Дата КАК Дата,
	|	ПеремещениеЗапасов.Дата КАК ДатаДокумента,
	|	ПеремещениеЗапасов.Дата КАК ДатаСписанияТовара,
	...
	|	ПеремещениеЗапасов.ПодписьРуководителя.РасшифровкаПодписи КАК ФИОРуководителя,
	|	ПеремещениеЗапасов.ПодписьПредседателя.Должность КАК ДолжностьПредседателя,
	|	ПеремещениеЗапасов.ПодписьПредседателя.РасшифровкаПодписи КАК ФИОПредседателя,
	|	ПеремещениеЗапасов.ПодписьЧленаКомиссии2.Должность КАК ДолжностьЧленаКомиссии2,
	|	ПеремещениеЗапасов.ПодписьЧленаКомиссии2.РасшифровкаПодписи КАК ФИОЧленаКомиссии2,
	|	ПеремещениеЗапасов.ПодписьЧленаКомиссии3.Должность КАК ДолжностьЧленаКомиссии3,
	|	ПеремещениеЗапасов.ПодписьЧленаКомиссии3.РасшифровкаПодписи КАК ФИОЧленаКомиссии3,
	|	ПеремещениеЗапасов.ПодписьЧленаКомиссии4.Должность КАК ДолжностьЧленаКомиссии4,
	|	ПеремещениеЗапасов.ПодписьЧленаКомиссии4.РасшифровкаПодписи КАК ФИОЧленаКомиссии4,
	|	ПеремещениеЗапасов.ПодписьМОЛ.Должность КАК ДолжностьМОЛ,
	|	ПеремещениеЗапасов.ПодписьМОЛ.РасшифровкаПодписи КАК ФИОМОЛ
	|ИЗ
	|	Документ.ПеремещениеЗапасов КАК ПеремещениеЗапасов
	|ГДЕ
	...
	|		ПеремещениеЗапасовЗапасы.Номенклатура КАК Номенклатура,
	|		ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|		ПРЕДСТАВЛЕНИЕ(ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения) КАК ЕдиницаИзмеренияНаименование,
	|		ПеремещениеЗапасовЗапасы.Номенклатура.Вес КАК МассаОдногоМеста,
	|		ПеремещениеЗапасовЗапасы.Количество * ПеремещениеЗапасовЗапасы.Номенклатура.Вес КАК МассаНетто,
	|		ПеремещениеЗапасовЗапасы.Характеристика КАК Характеристика,
	|		ВЫБОР
	|			КОГДА ПеремещениеЗапасовЗапасы.Количество = 0
	|				ТОГДА ПеремещениеЗапасовЗапасы.Цена
	|			ИНАЧЕ ПеремещениеЗапасовЗапасы.Сумма / ПеремещениеЗапасовЗапасы.Количество
	|		КОНЕЦ КАК Цена,
	|		ПеремещениеЗапасовЗапасы.Количество КАК КоличествоМест,
	|		ПеремещениеЗапасовЗапасы.Сумма КАК Стоимость,
	|		ПеремещениеЗапасовЗапасы.НомерСтроки КАК НомерСтроки
	|	ИЗ
	|		Документ.ПеремещениеЗапасов.Запасы КАК ПеремещениеЗапасовЗапасы
	|	ГДЕ
	|		ПеремещениеЗапасовЗапасы.Ссылка В (&МассивДокументов)) КАК ВложенныйЗапрос
	|
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка,
	|	НомерСтроки
...
Функция ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	Для каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		Если ИмяМакета = "ПеремещениеЗапасов" Тогда
			...
			|	ШапкаДокумента.СтруктурнаяЕдиницаПолучатель.ТипСтруктурнойЕдиницы КАК
			|		СтруктурнаяЕдиницаПолучательТипСтруктурнойЕдиницы,
			...
			|		Серия КАК Серия,
			|		КлючСвязи КАК КлючСвязи) КАК СерииНоменклатуры
			|ИЗ
			...
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЦеныНоменклатуры.СрезПоследних(&ДатаДокумента, Номенклатура В (&СписокНоменклатура)
			...
			ВыборкаСтрокЗапасы = РезультатыЗапроса[2].Выбрать();
			
			ШтрихкодыНоменклатуры = РезультатыЗапроса[3].Выгрузить();
			ШтрихкодыНоменклатуры.Индексы.Добавить("НомерСтроки");
			...
			Пока ВыборкаСтрокЗапасы.Следующий() Цикл
				...
				НайденныеСтроки = ШтрихкодыНоменклатуры.НайтиСтроки(ПараметрыПоискаШтрихкодыНоменклатуры);
				ПечатьДокументовУНФ.ПодобратьШтрихкодНоменклатуры(ПараметрыНоменклатуры, НайденныеСтроки);
			...
			Если Шапка.СтруктурнаяЕдиницаПолучательТипСтруктурнойЕдиницы = Перечисления.ТипыСтруктурныхЕдиниц.Розница
				Или Шапка.СтруктурнаяЕдиницаПолучательТипСтруктурнойЕдиницы
				= Перечисления.ТипыСтруктурныхЕдиниц.РозницаСуммовойУчет Тогда
		...
		ИначеЕсли ИмяМакета = "М11" Тогда
			...
			|		И
			|			ПеремещениеЗапасов.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору <> ЗНАЧЕНИЕ(Справочник.КлассификаторЕдиницИзмерения.ПустаяСсылка)
			...
			|		ИНАЧЕ ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.Цена, 0) * КурсыВалютСрезПоследних.Курс /
			|			КурсыВалютСрезПоследних.Кратность
			|	КОНЕЦ КАК Цена,
			|	ВЫБОР
			|		КОГДА &ВалютаВидЦен = НациональнаяВалюта.Значение
			|			ТОГДА ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество, 0)
			|		ИНАЧЕ ЕСТЬNULL(ЦеныНоменклатурыСрезПоследних.Цена * ТаблицаДокумента.Количество, 0) * КурсыВалютСрезПоследних.Курс /
			|			КурсыВалютСрезПоследних.Кратность
			|	КОНЕЦ КАК Сумма
			|ИЗ
			|	ТаблицаДокумента КАК ТаблицаДокумента
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЦеныНоменклатуры.СрезПоследних(&ДатаДокумента, Актуальность
			|		И ВидЦен = &ВидЦен) КАК ЦеныНоменклатурыСрезПоследних
			...
			РозничныйВидДокументаВалютаЦены = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(РозничныйВидДокумента,
				"ВалютаЦены");
			Запрос.УстановитьПараметр("ВалютаВидЦен", ?(ЗначениеЗаполнено(РозничныйВидДокументаВалютаЦены),
				РозничныйВидДокументаВалютаЦены, Константы.НациональнаяВалюта.Получить()));
			Запрос.УстановитьПараметр("ДатаДокумента", ТекущийДокумент.Дата);
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ТОРГ13") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ТОРГ13", НСтр("ru = 'ТОРГ-13'"),
			ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, "ТОРГ13"));
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	ИдентификаторКомплекта = СтрШаблон("М11,ТОРГ13,%1,ТТН,ПеремещениеЗапасов,ТОРГ16", Обработки.ПечатьМХ18.ИдентификаторПечатнойФормы());
	...
	КомандаПечати.Представление = НСтр("ru = 'ТОРГ16 (Акт о списании товаров)'");
	УправлениеПечатью.ДобавитьУсловиеВидимостиКоманды(КомандаПечати, "ВидОперации", Перечисления.ВидыОперацийПеремещениеЗапасов.СписаниеНаРасходы,
		 ВидСравнения.Равно);
...
Функция ПечатьАктаСписанияТоваров(МассивОбъектов, ОбъектыПечати)
	...
	|ИЗ
	|	Документ.ПеремещениеЗапасов КАК Документ
	|ГДЕ
	...
	|ИЗ
	|	Документ.ПеремещениеЗапасов.Запасы КАК ТаблицаТовары
	|ГДЕ
...
Функция ПараметрыУказанияСерий(Объект) Экспорт
	...
	ПараметрыУказанияСерий.ПолноеИмяОбъекта = "Документ.ПеремещениеЗапасов";

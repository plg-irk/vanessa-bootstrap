...
Процедура ЗаполнитьПоЗаказуПокупателя(ДокументСсылкаЗаказ) Экспорт
	...
	ЗначенияРеквизитов = Новый Структура("ОжидаетсяВыборВариантаКП,ВидОперации");
	ЗаполнитьЗначенияСвойств(ЗначенияРеквизитов, ВыборкаШапка);
...
Процедура ЗаполнитьПоЗаказНаПеремещение(ДокументСсылкаЗаказ) Экспорт
	...
	ПоложениеЯчейкиОтправителя = ПерсональныеНастройкиРУНФ.Прочитать("ПоложениеЯчейкиОтправителя");
	ПоложениеЯчейкиПолучателя = ПерсональныеНастройкиРУНФ.Прочитать("ПоложениеЯчейкиПолучателя");
...
Процедура ЗаполнитьПоПеремещениюЗапасов(ДанныеЗаполнения) Экспорт
	ИсключаяСвойства = "Дата, Номер";
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, ДанныеЗаполнения,,ИсключаяСвойства);

	Если ДанныеЗаполнения.ВидОперации = ПредопределенноеЗначение(
		"Перечисление.ВидыОперацийПеремещениеЗапасов.ПередачаВЭксплуатацию") Тогда
		ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийПеремещениеЗапасов.ВозвратИзЭксплуатации");
	...
	Спецоснастка.Загрузить(ДанныеЗаполнения.Спецоснастка.Выгрузить());
	ИнвентарьИХозяйственныеПринадлежности.Загрузить(ДанныеЗаполнения.ИнвентарьИХозяйственныеПринадлежности.Выгрузить());
	СерииНоменклатуры.Загрузить(ДанныеЗаполнения.СерииНоменклатуры.Выгрузить());
КонецПроцедуры

Процедура ЗаполнитьПоСтруктуре(ДанныеЗаполнения) Экспорт
	
	Если ДанныеЗаполнения.Свойство("ЗаказПокупателя") Тогда

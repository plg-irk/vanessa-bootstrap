...
Процедура ФормироватьСторнирующиеЗаписиДопЛистовВручнуюПриИзменении(Элемент)
	...
	ЕстьСторнирующиеЗаписи = Объект.ВосстановленПоАвансам.Итог("СторнирующаяЗаписьДопЛистаЧисло");

	Если Не Объект.ФормироватьСторнирующиеЗаписиДопЛистовВручную И ЕстьСторнирующиеЗаписи Тогда

		ТекстВопроса = НСтр(
			"ru = 'Удалить строки с установленным флагом ""Сторнирующая запись доп. листа"" из табличных частей?'");
		Оповещение = Новый ОписаниеОповещения("ВопросФормироватьСторнирующиеЗаписиДопЛистовВручнуюЗавершение",
			ЭтотОбъект);
...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	Если Объект.ВосстановленПоАвансам.Количество() <> 0 Тогда
...
Процедура ОбновитьУсловноеОформление(Форма)
   ...
   Если Элементы.Страницы.ТекущаяСтраница = Элементы.ГруппаВосстановленПоАвансам
...
Процедура УстановитьФункциональныеОпцииФормы()
	...
	ИспользоватьКорректировочныеДокументы = ПолучитьФункциональнуюОпцию("ИспользоватьКорректировкиРеализаций");
...
Процедура УстановитьВидимостьФлагаСторнирующихЗаписей(Форма)
	...
	Элементы.ФормироватьСторнирующиеЗаписиДопЛистовВручную.Видимость = Объект.ВосстановленПоАвансам.Итог("ЗаписьДополнительногоЛистаЧисло");
...
Процедура ОбновитьНадписьПодвала(Форма)
	...
	Объект = Форма.Объект;
	Форма.ВсегоНДС = Объект.ВосстановленПоАвансам.Итог("НДС");
...
Процедура ЗаполнитьДокументНаКлиенте(ИмяТабЧасти)
	...
	Если ИмяТабЧасти = Неопределено Тогда
		ЕстьДанные = Объект.ВосстановленПоАвансам.Количество() > 0;
	Иначе

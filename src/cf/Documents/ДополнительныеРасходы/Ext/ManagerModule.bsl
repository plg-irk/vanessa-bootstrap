...
Функция НаличиеСуммыНДС(ТекущийДокумент) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|    ПоступлениеДопРасходовРасходы.СуммаНДС,
	|    ПоступлениеДопРасходовРасходы.Ссылка
	|ИЗ
	|    Документ.ДополнительныеРасходы.Расходы КАК ПоступлениеДопРасходовРасходы
	|ГДЕ
	|    ПоступлениеДопРасходовРасходы.Ссылка = &СсылкаНаДокумент
	|    И ПоступлениеДопРасходовРасходы.СуммаНДС > 0
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|ИЗ
	|    Документ.ДополнительныеРасходы.Запасы КАК ПоступлениеДопРасходовТовары
	|ГДЕ

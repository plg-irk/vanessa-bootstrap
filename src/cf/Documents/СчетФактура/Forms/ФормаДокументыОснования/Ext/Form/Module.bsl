...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	|ТолькоПросмотрСпискаОснований, ИсправляемыйСчетФактура, ПлательщикНДСПрименяющийУСН";
	...
	Для каждого СтрокаДокументыОснования Из ДокументыОснования Цикл
		...
		Если НЕ ЗначениеЗаполнено(СтрокаДокументыОснования.ДокументОснование) Тогда
			...
			Сообщение.Текст = СтрШаблон(НСтр(
				"ru = 'Не заполнена колонка ""Документ основание"" в строке %1 списка ""Документы основания"".'"),
				Строка(НомерСтроки));
...
Процедура АдаптироватьПараметрыФормы()
	...
	КэшЗначений.ЕстьАвансы = (КэшЗначений.ВидОперации = Перечисления.ВидыОперацийСчетФактура.Аванс
		Или КэшЗначений.ВидОперации = Перечисления.ВидыОперацийСчетФактура.КорректировкаАванса
		Или КэшЗначений.ВидОперации = Перечисления.ВидыОперацийСчетФактура.НаАвансКомитента);

...
Процедура ЗаполнитьПоИнвентаризацииЗапасов(ДокументСсылкаИнвентаризацияЗапасов) Экспорт
	...
	ПоложениеЯчейки = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументСсылкаИнвентаризацияЗапасов, "ПоложениеЯчейки");
...
Процедура ЗаполнитьПоПриходномуОрдеру(ДокументСсылкаПриходныйОрдер) Экспорт
	...
	ЗначениеРеквизитовОснования = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылкаПриходныйОрдер, "Организация, 
		|СтруктурнаяЕдиница, ПоложениеЯчейки, Ячейка");
	
	Организация = ЗначениеРеквизитовОснования.Организация;
	СтруктурнаяЕдиница = ЗначениеРеквизитовОснования.СтруктурнаяЕдиница;
	
	ПоложениеЯчейки = ЗначениеРеквизитовОснования.ПоложениеЯчейки;
	
	Если ЗначениеРеквизитовОснования.ПоложениеЯчейки = Перечисления.ПоложениеРеквизитаНаФорме.ВШапке Тогда
		Ячейка = ЗначениеРеквизитовОснования.Ячейка;
	КонецЕсли;
	...
	ВидЦен = ?(ЗначениеЗаполнено(ВидЦен), ВидЦен, ПерсональныеНастройкиРУНФ.Прочитать("ОсновнойВидЦенПродажи"));
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ЭтоНовый() И Не ЗначениеЗаполнено(ПоложениеЯчейки) Тогда
		ПоложениеЯчейки = ПерсональныеНастройкиРУНФ.Прочитать("ПоложениеЯчейкиВКомплектацииЗапасов");
	КонецЕсли;

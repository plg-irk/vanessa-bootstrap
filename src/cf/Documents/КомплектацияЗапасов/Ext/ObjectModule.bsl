...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ЭтоНовый() Тогда
		...
		ПоложениеСклада = ПерсональныеНастройкиРУНФ.Прочитать("ПоложениеСкладаВДокументахПроизводства");
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ПоложениеСклада) Тогда
	...
	Если Не ЗначениеЗаполнено(СтруктурнаяЕдиницаМатериалы) Тогда
		СтруктурнаяЕдиницаМатериалы = СтруктурнаяЕдиница
	КонецЕсли;

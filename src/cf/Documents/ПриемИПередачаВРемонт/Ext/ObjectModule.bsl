...
Процедура ЗаполнитьРеквизитыПечати()
	...
	Если НЕ ЗначениеЗаполнено(УсловияГарантии) Тогда
		УсловияГарантии = ПерсональныеНастройкиРУНФ.Прочитать("УсловияГарантии", Организация);
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(УсловияПриемки) Тогда
		УсловияПриемки = ПерсональныеНастройкиРУНФ.Прочитать("УсловияПриемки", Организация);
	КонецЕсли;

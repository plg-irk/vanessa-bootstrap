...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Идентификатор = Отчеты.РасчетнаяВедомость.ИдентификаторПечатнойФормы();
	КомандаПечати.Представление = Отчеты.РасчетнаяВедомость.ПредставлениеПФ();
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МенеджерПечати = "Отчет.РасчетнаяВедомость";
	КомандаПечати.Порядок = 1;
	
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = Отчеты.РасчетныеЛистки.ИдентификаторПечатнойФормы();
	КомандаПечати.Представление = Отчеты.РасчетныеЛистки.ПредставлениеПФ();
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МенеджерПечати = "Отчет.РасчетныеЛистки";
...
Процедура ДобавитьКомандыОтчетов(КомандыОтчетов, Параметры) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.РасчетныеЛистки) Тогда
		...
		КомандаОтчет.Менеджер = Метаданные.Отчеты.НачисленияИУдержания.ПолноеИмя();
		КомандаОтчет.Представление = НСтр("ru = 'Начисления и удержания'");
		КомандаОтчет.КлючВарианта = "ВВалюте";
		КомандаОтчет.МножественныйВыбор = Ложь;
		КомандаОтчет.Важность = "Обычное";
		КомандаОтчет.ФункциональныеОпции = "ИспользоватьПодсистемуЗарплата";
		КомандаОтчет.ДополнительныеПараметры.Вставить("ИмяКоманды", "ОтчетНачисленияУдержания");
		КомандаОтчет.Важность = "Обычное";

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыУказанияСерий = Новый ФиксированнаяСтруктура(Документы.РасходныйОрдер.ПараметрыУказанияСерий(Объект));
...
Функция ПолучитьДанныеСтруктурнойЕдиницыПриИзменении(СтруктурнаяЕдиница, Организация)
	...
	СтруктураДанные = Новый Структура;
	ПодписьМОЛ = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьМОЛ", Организация);

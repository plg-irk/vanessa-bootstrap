...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СчетаНаОплату.Параметры.УстановитьЗначениеПараметра("БезОплаты", НСтр("ru = 'Без оплаты'"));
	СчетаНаОплату.Параметры.УстановитьЗначениеПараметра("ОплаченПолностью", НСтр("ru = 'Оплачен полностью'"));
	СчетаНаОплату.Параметры.УстановитьЗначениеПараметра("ОплаченЧастично", НСтр("ru = 'Оплачен частично'"));
...
Процедура РегулярныеПлатежиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	СоздатьПлатежноеПоручениеПоВыбраннымРегулярнымПлатежамНаКлиенте();
КонецПроцедуры
...
&НаКлиенте
Процедура СоздатьПлатежноеПоручениеПоВыбраннымРегулярнымПлатежамНаКлиенте()
	...
	Если МассивИсходныхДокументов.Количество() = 1 Тогда
		...
		ОткрытьФорму("Документ.ПлатежноеПоручение.ФормаОбъекта", ПараметрыОткрытия, ЭтотОбъект, , , , ОповещениеОЗакрытии);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ДобавитьПлатежныйРеквизит("", НСтр("ru = 'В документе'"), НСтр("ru = 'Рекомендуемое значение'"));
		ТекстПредупреждения =
...
Процедура УстановитьУсловноеОформление()
	...
	КрасныйЦвет = ЦветаСтиля.ЕдиныйНалоговыйСчетКрасныйЦветФона;
	ЗеленыйЦвет = ЦветаСтиля.ЦветПринятогоПриглашенияКЭДО;

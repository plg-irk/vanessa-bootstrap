...
Процедура ЗаполнитьПоЗаказПокупателя(ДокументСсылкаЗаказПокупателя) Экспорт
	...
	|	ТаблицаДокумента.ВидОперации КАК ВидОперацииЗаказа,
	...
	ПроверяемыеРеквизиты = Новый Структура("ОжидаетсяВыборВариантаКП,ВидОперации",
	Выборка.ОжидаетсяВыборВариантаКП, Выборка.ВидОперацииЗаказа);

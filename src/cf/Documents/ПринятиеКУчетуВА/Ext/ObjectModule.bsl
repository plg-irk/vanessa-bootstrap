...
Процедура ЗаполнитьПоВнеоборотныеАктивы(СправочникСсылкаВнеоборотныеАктивы) Экспорт
	...
	Запрос.УстановитьПараметр("ВнеоборотныйАктив", СправочникСсылкаВнеоборотныеАктивы);
...
// Процедура заполнения документа на основании структуры
//
// Параметры:
//	ДанныеЗаполнения - Структура - основание заполнения
//	
Процедура ЗаполнитьПоСтруктуре(ДанныеЗаполнения) Экспорт
	
	Если ДанныеЗаполнения.Свойство("ВнеоборотныйАктив") Тогда
		ЗаполнитьПоВнеоборотныеАктивы(ДанныеЗаполнения.ВнеоборотныйАктив);
	КонецЕсли;

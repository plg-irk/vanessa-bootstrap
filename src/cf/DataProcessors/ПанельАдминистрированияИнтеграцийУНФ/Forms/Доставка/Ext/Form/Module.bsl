...
Процедура НастроитьПеревозчиковСервиса1СДоставкаНажатие(Элемент)
	...
	ПараметрыФормы.ТипГрузоперевозки = СервисДоставкиКлиентСервер.ТипГрузоперевозкиСервис1СДоставка();
...
Процедура НастроитьПеревозчиковСервиса1СКурьерНажатие(Элемент)
	...
	ПараметрыФормы = СервисДоставкиКлиент.НовыйПараметрыОткрытьФормуСервисаДоставки();
	ПараметрыФормы.ИмяФормы = "ДоступныеПеревозчики";
	ПараметрыФормы.ТипГрузоперевозки = СервисДоставкиКлиентСервер.ТипГрузоперевозкиСервис1СКурьер();
	ПараметрыФормы.ЗаполнятьОрганизациюПоУмолчанию = Ложь;
	СервисДоставкиКлиент.ОткрытьФормуСервисаДоставки(ПараметрыФормы);
...
Процедура НастроитьПеревозчиковСервиса1СКурьерикаНажатие(Элемент)
	...
	ПараметрыФормы = СервисДоставкиКлиент.НовыйПараметрыОткрытьФормуСервисаДоставки();
	ПараметрыФормы.ИмяФормы = "ДоступныеПеревозчики";
	ПараметрыФормы.ТипГрузоперевозки = СервисДоставкиКлиентСервер.ТипГрузоперевозкиСервис1СКурьерика();
	ПараметрыФормы.ЗаполнятьОрганизациюПоУмолчанию = Ложь;
	СервисДоставкиКлиент.ОткрытьФормуСервисаДоставки(ПараметрыФормы);

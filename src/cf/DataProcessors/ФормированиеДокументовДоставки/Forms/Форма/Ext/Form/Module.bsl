...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяТЧ = ИмяТЧПланДоставки(); 
	НаборЭлементовГрупповогоИзмененияСтрок = НаборЭлементовГрупповогоИзмененияСтрокСервер(ИмяТЧ); 
	ГрупповоеИзменениеСтрокСервер.ПриСозданииНаСервере(НаборЭлементовГрупповогоИзмененияСтрок, ПланДоставкиИзменениеСтрокДействие);
	
	ПланДоставкиИзменениеСтрокДействиеПриОткрытии = ПланДоставкиИзменениеСтрокДействие;
	УстановитьПометку(ИмяТЧ, Истина);   
	
    	Элементы.ГруппаПланДоставкиИзменениеСтрок.Видимость = Истина;
	Элементы.ПланДоставкиПометка.Видимость = Истина;
...
Процедура ПланДоставкиИзменениеСтрокДействиеПриИзменении(Элемент)
	...
	ПланДоставкиИзменениеСтрокПриИзменении(Элемент);
...
&НаКлиенте
Процедура ФильтрСлужбаДоставкиПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

&НаКлиенте
Процедура ФильтрСпособОтгрузкиПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

&НаКлиенте
Процедура ФильтрСпособДоставкиПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

&НаКлиенте
Процедура ФильтрЗонаТарифПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры
...
&НаКлиенте
Процедура ФильтрВидЗаказаПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

&НаКлиенте
Процедура ФильтрКурьерПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

&НаКлиенте
Процедура ФильтрМаршрутныйЛистПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

&НаКлиенте
Процедура ФильтрТолькоНедоставленныеПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

&НаКлиенте
Процедура ФильтрТолькоНеоплаченныеПриИзменении(Элемент)
	ФильтрПриИзменении()
КонецПроцедуры

#КонецОбласти 

#Область ОбработчикиСобытийЭлементовТаблицыФормыПланДоставки
...
Процедура ПланДоставкиВыполнитьДействие(Команда)
	...
	УправлениеРезервнымиКопиямиТаблицы(ИмяТЧПланДоставки(), 1, Истина);
...
Процедура ПланДоставкиОтменитьИзменения(Команда)
	УправлениеРезервнымиКопиямиТаблицы(ИмяТЧПланДоставки(), 0, Ложь);
КонецПроцедуры
...
&НаКлиенте
Процедура ПланДоставкиИзменениеСтрокПриИзменении(Элемент)
...
Процедура СформироватьДокументыКлиент()
	...
	Иначе
		...
		ОткрытьФорму("ОбщаяФорма.ФормаПредупреждения", ПараметрыСовета, ЭтотОбъект, Истина, , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
	КонецЕсли;
...
Процедура ПланДоставкиИзменитьСтроки(Команда)
	Если Элементы.ГруппаПланДоставкиИзменениеСтрок.Видимость И Не ЗначениеЗаполнено(ПланДоставкиИзменениеСтрокДействие) Тогда
		...
		ПланДоставкиИзменениеСтрокПриИзменении(Элементы.ПланДоставкиИзменениеСтрокДействие);
	КонецЕсли;
КонецПроцедуры
...
//
// Параметры:
//  ЭтотОбъект - ФормаКлиентскогоПриложения - Форма, в которой происходит групповое изменение строк ТЧ.
//  Дерево  - ДанныеФормыКоллекция - ТЧ, которую требуется поместить во временное хранилище.
//  РезервнаяКопияТаблицыАдрес - Строка - Вернет адрес таблицы во временном хранилище.
//
&НаСервереБезКонтекста
Процедура СделатьРезервнуюКопиюДерева(ЭтотОбъект, Дерево, РезервнаяКопияТаблицыАдрес)
	
	//@skip-check module-self-reference
	РезервнаяКопияТаблицыАдрес = ПоместитьВоВременноеХранилище(Дерево, ЭтотОбъект.УникальныйИдентификатор);
...
Функция НаборЭлементовГрупповогоИзмененияСтрокКлиент(ИмяТЧ)
	...
	НаборЭлементов.Вставить("Действие",                ПланДоставкиИзменениеСтрокДействие);
	НаборЭлементов.Вставить("ДействиеЭлемент",         Элементы.ПланДоставкиИзменениеСтрокДействие);
	НаборЭлементов.Вставить("Значение",                ПланДоставкиИзменениеСтрокЗначение);

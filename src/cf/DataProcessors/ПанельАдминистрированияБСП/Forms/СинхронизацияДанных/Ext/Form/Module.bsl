...
Процедура УстановитьВидимость()
	...
	Если ПодсистемаСуществуетОбменДанными Тогда
		...
		Элементы.ГруппаЗагрузкаДанныхEnterpriseData.Видимость = ?(МассивДоступныхВерсий.Количество() = 0, Ложь, Истина) И НЕ ЭтоБизнесПриложение;
		Элементы.ГруппаИнтерфейсOData.Видимость = НЕ ЭтоБизнесПриложение;

...
Процедура ДекорацияДоходыРасходыНажатие(Элемент)
	...
	ПереключитьСтраницуОтчетаПоЭлементу(Элемент.Имя);
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыДанныеИсточника
...
Процедура ДанныеИсточникаПериодПриИзменении(Элемент)
	...
	ВыровнятьДатуПланированияПоПериодуПланирования(ТекСтрока.Период, ПериодичностьБюджета,
...
&НаКлиенте
Процедура ПереключитьСтраницуОтчетаПоЭлементу(ИмяЭлемента)
	
	Если ИмяЭлемента = "ДекорацияДоходыРасходы" Тогда
	...
	ПереключитьСтраницу(Элементы, ВидыОтчетов, ИмяЭлемента);
...
Процедура УстановитьОформление(УсловноеОформление)
	...
	РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор,
		ИмяЭлемента + ".ТипПоказателя", Перечисления.ТипыПоказателейБизнеса.Доход,
	...
	НовоеУсловноеОформление = УсловноеОформление.Элементы.Добавить();
	РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор,
		ИмяЭлемента + ".ТипПоказателя", Перечисления.ТипыПоказателейБизнеса.Расход,
		ВидСравненияКомпоновкиДанных.Равно);
	РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, ИмяЭлемента);

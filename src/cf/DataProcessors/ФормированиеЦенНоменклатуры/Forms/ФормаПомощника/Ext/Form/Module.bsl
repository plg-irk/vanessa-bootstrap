...
Функция ПодготовитьСтруктуруДанныхПечатиЭтикетокИЦенниковИзДокументов()
	...
	СтруктураДействий.Вставить("ЗаполнитьОрганизацию", ПерсональныеНастройкиРУНФ.Прочитать("ОсновнаяОрганизация"));
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КэшЗначений.Вставить("ОткрыватьПрайсЛистОрганизацииКакСписок", ПерсональныеНастройкиРУНФ.Прочитать("ОткрыватьПрайсЛистОрганизацииКакСписок"));
	...
	ЗакрытьПомощникБезПодтверждения = ПерсональныеНастройкиРУНФ.Прочитать("ЗакрытьПомощникБезПодтверждения");
...
Процедура ЗакрытьПомощникБезПодтвержденияПриИзменении(Элемент)
	...
	ПерсональныеНастройкиРУНФВызовСервера.Установить(ЗакрытьПомощникБезПодтверждения,

...
&НаСервере
Процедура ЗаполнитьОписаниеЗадачиИзменениеСостоянияПриВыполнении()
	...
	+ Символы.НПП;
	Элементы.ДопФункция_0.Заголовок = НСтр("ru = 'Выполнение заказа будет полностью или частично отменено'")+ Символы.НПП;
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа на производство при выполнении'");
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьОписаниеЗадачиСообщенияПриВыполнении()
	...
	Заголовок = НСтр("ru = 'Сообщение при выполнении заказа на производство'");
...
Процедура ОпределитьЗаголовкиПолей(ПолеСтатусВыполнения, ДекорацияТекстОбсуждение)
	...
	Если ЭтоЗадачаСообщенияПриВыполнении() Тогда
		...
		ДекорацияТекстОбсуждение.Заголовок = НСтр("ru = 'напиши в обсуждение и'") + Символы.НПП;
	КонецЕсли;
...
Процедура ОпределитьНаименованиеЗадачи(Задача, СтрокаНастроек)
	...
	Если ЭтоЗадачаСообщенияПриВыполнении() Тогда
		СтрокаДействия = НСтр("ru = 'Оповестить пользователя при'") + Символы.НПП;
	Иначе
		СтрокаДействия = НСтр("ru = 'Изменить состояние заказа на производство при'") + Символы.НПП;
	КонецЕсли;

	Если СтрокаНастроек.СтатусВыполнения = Перечисления.СтатусОтгрузки.Полная Тогда
		СтрокаСтатусВыполнения = НСтр("ru = 'полном выполнении'") + Символы.НПП;
	Иначе
		СтрокаСтатусВыполнения = НСтр("ru = 'частичном выполнении'") + Символы.НПП;
	КонецЕсли;

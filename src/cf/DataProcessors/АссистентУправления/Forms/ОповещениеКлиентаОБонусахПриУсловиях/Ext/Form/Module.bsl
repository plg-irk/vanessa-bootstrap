...
Процедура ТекстОшибкиНеВключеныБонусыНажатие(Элемент)
	...
	ОткрытьФорму("Обработка.НастройкаПрограммы.Форма.НастройкаПрограммы", ПараметрыФормы,ЭтотОбъект,,,,Новый ОписаниеОповещения("ПроверкаНастроекПоБонусам", ЭтотОбъект));

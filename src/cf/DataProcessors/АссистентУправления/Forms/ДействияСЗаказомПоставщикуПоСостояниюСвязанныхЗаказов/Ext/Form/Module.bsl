...
Процедура ЗаполнитьОписаниеЗадачиИзменениеПоЗаказамПокупателей()
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа поставщику по состоянию заказов покупателей'");
...
Процедура ЗаполнитьОписаниеЗадачиСообщениеПоЗаказамПокупателей()
	...
	Заголовок = НСтр("ru = 'Сообщение заказу поставщику по состоянию заказов покупателей'");
...
Процедура ОпределитьЗаголовкиПолей(ЭлементНадписьЗаказПокупателя, ПолеТипПредмета, ДекорацияТекстОбсуждение)
	...
	ДекорацияТекстОбсуждение.Заголовок = НСтр("ru = 'напиши в обсуждение связанного с ними заказа поставщику и'") + Символы.НПП;
	НадписьЗаказПокупателя = НСтр("ru = 'Когда заказы покупателей'");

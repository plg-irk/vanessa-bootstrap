...
Процедура ОпределитьЗаголовкиПолей(ПолеСостояниеЗаказаНаПроизводство, ПолеСостояниеЗаказаПоставщику, ДекорацияТекстОбсуждение)
	...
	Если ТолькоОповестить() Тогда
		ДекорацияТекстОбсуждение.Заголовок = НСтр("ru = 'напиши в обсуждение связанного'") + Символы.НПП;
...
Процедура СоздатьИзменитьЗадачиАссистента()
	...
	Попытка
		...
		Если НЕ ЗначениеЗаполнено(ГруппаЗадач) Тогда
			...
			ГруппаЗадач.Наименование = Заголовок;
...
Процедура ЗаполнитьОписаниеЗадачиИзмененияПоЗаказамПоставщикам()
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа покупателя по состоянию заказов поставщикам'");
...
Процедура ЗаполнитьОписаниеЗадачиИзмененияПоЗаказамНаПроизводство()
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа покупателя по состоянию заказов на производство'");
...
Процедура ЗаполнитьОписаниеЗадачиИзмененияПоЗаказамНаПроизводствоИПоставщикам()
	...
	Элементы.ДопФункция_0.Заголовок = НСтр("ru = 'Заказы на производство и/или поставщикам вернулись в более раннее состояние'")+ Символы.НПП;
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа покупателя по состоянию заказов на производство и поставщикам'");
...
Процедура ЗаполнитьОписаниеЗадачиСообщенияПоЗаказамПоставщикам()
	...
	Элементы.ОсновноеОписание.Заголовок = НСтр("ru = 'Когда изменится состояние заказов поставщикам, Даша сообщит связанному с ними заказу покупателя, а также сообщит, если:'") + Символы.НПП;
	Элементы.ДопФункция_0.Заголовок = НСтр("ru = 'Заказы поставщикам вернулись в более раннее состояние'") + Символы.НПП;
	
	Элементы.КартинкаЗадачи.Картинка = БиблиотекаКартинок.АссистентУправленияСообщениеЗакупки;
	Заголовок = НСтр("ru = 'Сообщение заказу покупателя по состоянию заказов поставщикам'");
...
Процедура ЗаполнитьОписаниеЗадачиСообщенияПоЗаказамНаПроизводство()
	...
	Элементы.ОсновноеОписание.Заголовок = НСтр("ru = 'Когда изменится состояние заказов на производство, Даша сообщит связанному с ними заказу покупателя, а также сообщит, если:'") + Символы.НПП;
	Элементы.ДопФункция_0.Заголовок = НСтр("ru = 'Заказы на производство вернулись в более раннее состояние'") + Символы.НПП;
	
	Элементы.КартинкаЗадачи.Картинка = БиблиотекаКартинок.АссистентУправленияСообщениеПроизводство;
	Заголовок = НСтр("ru = 'Сообщение заказу покупателя по состоянию заказов на производство'");
...
Процедура ЗаполнитьОписаниеЗадачиСообщенияПоЗаказамНаПроизводствоИПоставщикам()
	...
	Элементы.ДопФункция_0.Заголовок = НСтр("ru = 'Заказы поставщикам и/или на производство вернулись в более раннее состояние'") + Символы.НПП;
	
	Элементы.КартинкаЗадачи.Картинка = БиблиотекаКартинок.АссистентУправленияСообщениеЗакупкиИПроизводство;
	Заголовок = НСтр("ru = 'Сообщение заказу покупателя по состоянию заказов на производство и поставщикам'");

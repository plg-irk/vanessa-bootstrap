...
Процедура ЗаполнитьОписаниеЗадачиИзменениеСостоянияПриОплате()
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа поставщику при оплате'");
...
Процедура ЗаполнитьОписаниеЗадачиИзменениеСостоянияПриПоставке()
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа поставщику при поставке'");
...
Процедура ЗаполнитьОписаниеЗадачиИзменениеСостоянияПриОплатеИПоставке()
	...
	Заголовок = НСтр("ru = 'Изменение состояния заказа поставщику при оплате и поставке'");
...
Процедура ЗаполнитьОписаниеЗадачиСообщенияПриОплате()
	...
	Заголовок = НСтр("ru = 'Сообщение при оплате заказа поставщику'");
...
Процедура ЗаполнитьОписаниеЗадачиСообщенияПриПоставке()
	...
	Заголовок = НСтр("ru = 'Сообщение при поставке заказа поставщику'");
...
Процедура ЗаполнитьОписаниеЗадачиСообщенияПриОплатеИПоставке()
	...
	Заголовок = НСтр("ru = 'Сообщение при оплате и поставке заказа поставщику'");

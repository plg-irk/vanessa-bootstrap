...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, СтруктурнаяЕдиница,
		|ПодписьКладовщика, Контрагент, КонтактноеЛицоПодписант, СрокХранения, ВидОперации, Грузоотправитель");
...
Процедура ГрузоотправительОнЖеПриИзменении(Элемент)
	...
	Элементы.ГрузоотправительКонтрагент.Видимость = ГрузоотправительОнЖе;
...
Процедура ЗаписатьНастройкуПользователяСервер(НазваниеНастройки, ЗначениеНастройки)
	...
	ПерсональныеНастройкиРУНФ.Установить(ЗначениеНастройки, НазваниеНастройки, ,
...
Процедура УстановитьОтображениеГрузоперевозки()
	...
	Если КонтекстПечати.ВидОперации = Перечисления.ВидыОперацийПриходнаяНакладная.ПоступлениеОтПоставщика Тогда
		Элементы.Грузоотправитель.Видимость = НЕ ГрузоотправительОнЖе;
		Элементы.ГрузоотправительКонтрагент.Видимость = ГрузоотправительОнЖе;
	Иначе

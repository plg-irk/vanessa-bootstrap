...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РежимВыполнениеЭтапов = ПерсональныеНастройкиРУНФ.Прочитать("РежимВыполнениеЭтапов");
	Режим = Число(РежимВыполнениеЭтапов);
КонецПроцедуры
...
Процедура РежимПриИзменении(Элемент)
	...
	СтруктураДанных = Новый Структура;
	Режим = ?(Режим = 1, 0, 1);
	Оповещение = Новый ОписаниеОповещения("ОбновитьРежим", ЭтотОбъект, СтруктураДанных);
...
&НаКлиенте
Процедура РасширеныйРежим(Команда)
	Режим = 1;
	СтруктураДанных = Новый Структура;
	Оповещение = Новый ОписаниеОповещения("ОбновитьРежим", ЭтотОбъект, СтруктураДанных);
	ПроверитьМодифицированностьИПродолжить(Оповещение);
...
Процедура ОбновитьУсловноеОформление()
	...
	Для ии = 1 По КоличествоЭтапов Цикл
		...
		РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, "Заказы.ЭтапОстаток" + ии,0,ВидСравненияКомпоновкиДанных.Равно);
		РаботаСФормой.ДобавитьЭлементУсловногоОформления(НовоеУсловноеОформление, "ТолькоПросмотр", Истина);
		
		
		НовоеУсловноеОформление = УсловноеОформление.Элементы.Добавить();
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКПроизводству" + ии);
		РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, "Заказы.ЭтапОстаток" + ии,0,ВидСравненияКомпоновкиДанных.Равно);
		РаботаСФормой.ДобавитьЭлементУсловногоОформления(НовоеУсловноеОформление, "Видимость", Ложь);
		
		
		НовоеУсловноеОформление = УсловноеОформление.Элементы.Добавить();
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКПроизводствуЗаголовок" + ии);
		РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, "Заказы.ЭтапОстаток" + ии,0,ВидСравненияКомпоновкиДанных.Равно);
		РаботаСФормой.ДобавитьЭлементУсловногоОформления(НовоеУсловноеОформление, "Видимость", Ложь);
		
		
		НовоеУсловноеОформление = УсловноеОформление.Элементы.Добавить();
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтап" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапПометка" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапОстатокЗаголовок" + ии);
		...
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "СтруктурнаяЕдиница" + ии);
		
		РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, "Заказы.ЭтапНедоступен" + ии, Истина);
		РаботаСФормой.ДобавитьЭлементУсловногоОформления(НовоеУсловноеОформление, "ЦветФона", ЦветаСтиля.ЦветФонаРежимаПродажиРМК);
		...
		НовоеУсловноеОформление = УсловноеОформление.Элементы.Добавить();
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКПроизводству" + ии);
		РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, "Заказы.ЭтапКПроизводству" + ии,0,ВидСравненияКомпоновкиДанных.Больше);
		РаботаСФормой.ДобавитьЭлементУсловногоОформления(НовоеУсловноеОформление, "ЦветФона", ЦветаСтиля.ЦветФонаРежимаСкупкиРМК);
		...
		Если ИспользоватьСтруктурныеЕдиницы И ВыполнениеЭтаповРазнымиПодразделениями Тогда
			...
			НовоеУсловноеОформление = УсловноеОформление.Элементы.Добавить();
			РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапСтруктурнаяЕдиница" + ии);
			РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, ВыполнениеЭтаповРазнымиПодразделениями, Ложь);
			ГруппаУсловий = РаботаСФормой.ДобавитьГруппуЭлементовОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИли);
			РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(ГруппаУсловий, "Заказы.ЭтапНедоступен" + ии, Истина);
//			РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(ГруппаУсловий, "Заказы.ЭтапОстаток" + ии,0,ВидСравненияКомпоновкиДанных.Равно);
...
//			РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(ГруппаУсловий, "Заказы.ЭтапОстаток" + ии,0,ВидСравненияКомпоновкиДанных.Равно);
		...
		НовоеУсловноеОформление = УсловноеОформление.Элементы.Добавить();
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапОстатокЗаголовок" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапОстаток" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКИсполнению" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКВыполнению" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКПроизводству" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКПроизводствуЗаголовок" + ии);
		РаботаСФормой.ДобавитьОформляемыеПоля(НовоеУсловноеОформление, "ЗаказыЭтапКИсполнениюЗаголовок" + ии);
		РаботаСФормой.ДобавитьЭлементОтбораКомпоновкиДанных(НовоеУсловноеОформление.Отбор, "Режим", 0,ВидСравненияКомпоновкиДанных.Равно);
		РаботаСФормой.ДобавитьЭлементУсловногоОформления(НовоеУсловноеОформление, "Видимость", Ложь);
...
&НаКлиенте
Процедура ОбновитьРежим(Результат, ДополнительныеДанные) Экспорт
	...
	Режим = ?(Режим = 1, 0, 1);
	ОбновитьРеквизитыДереваЗаказов(КоличествоЭтапов);
	УстановитьНастройку("РежимВыполнениеЭтапов", Режим);
	ЗаполнитьДеревоЗаказовКлиент();
КонецПроцедуры
...
&НаКлиенте
Процедура Подключаемый_КВыполнениюПриИзменении(Элемент)
	
	Модифицированность = Истина;
	
	НомерЭтапа = СтрЗаменить(Элемент.Имя, "ЗаказыЭтапКПроизводству", "");
	
	ТекущаяСтрока = Элементы.Заказы.ТекущиеДанные;
	ТекущаяСтрока["ЭтапПометка" + НомерЭтапа] = Истина;
	СклоненныйЭтап = ПолучитьСклонениеЭтапа(ТекущаяСтрока["Этап" + НомерЭтапа], 1);
	НаименованиеЭтапа = "К " + СтрЗаменить(СклоненныйЭтап,"1","") + " %1 %2";
	
	ПриИзмененииПометкиЭтапа(ТекущаяСтрока, НомерЭтапа);
КонецПроцедуры

&НаСервере
Функция ПолучитьСклонениеЭтапа(НаименованиеЭтапа, КПроизводству)
	Возврат ПолучитьСклоненияСтрокиПоЧислу(НаименованиеЭтапа, КПроизводству,,
	"ЧС=Количественное", "ПД=Дательный")[0];
КонецФункции
	...
	Для каждого СтрокаЗаказ Из ДеревоЗаказов.Строки Цикл
		...
		Для каждого СтрокаПродукция Из СтрокаЗаказ.Строки Цикл
			...
			Для каждого СтрокаЭтап Из СтрокаПродукция.Строки Цикл
				...
				НоваяСтрокаПродукция["ЭтапОстаток"+НомерЭтапа] = СтрокаЭтап.Остаток;
				Если СтрокаЭтап.Остаток > 0 Тогда
					НоваяСтрокаПродукция["ЭтапОстатокЗаголовок"+НомерЭтапа] =  СтрШаблон(Нстр("ru = 'Осталось %1 %2'"),СтрокаЭтап.Остаток,СтрокаПродукция.ЕдиницаИзмерения);
				Иначе
					НоваяСтрокаПродукция["ЭтапОстатокЗаголовок"+НомерЭтапа] = Нстр("ru = 'Этап выполнен полностью'");
				КонецЕсли;
				
				НоваяСтрокаПродукция["ЭтапКПроизводству"+НомерЭтапа] = СтрокаЭтап.Остаток;
				НоваяСтрокаПродукция["ЭтапКПроизводствуЗаголовок"+НомерЭтапа] = Нстр("ru = ''");
...
// В данной процедуре мы создаем все новые реквизиты формы, при добавлении группы или элемента на форму необходимо
// его инициализировать в этой процедуре
&НаСервере
Процедура ОбновитьРеквизитыДереваЗаказов(НовоеКоличествоЭтапов)
	...
	Если НовоеКоличествоЭтапов>КоличествоЭтапов Тогда
		...
		Для ии = КоличествоЭтапов + 1 По НовоеКоличествоЭтапов Цикл
			...
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы("ЭтапОстаток" + ии, Новый ОписаниеТипов("Число",Новый КвалификаторыЧисла(10,3)), "Заказы"));
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы("ЭтапОстатокЗаголовок" + ии, Новый ОписаниеТипов("Строка", Новый КвалификаторыСтроки(0)), "Заказы"));
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы("ЭтапКПроизводству" + ии, Новый ОписаниеТипов("Число",Новый КвалификаторыЧисла(10,3)), "Заказы"));
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы("ЭтапКВыполнению" + ии, Новый ОписаниеТипов("Число",Новый КвалификаторыЧисла(10,3)), "Заказы"));
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы("ЭтапКПроизводствуЗаголовок" + ии, Новый ОписаниеТипов("Строка", Новый КвалификаторыСтроки(0)), "Заказы"));
	...
	ИначеЕсли НовоеКоличествоЭтапов<КоличествоЭтапов Тогда
		...
		Для ии = НовоеКоличествоЭтапов + 1 По КоличествоЭтапов Цикл
			...
			МассивУдаляемыхРеквизитов.Добавить("Заказы.ЭтапОстаток" + ии);
			МассивУдаляемыхРеквизитов.Добавить("Заказы.ЭтапОстатокЗаголовок" + ии);
			МассивУдаляемыхРеквизитов.Добавить("Заказы.ЭтапКпроизводству" + ии);
			МассивУдаляемыхРеквизитов.Добавить("Заказы.ЭтапКПроизводствуЗаголовок" + ии);
			МассивУдаляемыхРеквизитов.Добавить("Заказы.ЭтапКВыполнению" + ии);
...
//процедура отрисовывает внешний вид иерархии и колонок этапов
&НаСервере
Процедура ОбновитьЭлементыФормы(НовоеКоличествоЭтапов)
	...
	Если НовоеКоличествоЭтапов>КоличествоЭтапов Тогда
		...
		Для ии = КоличествоЭтапов + 1 По НовоеКоличествоЭтапов Цикл
			...
			ГруппаЗаголовок = Элементы.Добавить("ЗаказыГруппаЗаголовок" + ии, Тип("ГруппаФормы"), Группа);
			ГруппаЗаголовок.Вид = ВидГруппыФормы.ГруппаКолонок;
			ГруппаЗаголовок.Группировка = ГруппировкаКолонок.ВЯчейке;
			ГруппаЗаголовок.ОтображатьВШапке = Ложь;
			ГруппаЗаголовок.РастягиватьПоГоризонтали = Ложь;
			ГруппаЗаголовок.Ширина = 15;
			
			ЭлементПометка = Элементы.Добавить("ЗаказыЭтапПометка" + ии, Тип("ПолеФормы"), ГруппаЗаголовок);
			...
			ЭлементЗаголовок = Элементы.Добавить("ЗаказыЭтапЗаголовок" + ии, Тип("ПолеФормы"), ГруппаЗаголовок);
			...
			ЭлементЗаголовок.Ширина = 15; 
			
			
			
			
			ГруппаКПроизводству = Элементы.Добавить("ЗаказыГруппаКПроизводству" + ии, Тип("ГруппаФормы"), Группа);
			ГруппаКПроизводству.Вид = ВидГруппыФормы.ГруппаКолонок;
			ГруппаКПроизводству.Группировка = ГруппировкаКолонок.ВЯчейке;
			ГруппаКПроизводству.ОтображатьВШапке = Ложь;
			ГруппаКПроизводству.РастягиватьПоГоризонтали = Ложь;
			ГруппаКПроизводству.Ширина = 15;
			
			ЭлементКПроизводству = Элементы.Добавить("ЗаказыЭтапКПроизводству" + ии, Тип("ПолеФормы"), ГруппаКПроизводству);
			ЭлементКПроизводству.Вид = ВидПоляФормы.ПолеВвода;
			ЭлементКПроизводству.ПутьКДанным = "Заказы.ЭтапКПроизводству" + ии;
			ЭлементКПроизводству.ОтображатьВШапке = Ложь;
			ЭлементКПроизводству.РежимРедактирования = РежимРедактированияКолонки.ВходПриВводе;
			ЭлементКПроизводству.ПодсказкаВвода = Нстр("ru = 'К выполнению на этапе'");
			ЭлементКПроизводству.УстановитьДействие("ПриИзменении", "Подключаемый_КВыполнениюПриИзменении"); 
			
			ЭлементКПроизводствуЗаголовок = Элементы.Добавить("ЗаказыЭтапКПроизводствуЗаголовок" + ии, Тип("ПолеФормы"), ГруппаКПроизводству);
			ЭлементКПроизводствуЗаголовок.Вид = ВидПоляФормы.ПолеНадписи;
			ЭлементКПроизводствуЗаголовок.ПутьКДанным = "Заказы.ЭтапКПроизводствуЗаголовок" + ии;
			ЭлементКПроизводствуЗаголовок.ОтображатьВШапке = Ложь;
			ЭлементКПроизводствуЗаголовок.Ширина = 0;
			ЭлементКПроизводствуЗаголовок.Видимость = Ложь;
			
			ГруппаОстаток = Элементы.Добавить("ЗаказыГруппаОстаток" + ии, Тип("ГруппаФормы"), Группа);
			ГруппаОстаток.Вид = ВидГруппыФормы.ГруппаКолонок;
			ГруппаОстаток.Группировка = ГруппировкаКолонок.ВЯчейке;
			ГруппаОстаток.ОтображатьВШапке = Ложь;
			ГруппаОстаток.РастягиватьПоГоризонтали = Ложь;
			ГруппаОстаток.Ширина = 15;
			
			ЭлементОстаток = Элементы.Добавить("ЗаказыЭтапОстаток" + ии, Тип("ПолеФормы"), ГруппаОстаток);
			ЭлементОстаток.Вид = ВидПоляФормы.ПолеНадписи;
			ЭлементОстаток.ПутьКДанным = "Заказы.ЭтапОстаток" + ии;
			ЭлементОстаток.ОтображатьВШапке = Ложь;
			ЭлементОстаток.Видимость = Ложь;
			
			ЭлементОстатокЗаголовок = Элементы.Добавить("ЗаказыЭтапОстатокЗаголовок" + ии, Тип("ПолеФормы"), ГруппаОстаток);
			ЭлементОстатокЗаголовок.Вид = ВидПоляФормы.ПолеНадписи;
			ЭлементОстатокЗаголовок.ПутьКДанным = "Заказы.ЭтапОстатокЗаголовок" + ии;
			ЭлементОстатокЗаголовок.ОтображатьВШапке = Ложь;
			ЭлементОстатокЗаголовок.Ширина = 15; 
			ЭлементОстатокЗаголовок.ТолькоПросмотр = Истина;
	...
	ИначеЕсли НовоеКоличествоЭтапов<КоличествоЭтапов Тогда
		...
		Для ии = НовоеКоличествоЭтапов + 1 По КоличествоЭтапов Цикл
			...
			УдалитьЭлементФормы("ЗаказыЭтапОстаток" + ии);
...
&НаСервере
Процедура УстановитьНастройку(ИмяНастройки, Режим = 0)
	
	ПерсональныеНастройкиРУНФ.Установить(Режим, ИмяНастройки);

...
Процедура ПодготовитьДанныеНастроекОбмена(Параметры, АдресРезультата) Экспорт
	...
	ТекстЗапроса = "
		...
		|	ИЛИ УРМККассыККМ.Ссылка.ТорговыйОбъект.Родитель = &ТорговыйОбъект)
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|	И ([ТорговыйОбъект] = &ТорговыйОбъект ИЛИ [ТорговыйОбъект].Родитель = &ТорговыйОбъект)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ПрефиксПриемника) Тогда
			...
			Если Параметры.ИспользоватьПараметрыТранспортаFILE Тогда
				...
				КаталогНастроек = Параметры.КаталогОбменаИнформацией;
				Параметры.КаталогОбменаИнформацией = ПодкаталогПоПрефиксуПриемника(КаталогНастроек, ПрефиксПриемника, Результат);
			...
			ЗаполнитьЗначенияСвойств(Параметры.НастройкиТранспорта, Параметры);

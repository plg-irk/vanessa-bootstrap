...
Процедура СоздатьЭлементыНоменклатурыПриИзменении(Элемент)
	Элементы.ГруппаСоздатьЭлементыНоменклатурыДополнительныеНастройки.Доступность = СоздатьЭлементыНоменклатуры;
	
	ПерезаполнитьЗначенияРеквизитовНоменклатуры = СоздатьЭлементыНоменклатуры;
	СоздатьИерархиюНоменклатуры = СоздатьЭлементыНоменклатуры;
	СоздатьХарактеристикиНоменклатуры = СоздатьЭлементыНоменклатуры;
	СоздатьКатегорииНоменклатуры = СоздатьЭлементыНоменклатуры;
	СоздатьИерархиюКатегорийНоменклатуры = СоздатьЭлементыНоменклатуры;
	ЗагрузитьИзображения = СоздатьЭлементыНоменклатуры;

	Элементы.СоздатьИерархиюКатегорийНоменклатуры.Доступность = СоздатьКатегорииНоменклатуры;
...
Процедура СоздатьКатегорииНоменклатурыПриИзменении(Элемент)
	...
	СоздатьИерархиюКатегорийНоменклатуры = СоздатьКатегорииНоменклатуры;
КонецПроцедуры

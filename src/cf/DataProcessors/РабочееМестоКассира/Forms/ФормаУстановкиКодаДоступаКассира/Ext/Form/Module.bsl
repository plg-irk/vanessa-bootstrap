...
Процедура СформироватьНовыйКодДоступаСотрудника()
	...
	Если ИспользуетсяОтправкаEmail Тогда
...
Процедура ПодготовитьЭлементыОтправкиКодаДоступаНаEmail()
	...
	ИспользуетсяОтправкаEmail = ДоступнаОтправкаЭлектроннойПочты();
	Элементы.ОтправлятьКодПоEmail.Видимость = ИспользуетсяОтправкаEmail;

...
Процедура СформироватьДокументыСервер(ОрганизацияПолучатель)
	...
	Пока ВыборкаПоПериоду.Следующий() Цикл
		...
		Пока ВыборкаПоОрганизации.Следующий() Цикл
			...
			НастройкиНДС = НалогиУНФ.НастройкиНДСОрганизации(ВыборкаПоНоменклатуре.ОрганизацияВладелец, ,
				ВыборкаПоНоменклатуре.Период);
			...
			Если ДокументыПередачи.Количество() = 0 Тогда
				...
				ПередачаТоваровМеждуОрганизациями.НалогообложениеНДС = НастройкиНДС.ТипНалогообложения;
			...
			ПараметрыСтавкиНДС = НоменклатураВДокументахСервер.ПараметрыОпределенияСтавкиНДС();
			ПараметрыСтавкиНДС.Организация = ПередачаТоваровМеждуОрганизациями.Организация;
			ПараметрыСтавкиНДС.ДатаОбработки = ПередачаТоваровМеждуОрганизациями.Дата;
			ПараметрыСтавкиНДС.НалогообложениеНДС = ПередачаТоваровМеждуОрганизациями.НалогообложениеНДС;
			ПараметрыСтавкиНДС.ВидСтавкиНДСПоУмолчанию = НастройкиНДС.ВидСтавкиНДС;
			...
			Пока ВыборкаПоНоменклатуре.Следующий() Цикл
				...
				Если НайденныеСтроки.Количество() = 0 Тогда
					...
					ПараметрыСтавкиНДС.Номенклатура = ВыборкаПоНоменклатуре.Номенклатура;
					ПараметрыСтавкиНДС.НоменклатураВидСтавкиНДС = ВыборкаПоНоменклатуре.ВидСтавкиНДС;
					ДанныеНДС = НоменклатураВДокументахСервер.ДанныеНДССтрокиНоменклатуры(ПараметрыСтавкиНДС);
					НоваяСтрокаЗапасов.СтавкаНДС = ДанныеНДС.СтавкаНДС;

...
&НаКлиенте
Процедура ДиагностикаПодключенияНажатие(Элемент)
	
	ПараметрыФормы = Новый Структура;
	ОткрытьФорму("Обработка.НастройкаПрограммы.Форма.НастройкаТелефонииДиагностика", ПараметрыФормы, ЭтотОбъект);
...
Процедура АТС_Билайн_КлючДляАвторизацииВОблачнойАТСПриИзменении(Элемент)
	...
	Оповестить("Телефония_ДиагностикаОбновлениеНастроек");
...
#Область ОбработчикиСобытийЭлементовНастроекОбработкиЗвонков

&НаКлиенте
Процедура ДействиеПропущенныйЗвонокПриИзменении(Элемент)
	
	ЗаписатьЗначениеОбщейНастройкиТелефонии("ДействиеПропущенногоЗвонка", ДействиеПропущенныйЗвонок);
	ОбновитьПовторноИспользуемыеЗначения();

	Элементы.СлужебныйПользователь.Видимость = ?(ДействиеПропущенныйЗвонок = "ПоследнегоОтклонившегоЗвонок", Ложь, Истина);
	Если ДействиеПропущенныйЗвонок = "ПоследнегоОтклонившегоЗвонок" Тогда
		ЗаписатьЗначениеОбщейНастройкиТелефонии("СлужебныйПользовательДляПропущенногоЗвонка",
...
&НаКлиенте
Процедура СлужебныйПользовательПриИзменении(Элемент)
	
	ЗаписатьЗначениеОбщейНастройкиТелефонии("СлужебныйПользовательДляПропущенногоЗвонка", СлужебныйПользователь);
	ОбновитьПовторноИспользуемыеЗначения();
...
Процедура ЗаписатьЗначениеНастройкиИнтеграцииАТС(ТаблицаНастроек, Индекс)
	...
	ЗаписатьЗначениеНастройкиИнтеграцииАТССервер(ТаблицаНастроек, Индекс);
...
Процедура ЗаполнитьДействияОбработкиЗвонков()
	...
	Элементы.ДействиеИсходящийЗвонок.СписокВыбора.Добавить("Вызов", НСтр("ru='Вызов'"));
	Элементы.ДействиеИсходящийЗвонок.СписокВыбора.Добавить("ОткрытьСобытие", НСтр("ru='Открыть событие'"));
	Элементы.ДействиеИсходящийЗвонок.СписокВыбора.Добавить("ОткрытьСобытиеИЗвонок", НСтр("ru='Открыть событие + вызов'"));
	
	Элементы.ДействиеПропущенныйЗвонок.СписокВыбора.Добавить("ПоследнегоОтклонившегоЗвонок", НСтр("ru='Сотрудник отклонивший звонок последним'"));
	Элементы.ДействиеПропущенныйЗвонок.СписокВыбора.Добавить("НазначитьСотрудника", НСтр("ru='Назначить сотрудника'"));
...
Процедура ПрочитатьЗначенияНастроек()
	...
	ДействиеПропущенныйЗвонок                  = НастройкиТелефонии.ДействиеПропущенногоЗвонка;
	СлужебныйПользователь                      = НастройкиТелефонии.СлужебныйПользовательДляПропущенногоЗвонка;
...
&НаСервере
Процедура ЗаписатьЗначениеНастройкиИнтеграцииАТССервер(ТаблицаНастроек, Индекс)

...
//
// Параметры:
//  СписокДокументов - Массив из ДокументСсылка.ПриемНаРаботуУНФ,
//  						ДокументСсылка.КадровоеПеремещениеУНФ,
//  						ДокументСсылка.УвольнениеУНФ 
//
...
//												иначе пустая строка
//       * Данные    				- Массив из Структура - реквизиты для заполнения кадровых документов рег. учета
//

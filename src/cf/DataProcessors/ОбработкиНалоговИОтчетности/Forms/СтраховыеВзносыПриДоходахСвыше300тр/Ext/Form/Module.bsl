...
Процедура УплаченоСНачалоГОДСвыше300трНажатие(Элемент, СтандартнаяОбработка)
	...
	Новый Структура("Организация, СформироватьПриОткрытии, Период,ВидВзаиморасчетов, УчетВыплатТекущегоГода, ЗадачиКалендаря, ПользовательскиеНастройки",
	Объект.Организация, Истина, ПериодПараметр, СпсВидов, Ложь, СпсЗадач, КомпоновщикНастроек.ПользовательскиеНастройки));

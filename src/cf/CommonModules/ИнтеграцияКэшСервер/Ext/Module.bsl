...
//  ДатаАктуальности - Неопределено - Дата актуальности
...
//  Неопределено, Произвольный - Кэш получить
...
// Дата актуальности кэша по умолчанию.
// 
// Возвращаемое значение:
//  Дата - Дата актуальности кэша по умолчанию
Функция ДатаАктуальностиКэшаПоУмолчанию() Экспорт
	Возврат ДобавитьМесяц( ТекущаяДатаСеанса(), 1 );
КонецФункции

// Удалить неактуальные значения из кэша.

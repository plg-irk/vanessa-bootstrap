...
// Возвращает структуру, характеризующую состояние последней кассовой смены по кассе ККМ.
//
...
Функция ПолучитьРеквизитыКассира(КассирДляПечати) Экспорт
	
	Возврат РозничныеПродажиСервер.ПолучитьРеквизитыКассира(КассирДляПечати);
	
КонецФункции

Функция ПолучитьРеквизитыМестаРасчета(КассаККМ, ВариантЗаполненияМестаРасчетов) Экспорт
	
	Возврат РозничныеПродажиСервер.ПолучитьРеквизитыМестаРасчета(КассаККМ, ВариантЗаполненияМестаРасчетов);
	
КонецФункции

Функция ЗакрытьКассовуюСмену(КассаККМ, ОписаниеОшибки) Экспорт
	
	Возврат РозничныеПродажиСервер.ЗакрытьКассовуюСмену(КассаККМ, ОписаниеОшибки);
...
Процедура ЗаполнитьПредставленияНоменклатурыИХарактеристики(ПредставлениеНоменклатуры, ПредставлениеХарактеристики,
	...
	Если ЗначениеЗаполнено(Номенклатура) Тогда
		ПредставлениеНоменклатуры = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Номенклатура,
			"НаименованиеПолное");
	КонецЕсли;
	Если ЗначениеЗаполнено(Характеристика) Тогда
		ПредставлениеХарактеристики = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Характеристика,

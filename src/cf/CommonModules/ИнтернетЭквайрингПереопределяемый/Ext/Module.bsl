...
Процедура ПриОпределенииНастроекПодключения(Настройки) Экспорт
	...
	ИнтеграцияСПлатежнымиСистемамиУНФ.ПриОпределенииНастроекИнтеграцииИнтернетЭквайринга(
		"СоответствиеНастроекИнтеграцииУНФИнтернетЭквайринг",
		Настройки);
...
Процедура ПриНастройкеЭлементовФормыПодключения(
	...
	ИнтеграцияСПлатежнымиСистемамиУНФ.ПриНастройкеЭлементовФормыПодключенияИнтернетЭквайринг(
		НастройкиФормы,
		НастройкиЭлементов,
...
Процедура ПриЗаписиНастроекПодключения(
	...
	ИнтеграцияСПлатежнымиСистемамиУНФ.ПриЗаписиНастроекПодключенияИнтернетЭквайринга(
		ПрикладныеНастройки,
		Отказ,
		СообщениеОбОшибке);
...
Процедура ПриФормированииЗаказаНаВозврат(
	...
	ИнтеграцияСПлатежнымиСистемамиУНФ.ПриФормированииЗаказаНаВозвратИнтернетЭквайринга(
		ДокументВозврата,
		ЗаказНаВозврат,
		НастройкаПодключения,
		ДополнительныеПараметры);
...
Процедура ПриЗагрузкеСтатусаОперации(
	...
	ИнтеграцияСПлатежнымиСистемамиУНФ.ПриЗагрузкеСтатусаОперацииИнтернетЭквайринг(
		ДокументОперации,
		НастройкаПодключения,
		РезультатОбработки,
		Обработан);

...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьДанныеУПД_5_02_ИнформацияПокупателя(Основания, Данные, Отказ);
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент_5_02(ДеревоДанных, СсылкиНаВладельцев = Неопределено, СпособОбработки = Неопределено, ОписаниеОшибки = "") Экспорт
	...
	Попытка
		...
		Если ФункцияУПД = "СЧФДОП" Тогда
			...
			УправлениеНебольшойФирмойЭлектронныеДокументыСервер.НайтиСоздатьУПДДокументОПередаче_5_02(ДеревоДанных, ПервичныйДокумент,, СпособОбработки, ОписаниеОшибки);
			...
			УправлениеНебольшойФирмойЭлектронныеДокументыСервер.НайтиСоздатьУПДСчетФактуру_5_02(ДеревоДанных, СчетФактура);
...
Процедура ПриОпределенииТипаУчастникаЭДО(ПроверяемоеЛицо, Признаки) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПриОпределенииТипаУчастникаЭДО(ПроверяемоеЛицо, Признаки);	
...
Процедура ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента) Экспорт
	...
	ИначеЕсли ТипИсточника = Тип("ДокументСсылка.ПеремещениеМеждуМОДИСМП")
		...
		Если ТипИсточника = Тип("ДокументСсылка.ПеремещениеМеждуМОДИСМП") Тогда
		...
		ПараметрыЭД.Направление = НаправленияДокументов.Исходящий;
		ПараметрыЭД.Организация = ЗначенияРеквизитов.Организация;
		ПараметрыЭД.Контрагент  = ЗначенияРеквизитов.Организация;
		ПараметрыЭД.ДоговорКонтрагента = ОбщегоНазначенияИС.ПустоеЗначениеОпределяемогоТипа(Метаданные.ОпределяемыеТипы.ДоговорКонтрагентаИС);
...
Процедура ЗаполнитьСоответствиеСтавокНДС(Соответствие) Экспорт
	...
	Соответствие.Вставить("22",      Справочники.СтавкиНДС.ПустаяСсылка());
	...
	Соответствие.Вставить("22/122",  Справочники.СтавкиНДС.ПустаяСсылка());
	Соответствие.Вставить("5",       Справочники.СтавкиНДС.ПустаяСсылка());
	Соответствие.Вставить("7",       Справочники.СтавкиНДС.ПустаяСсылка());
	Соответствие.Вставить("5/105",   Справочники.СтавкиНДС.ПустаяСсылка());
	Соответствие.Вставить("7/107",   Справочники.СтавкиНДС.ПустаяСсылка());
	Соответствие.Вставить("9,09",    Справочники.СтавкиНДС.ПустаяСсылка());
	Соответствие.Вставить("16,67",   Справочники.СтавкиНДС.ПустаяСсылка());
	Соответствие.Вставить("18,03",   Справочники.СтавкиНДС.ПустаяСсылка());

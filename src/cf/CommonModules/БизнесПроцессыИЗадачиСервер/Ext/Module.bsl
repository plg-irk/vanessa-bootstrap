...
Процедура ЗаполнитьОтветственногоЗаКонтрольИсполнения() Экспорт
	...
	// РУНФ
	ВсеОбъектыАдресации = ОбщегоНазначения.ПредопределенныйЭлемент(
		"ПланВидовХарактеристик.ОбъектыАдресацииЗадач.ВсеОбъектыАдресации");
	Если Не ЗначениеЗаполнено(ВсеОбъектыАдресации) Тогда
		Возврат;
	КонецЕсли;
	
	ОтветственныйЗаКонтрольИсполнения = ОбщегоНазначения.ПредопределенныйЭлемент(
		"Справочник.РолиИсполнителей.ОтветственныйЗаКонтрольИсполнения");
	Если Не ЗначениеЗаполнено(ОтветственныйЗаКонтрольИсполнения) Тогда
		Возврат;
	КонецЕсли;
	// Конец РУНФ
	
	РольОбъект = ОтветственныйЗаКонтрольИсполнения.ПолучитьОбъект();
...
Процедура ЗаполнитьНаименованиеПредопределенногоЭлементаВсеОбъектыАдресации() Экспорт
	...
	Ссылка = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
		ПланыВидовХарактеристик.ОбъектыАдресацииЗадач.ВсеОбъектыАдресации, "Ссылка");

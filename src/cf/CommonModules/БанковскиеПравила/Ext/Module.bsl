...
Функция ЭтоСчетДепозитаБанка(БалансовыйСчет) Экспорт
	...
	СоответствиеСчетов = БанковскиеСчетаКлиентСервер.СоответствиеСпецСчетовБанка();
...
//  Строка - балансовый счет ЕКС, всегда равен "40102".
//
...
//
// Параметры:
//  НомерКорСчетаБанка - Строка - Номер корреспондентского счета банка.
//  БИКБанка - Строка - БИК банка.
//
// Возвращаемое значение:
//  Булево - Истина, если контрольный ключ в номере корреспондентского счета банка верен, иначе Ложь.
//
...
//
// Возвращаемое значение:
//  Булево - Истина, если переданный БИК является кодом Территориального органа Федерального казначейства, иначе Ложь.
//
...
//
// Возвращаемое значение:
//  Строка - Идентификатор операции "CTOB".
//
...
//
// Возвращаемое значение:
//  Строка - Идентификатор операции "BTOC".
//

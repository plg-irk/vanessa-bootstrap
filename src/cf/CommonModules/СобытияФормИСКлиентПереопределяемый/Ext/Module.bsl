...
Процедура ВыполнитьПереопределяемуюКоманду(Форма, Команда) Экспорт
	...
	Если Команда.Имя = "КомандаУНФЗаполнитьЦеныПоВидуЦен" Тогда
		
		ДополнительныеПараметры = Новый Структура;
		ДополнительныеПараметры.Вставить("Форма", Форма);
		
		ОписаниеОповещения = Новый ОписаниеОповещения("ПриЗакрытииФормыВыбораВидаЦен", СобытияФормИСУНФКлиент, ДополнительныеПараметры);

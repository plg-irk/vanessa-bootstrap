...
//  Строка - Содержание проводки
//
Функция ВозникновениеОбязательствПокупателя() Экспорт
	
	Возврат НСтр("ru='Возникновение обязательств покупателя'");
...
//  Строка - Содержание проводки
//
Функция ПрочиеЗатраты() Экспорт
	
	Возврат НСтр("ru = 'Прочие затраты (расходы)'");
...
//  Строка - Содержание проводки
//
Функция УменьшениеДолгаКонтрагента() Экспорт
	
	Возврат НСтр("ru='Уменьшение долга контрагента'");
...
//  Строка - Содержание проводки
//
Функция УвеличениеДолгаКонтрагента() Экспорт
	
	Возврат НСтр("ru='Увеличение долга контрагента'");
...
//  Строка - Содержание проводки
//
Функция РасчетыПоПрочимОперациям() Экспорт
	
	Возврат НСтр("ru='Учет расчетов по прочим операциям'");
...
//  Строка - Содержание проводки
//
Функция НачислениеЗарплаты() Экспорт
...
//  Строка - Содержание проводки
//
Функция ПеремещениеЗапасов() Экспорт
	
	Возврат НСтр("ru = 'Перемещение запасов'");
...
//  Строка - Содержание проводки
//
Функция ОтнесениеЗатратНаПродукцию() Экспорт
	
	Возврат НСтр("ru = 'Отнесение затрат на продукцию'");
...
//  Строка - Содержание проводки
//
Функция РеализацияКомиссионныхТоваров() Экспорт
	
	Возврат НСтр("ru = 'Реализация комиссионных товаров'");

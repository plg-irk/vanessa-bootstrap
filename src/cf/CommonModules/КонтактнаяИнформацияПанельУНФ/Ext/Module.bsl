...
Процедура ПроверитьСоздатьРеквизитыПанели(Форма, ИмяГруппыРазмещения, СписокКонтекстноеМеню)
	...
	Если ЕстьРеквизитФормы(РеквизитыФормы, "ЕстьТаблицаДанныеПанелиКонтактнойИнформации") Тогда
		Возврат;
	КонецЕсли;
	...
	Если НЕ ЕстьРеквизитФормы(РеквизитыФормы, "ИспользуетсяРаботаССобытиями") Тогда
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИспользуетсяРаботаССобытиями", Новый ОписаниеТипов("Булево")));
	КонецЕсли;
	Если НЕ ЕстьРеквизитФормы(РеквизитыФормы, "КИ_НужноИзменитьДанныеПриАктивизацииСтрокиТаблицы") Тогда
		ДобавляемыеРеквизиты.Добавить(
		Новый РеквизитФормы("КИ_НужноИзменитьДанныеПриАктивизацииСтрокиТаблицы", Новый ОписаниеТипов("Булево")));
	КонецЕсли;
 	Если НЕ ЕстьРеквизитФормы(РеквизитыФормы, "ПараметрыКИ") Тогда
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ПараметрыКИ", Новый ОписаниеТипов()));
	КонецЕсли;
	...
	Попытка
    	Форма.ПараметрыКИ = КонтактнаяИнформацияУНФВызовСервера.ПолучитьПараметрыКонтактнойИнформацииНаСервере();
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		ТекстОшибки = ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
		ЗаписьЖурналаРегистрации(НСтр("ru='Ошибка получения параметров контактной информации'", ОбщегоНазначения.КодОсновногоЯзыка()),

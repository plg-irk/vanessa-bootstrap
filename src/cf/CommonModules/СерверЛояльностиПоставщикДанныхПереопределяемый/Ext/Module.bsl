...
//  СтруктураОтвета	 - Структура										 - Структура ответа данные карты.
...
//
// Параметры:
//  ПараметрыРасчета - Структура - параметры расчета автоматических скидок.
...
//  Результат		 - Структура	 - содержит данные о запретах продаж
//
...
Процедура ПолучитьИспользованныеПромокоды(Документ, МассивПромокодов) Экспорт
	...
	СерверЛояльностиПоставщикДанныхУНФ.ПолучитьИспользованныеПромокоды(Документ, МассивПромокодов); // НЕ БСЛ
...
//  СтруктураОтвета	 - Структура - параметры ответа сервера лояльности.
//
...
//
// Параметры:
//  ПараметрыРасчета - Структура - параметры расчета списка серий.
...
Процедура ЗаполнитьНачисленияПоПодарочнымСертификатам(Объект, ТаблицаПодарочныхСертификатов) Экспорт
	СерверЛояльностиПоставщикДанныхУНФ.ЗаполнитьНачисленияПоПодарочнымСертификатам(Объект, ТаблицаПодарочныхСертификатов); // НЕ БСЛ
КонецПроцедуры
...
Процедура УстановитьСтатусПодарочного(ДанныеСертификата, Продан) Экспорт
	...
	СерверЛояльностиПоставщикДанныхУНФ.УстановитьСтатусПодарочного(ДанныеСертификата, Продан); // НЕ БСЛ
...
Процедура ВыделитьСертификатыСКонтролемОрганизации(МассивСертификаторв, Результат) Экспорт
	...
	Результат = СерверЛояльностиПоставщикДанныхУНФ.ВыделитьСертификатыСКонтролемОрганизации(МассивСертификаторв); // НЕ БСЛ
...
Процедура ЗаполнитьПризнакКонтроляОрганизацийПодарочногоСертификата(ПодарочныйСертификат, Результат) Экспорт
	СерверЛояльностиПоставщикДанныхУНФ.ЗаполнитьПризнакКонтроляОрганизацийПодарочногоСертификата(ПодарочныйСертификат, Результат); // НЕ БСЛ
КонецПроцедуры
#КонецОбласти

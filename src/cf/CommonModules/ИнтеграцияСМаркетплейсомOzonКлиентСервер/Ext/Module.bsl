...
//  Массив Из ПеречислениеСсылка.ТипыНоменклатуры - состоит из элементов типа ПеречислениеСсылка.ТипыНоменклатуры.
//
...
Функция ВариантЗагрузкиЗагрузитьНесопоставленныеКарточкиТоваровПоИдентификаторам() Экспорт
	Возврат 3;
КонецФункции
...
Функция МаксимальныйРазмерПорцииЗагрузкиДанных() Экспорт
	Возврат 100000;
КонецФункции
...
Функция ПараметрыИмпортаДляДетальнойЗагрузки() Экспорт
	...
	Параметры.Вставить( "ИдентификаторыТоваровДляИмпорта", Неопределено );
	Параметры.Вставить( "ИмяИдентификатора", "ИдентификаторОбъектаМаркетплейса" );

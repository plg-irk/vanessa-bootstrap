...
Функция ДополнительныеДанныеЗапросаТСПИоТ(ПараметрыСканирования) Экспорт
	...
	ДанныеКлиента.Вставить("ИдентификаторКассовогоПО", Строка(ОбщегоНазначенияКлиентСервер.ПустойУникальныйИдентификатор())); // Идентификатор ПМСР (кассового ПО) в реестре ГИС МТ

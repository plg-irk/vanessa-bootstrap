...
//
// Параметры:
//  Наименование				 - Строка - ФИО создаваемого физ. лица
...
Процедура СоздатьФизЛицоПоФИОиИНН(Наименование, ИНН, ФизЛицоРезультат) Экспорт
	...
	ФизЛицоРезультат = НовоеФизическоеЛицо.Ссылка;

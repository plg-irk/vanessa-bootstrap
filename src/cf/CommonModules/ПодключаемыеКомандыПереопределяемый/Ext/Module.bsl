...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	ОнлайнОплатыУНФ.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники,
		ПодключенныеОтчетыИОбработки, Команды);
		
	ОнлайнЗаказыУНФ.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники,
		ПодключенныеОтчетыИОбработки, Команды);
	...
	Видеовстречи.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки,
		Команды);
	...
	ПодключаемыеКомандыУНФ.ИзменитьСвойствоКоманды(Команды, "Вид", "СБП", "СБП", "ДляОбъекта",
		"Отправить");
	ПодключаемыеКомандыУНФ.ИзменитьСвойствоКоманды(Команды, "Вид", "ЮКасса", "ЮКасса", "ДляОбъекта",
		"Отправить");
	ПодключаемыеКомандыУНФ.ИзменитьСвойствоКоманды(Команды, "Вид", "ОнлайнЗаказы", "ОнлайнЗаказы", "ДляОбъекта",
		"Отправить");
		
	ПодключаемыеКомандыУНФ.ИзменитьСвойствоКоманды(Команды, "Порядок", "Отправить", "ОнлайнЗаказы", "ДляОбъекта",
		140);
	ПодключаемыеКомандыУНФ.ИзменитьСвойствоКоманды(Команды, "Порядок", "Отправить", "СБП", "ДляОбъекта",
		160);
	ПодключаемыеКомандыУНФ.ИзменитьСвойствоКоманды(Команды, "Порядок", "Отправить", "ЮКасса", "ДляОбъекта",
		170);

...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел = Разделы.Добавить();
	Раздел.Имя  = "КассоваяСмена";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("c860a33b-1ba6-4829-8b97-7442c3178f66");
	Раздел.Представление = НСтр("ru = 'Кассовая смена'");
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.КассыККМ"));
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДокументыСПолемОрганизация.Добавить("Документ.ВыплатыСамозанятым");
	ДокументыСПолемОрганизация.Добавить("Документ.РасходыПредпринимателя");
	ДокументыСПолемОрганизация.Добавить("Документ.РасходыНаОнлайнКассыУменьшающиеНалоги");
	...
	// Кассовые смены
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ОтчетОРозничныхПродажах", "Дата", "КассоваяСмена",
		"КассаККМ");
...
Процедура ПередПроверкойСтаройВерсииДанных(ОбъектМетаданных, ИдентификаторДанных, УзелПроверкиЗапретаЗагрузки, ДанныеДляПроверки) Экспорт
	...
	ЭтоЗаказНаряд		= РаботаСЗаявкамиКлиентСервер.ЭтоТипЗаказНаряда(Данные.ВидОперации);

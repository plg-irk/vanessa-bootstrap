...
Функция ЗарегистрироватьНовыеСобытияКалендаряОтчетностиКИсполнению(Организация = Неопределено) Экспорт
    ...
    |                       И ГОД(КалендарьПодготовкиОтчетности.СобытиеКалендаря.ДатаОкончанияСобытия) >= 2025
    |                   ТОГДА ВЫБОР
    ...
    |                   ИЛИ КалендарьПодготовкиОтчетности.СобытиеКалендаря.Задача В (&МассивЗадачВзносыИП)
    |                       И ГОД(КалендарьПодготовкиОтчетности.СобытиеКалендаря.ДатаОкончанияСобытия) >= 2025
    |                       И НЕ КалендарьПодготовкиОтчетности.СобытиеКалендаря.УпрощенныйЗачетФиксированныхВзносов)

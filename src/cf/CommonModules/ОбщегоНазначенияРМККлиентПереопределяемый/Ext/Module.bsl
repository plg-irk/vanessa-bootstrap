...
Процедура ДополнитьПараметрыОткрытияФормыВыбораСкладЯчейка(Форма, ПараметрыОткрытия) Экспорт
	...
	ОбщегоНазначенияРМКУНФКлиент.ДополнитьПараметрыОткрытияФормыВыбораСкладЯчейка(Форма, ПараметрыОткрытия);
...
Процедура ЗафиксироватьВыборСкладаЯчейки(Форма, ПереопределенВыбор) Экспорт
	...
	ОбщегоНазначенияРМКУНФКлиент.ЗафиксироватьВыборСкладаЯчейки(Форма, ПереопределенВыбор);
...
Процедура БутылкиЕГАИС(Форма, ОповещениеОЗавершении) Экспорт
	ОбщегоНазначенияРМКУНФКлиент.БутылкиЕГАИС(Форма, ОповещениеОЗавершении);
КонецПроцедуры
...
// Переопределяет имена реквизитов формы для формирования структуры реквизитов аналогичной форме авторизации.
// Структура требуется для обработки поиска кассира.
//
// Параметры:
//  ИменаРеквизитов - Строка - Имена реквизитов через запятую.
//
Процедура ДополнитьИменаРеквизитовФормыАвторизацииРМК(ИменаРеквизитов) Экспорт
	

	
КонецПроцедуры

// Заполняет дополнительные параметры для проверки наличия кода авторизации у кассира.
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма авторизации РМК,
//  ДополнительныеПараметры - Структура - дополнительные параметры.
//
Процедура ЗаполнитьДополнительныеПараметрыПроверкиКодаАвторизаци(Форма, ДополнительныеПараметры) Экспорт
...
Процедура ОткрытьФормуСозданияКодаДоступа(СтруктураСозданияКода) Экспорт
	...
	ОбщегоНазначенияРМКУНФКлиент.ОткрытьФормуСозданияКодаДоступа(СтруктураСозданияКода);
...
// Определяет существование подсистемы ГосИС
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма рабочего места кассира.
//  Результат - Булево - подсистема существует.
//
...
//  ККТ - Спарвочник.ПодключаемоеОборудование - ККТ
//  УникальныйИдентификатор - УникальныйИдентификатор - Уникальный идентификатор формы источника запроса
Процедура АктуализацияСпискаCDNПлощадок(Организация, НомерФискальногоНакопителя, ККТ, УникальныйИдентификатор) Экспорт
	
	ОбщегоНазначенияРМКУНФКлиент.АктуализацияСпискаCDNПлощадок(Организация, УникальныйИдентификатор);
	
КонецПроцедуры

// Запрашивает розничный токен для проверки марки
//
// Параметры:
//  Организация - ОпределяемыйТип.ОрганизацияРМК - Организация для получения цифровой подписи или токена
//  СтандартнаяОбработка - Булево - признак стандартной обработки события.
Процедура ЗапроситьКлючСессии(Организация, СтандартнаяОбработка) Экспорт
...
Процедура АвторизоватьТСПИоТ(ОповещениеПриЗавершении, ПаратмерыАвторизации, Форма) Экспорт
	...
	ОбщегоНазначенияРМКУНФКлиент.АвторизоватьТСПИоТ(ОповещениеПриЗавершении, ПаратмерыАвторизации, Форма);
...
Процедура ПолучитьСтатусТСПИоТ(ОповещениеПриЗавершении, ПаратмерыАвторизации, Форма) Экспорт
	...
	ОбщегоНазначенияРМКУНФКлиент.ПолучитьСтатусТСПИоТ(ОповещениеПриЗавершении, ПаратмерыАвторизации, Форма);
...
// Заполняет выполняемые операции проверки средствами ККТ
// 
// Параметры:
//  Результат - Структура - содержит строки операций
//  СтандартнаяОбработка - Булево - признак стандартной обработки события.
//
...
// Вызывает форму заполнения номенклатуры из справочника "Палитра Товаров" выбранным способом
//
// Параметры:
...
// Вызывает форму заполнения номенклатуры из справочника "Контроль Продаж" выбранным способом
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма элемента справочнимка "Контроль Продаж".
//  ИмяКоманды - Строка.
//
Процедура ЗаполнитьНоменклатуруВКонтролеПродаж(Форма, ИмяКоманды) Экспорт
...
// Выполняет завершающие действия после заполнения номенклатуры в ооставе контроля продаж выбранным способом
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма элемента справочнимка "Контроль Продаж".
//  ДанныеВыбора - Структура.
//  ИмяКоманды - Строка.
//
Процедура ОбработатьЗавершениеЗаполненияНоменклатурыВКонтролеПродаж(Форма, ДанныеВыбора, ИмяКоманды) Экспорт
...
//
// Параметры:
//  ОсобенностьУчета - ОпределяемыйТип.ОсобенностиУчетаНоменклатурыРМК - особенность учета для получения текстов
//  Результат - Соответствие
//
Процедура ТекстыОшибокКонтроляОстатковЧастичногоВыбытия(ОсобенностьУчета, Результат) Экспорт
	
	ОбщегоНазначенияРМКУНФКлиент.ТекстыОшибокКонтроляОстатковЧастичногоВыбытия(ОсобенностьУчета, Результат);
...
// Получает локальные данные карты лояльности
//
// Параметры:
//  ДисконтнаяКарта	 - ОпределяемыеТипы.ДисконтнаяКартаРМК - карта лояльности клиента.
//  ДанныеКарты		 - Структура - данные карты для заполнения.
//
Процедура ПолучитьДанныеКартыЛояльности(ДисконтнаяКарта, ДанныеКарты) Экспорт
...
// 
// Параметры:
//  Форма - ФормаКлиентскогоПриложение - форма рабочего места кассира.
...
Процедура ЗаполнитьДополнительныеПараметрыШаблонаЧека(Форма, ДополнительныеПараметрыШаблонаЧека) Экспорт
	ОбщегоНазначенияРМКУНФКлиент.ЗаполнитьДополнительныеПараметрыШаблонаЧека(Форма,
		ДополнительныеПараметрыШаблонаЧека);
КонецПроцедуры

// Заполняет представления номенклатуры и характеристики наименованием для печати.
//
// Параметры:
//  ПредставлениеНоменклатуры - Строка - Наименование для печати номенклатуры.
//  ПредставлениеХарактеристики - Строка - Наименование для печати характеристики.
//  Номенклатура - ОпределяемыйТип.НоменклатураРМК - Номенклатура.
//  Характеристика - ОпределяемыйТип.ХарактеристикаРМК - Характеристика номенклатуры.
//
Процедура ЗаполнитьПредставленияНоменклатурыИХарактеристики(ПредставлениеНоменклатуры, ПредставлениеХарактеристики,
	Номенклатура, Характеристика) Экспорт
	
	ОбщегоНазначенияРМКУНФВызовСервера.ЗаполнитьПредставленияНоменклатурыИХарактеристики(
		ПредставлениеНоменклатуры, ПредставлениеХарактеристики, Номенклатура, Характеристика);
...
Процедура ОткрытьФормуВыбораТорговогоОбъекта(Форма, СтандартнаяОбработка) Экспорт
	ОбщегоНазначенияРМКУНФКлиент.ОткрытьФормуВыбораТорговогоОбъекта(Форма, СтандартнаяОбработка);
КонецПроцедуры
#КонецОбласти

...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	ПечатьДокументовУНФ.ПриОпределенииНастроекПечати(Настройки);
...
Процедура ПередПечатью(Знач ИдентификаторПечатнойФормы, ОбъектыПечати, ПараметрыПечати) Экспорт 
	...
	ВыводитьФаксимиле = ПечатьДокументовУНФ.НастройкаПользователяЗаполнятьФаксимиле();
	ПараметрыПечати.Вставить("ПодписьИПечать", ВыводитьФаксимиле);
...
Процедура ПриПолученииПодписейИПечатей(Документы, ПодписиИПечати) Экспорт
	...
	ПечатьДокументовУНФ.ПриПолученииПодписейИПечатей(Документы, ПодписиИПечати);
...
Процедура ПечатьДокументовПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	ПечатьДокументовУНФ.ПечатьДокументовПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка);
...
Процедура ПечатьДокументовПриЗагрузкеДанныхИзНастроекНаСервере(Форма, Настройки) Экспорт
	...
	ПечатьДокументовУНФ.ПечатьДокументовПриЗагрузкеДанныхИзНастроекНаСервере(Форма, Настройки);
...
Процедура ПечатьДокументовПриСохраненииДанныхВНастройкахНаСервере(Форма, Настройки) Экспорт
	...
	ПечатьДокументовУНФ.ПечатьДокументовПриСохраненииДанныхВНастройкахНаСервере(Форма, Настройки);

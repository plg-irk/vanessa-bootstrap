...
Процедура ПриФормированииСпискаУслуг(ПоставщикиУслуг) Экспорт
	...
	УслугаРозница = Новый Структура;
	УслугаРозница.Вставить("Идентификатор", ИдентификаторУслугиРозница());
	УслугаРозница.Вставить("Наименование", НСтр("ru = 'Розница'"));
	УслугаРозница.Вставить("ТипУслуги", Перечисления.ТипыУслуг.Безлимитная);
	УслугиУНФ.Добавить(УслугаРозница);
	
	УслугаРозницаБазовая = Новый Структура;
	УслугаРозницаБазовая.Вставить("Идентификатор", ИдентификаторУслугиРозницаБазовая());
	УслугаРозницаБазовая.Вставить("Наименование", НСтр("ru = 'Розница (базовая)'"));
	УслугаРозницаБазовая.Вставить("ТипУслуги", Перечисления.ТипыУслуг.Безлимитная);
	УслугиУНФ.Добавить(УслугаРозницаБазовая);
	
	УслугаБизнес = Новый Структура;
	УслугаБизнес.Вставить("Идентификатор", ИдентификаторУслугиБизнес());
	УслугаБизнес.Вставить("Наименование", НСтр("ru = 'Бизнес'"));
	УслугаБизнес.Вставить("ТипУслуги", Перечисления.ТипыУслуг.Безлимитная);
	УслугиУНФ.Добавить(УслугаБизнес);
...
// Идентификатор услуги "РозницаБазовая"
// 
// Возвращаемое значение:
//  Строка
//
Функция ИдентификаторУслугиРозницаБазовая() Экспорт
...
Процедура ВыполнитьАктивациюЛицензииКоличествоКасс(ИмяЛицензии, ЛицензияАктивирована) Экспорт
	...
	Если ИзменитьОтключение Тогда
		...
		ЗаписьРегистра = РегистрыСведений.УдалитьНастройкиКассыШтрихМ.СоздатьМенеджерЗаписи();

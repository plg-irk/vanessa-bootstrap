...
// Проверить возможность создания по заказу покупателя.
// 
// Параметры:
//  ЗаказИлиЗаказы - Массив из ДокументСсылка.ЗаказПокупателя, ДокументСсылка.ЗаказПокупателя
//
Процедура ПроверитьВозможностьСозданияПоЗаказуПокупателя(ЗаказИлиЗаказы) Экспорт
	
	РаботаСЗаявками.ВызватьИсключениеЕслиЗаявка(ЗаказИлиЗаказы);

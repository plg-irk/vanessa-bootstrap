...
Процедура ПриОпределенииВидовПриложенийКонфигурации(ВидыПриложений) Экспорт
	...
	// Розница (базовая)
	НовыйВидПриложенияРозницаБазовая = ВидыПриложений.Добавить();
	НовыйВидПриложенияРозницаБазовая.Имя = "РозницаБазовая";
	НовыйВидПриложенияРозницаБазовая.Представление = НСтр("ru='Розница (базовая)'");
	
	УслугаВидаПриложенияРозницаБазовая = ВидыПриложенийСервер.НоваяУслуга();
	УслугаВидаПриложенияРозницаБазовая.ИдентификаторПоставщика = ТарификацияУНФ.ИдентификаторПоставщикаУНФ();
	УслугаВидаПриложенияРозницаБазовая.ИдентификаторУслуги = ТарификацияУНФ.ИдентификаторУслугиРозницаБазовая();
	НовыйВидПриложенияРозницаБазовая.Услуги.Добавить(УслугаВидаПриложенияРозницаБазовая);
	
	ДополнительныеСвойства = НовыйВидПриложенияРозницаБазовая.ДополнительныеСвойства;
	ДополнительныеСвойства.Вставить("ИмяМакетаРасширения", "ЗаставкаРозница");
	ДополнительныеСвойства.Вставить("ИдентификаторИнтернетПоддержки", "Retail");
	
	НовыйВидПриложенияРозницаБазовая.Процедура = "ВидыПриложенийУНФ.УстановитьВидПриложенияРозница";
...
Процедура ПриДобавленииОбработчиковПереходаВидовПриложений(Обработчики) Экспорт
	...
	ОбработчикПереходаРозницаБазоваяНаРозница = Обработчики.Добавить();
	ОбработчикПереходаРозницаБазоваяНаРозница.ИсходноеИмяВидаПриложения = "РозницаБазовая";
	ОбработчикПереходаРозницаБазоваяНаРозница.ИмяВидаПриложения = "Розница";
	ОбработчикПереходаРозницаБазоваяНаРозница.Процедура = "ВозможностиПриложения.ОбновлениеРозницыБазовойДоРозницы";
	
	ОбработчикПереходаРозницаБазоваяНаУНФ = Обработчики.Добавить();
	ОбработчикПереходаРозницаБазоваяНаУНФ.ИсходноеИмяВидаПриложения = "РозницаБазовая";
	ОбработчикПереходаРозницаБазоваяНаУНФ.ИмяВидаПриложения = ВидыПриложенийСервер.БазовыйВидПриложения().Имя;
	ОбработчикПереходаРозницаБазоваяНаУНФ.Процедура = "ВозможностиПриложения.ОбновлениеРозницыДоУНФ";

КонецПроцедуры

// См. ВидыПриложенийПереопределяемый.ПриУстановкеБазовогоВидаПриложения
// 
Процедура ПриУстановкеБазовогоВидаПриложения(РезультатОбработки) Экспорт
	
	Если ВозможностиПриложения.БазовыйВидПриложенияЭтоУНФ() Тогда
		ВозможностиПриложения.УстановитьВидПриложенияУНФ(РезультатОбработки);
	ИначеЕсли ВозможностиПриложения.БазовыйВидПриложенияЭтоРозница() Тогда
		ВозможностиПриложения.УстановитьВидПриложенияРозница(РезультатОбработки);
	Иначе
		ТекстОшибки = НСтр("ru='Неизвестен метод установки базового вида приложения для конфигурации %1'");
		ТекстОшибки = СтрШаблон(ТекстОшибки, Метаданные.Имя);
...
// Установлен режим запуска комбинированное приложение.
// 
// Возвращаемое значение:
//  Булево - Установлен режим запуска комбинированное приложение

...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	// Это Розница 3.0.
	// Удалим планы обмена неподдерживаемые в Рознице 3.0.
	Если ОбщегоНазначения.ДоступноИспользованиеРазделенныхДанных()
		И Не ОбщегоНазначенияУНФ.ЭтоУНФ() Тогда
		
		ПланыОбменаНеПоддерживаемыеВРознице = Новый Массив;
		ПланыОбменаНеПоддерживаемыеВРознице.Добавить(Метаданные.ПланыОбмена.ОбменРозницаУправлениеНебольшойФирмой);
		ПланыОбменаНеПоддерживаемыеВРознице.Добавить(Метаданные.ПланыОбмена.ОбменУправлениеНебольшойФирмойБухгалтерия30);
		
		ПланыОбменаПодсистемы = ОбщегоНазначенияКлиентСервер.РазностьМассивов(
			ПланыОбменаПодсистемы,
			ПланыОбменаНеПоддерживаемыеВРознице);
	КонецЕсли;

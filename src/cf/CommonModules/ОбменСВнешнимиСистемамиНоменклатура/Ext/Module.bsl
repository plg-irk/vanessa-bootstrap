...
Функция ТоварыСоздатьОписаниеТоваровНовый() Экспорт
	...
	ОписанияТоваров.Колонки.Добавить( "УдалитьОбувнаяПродукция" );
	...
	ОписанияТоваров.Колонки.Добавить( "УдалитьТабачнаяПродукция" );
	...
	ОписанияТоваров.Колонки.Добавить( "УдалитьШиныИПокрышки" );

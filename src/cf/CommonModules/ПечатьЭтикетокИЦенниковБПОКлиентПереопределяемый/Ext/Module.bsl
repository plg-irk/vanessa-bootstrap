...
Процедура УстановитьШтрихкодыНоменклатуры(Форма, Штрихкоды) Экспорт
	ПечатьДокументовУНФКлиент.УстановитьШтрихкодыНоменклатуры(Форма, Штрихкоды);
КонецПроцедуры
...
Процедура ТоварыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование, Форма) Экспорт
	...
	ПечатьДокументовУНФКлиент.ТоварыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование, Форма);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник, Форма) Экспорт
	...
	ПечатьДокументовУНФКлиент.ОбработкаОповещения(ИмяСобытия, Параметр, Источник, Форма);
	
КонецПроцедуры

// Переопределеяет обработку события НачалоВыбора элементов формы
// Параметры:
//  Элемент - ЭлементФормы - Элемент формы у которого произошло событие
//  ДанныеВыбора - СписокЗначений - В обработчике можно сформировать и передать в этом параметре данные для выбора
//
Процедура НачалоВыбора(Элемент, ДанныеВыбора) Экспорт

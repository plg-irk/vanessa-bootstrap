...
Функция ТипОтношенийСКонтрагентомПоВидуОперации(ВидОперации) Экспорт
	...
	ИначеЕсли ТипЗнч(ВидОперации) = Тип("ПеречислениеСсылка.ВидыОперацийПлатежноеПоручение") Тогда
		...
		ИначеЕсли ВидОперации = Перечисления.ВидыОперацийПлатежноеПоручение.ПрочиеРасчеты
			...
			ИЛИ ВидОперации = Перечисления.ВидыОперацийПлатежноеПоручение.ВыплатыСамозанятым
			ИЛИ ВидОперации = Перечисления.ВидыОперацийПлатежноеПоручение.ПеречислениеНалога Тогда
			Результат.ПрочиеОтношения = Истина;
		КонецЕсли;
	
	ИначеЕсли ТипЗнч(ВидОперации) = Тип("ПеречислениеСсылка.ВидыОперацийРасходДСПлан") Тогда
		
		Если ВидОперации = Перечисления.ВидыОперацийРасходДСПлан.Покупателю Тогда
			Результат.Покупатель = Истина;
		ИначеЕсли ВидОперации = Перечисления.ВидыОперацийРасходДСПлан.Поставщику Тогда
			Результат.Поставщик = Истина;
		ИначеЕсли ВидОперации = Перечисления.ВидыОперацийРасходДСПлан.ПрочиеРасчеты
			ИЛИ ВидОперации = Перечисления.ВидыОперацийРасходДСПлан.НаРасходы
			ИЛИ ВидОперации = Перечисления.ВидыОперацийРасходДСПлан.РасчетыПоКредитам
			ИЛИ ВидОперации = Перечисления.ВидыОперацийРасходДСПлан.Прочее
			ИЛИ ВидОперации = Перечисления.ВидыОперацийРасходДСПлан.Налоги Тогда
			Результат.ПрочиеОтношения = Истина;
		КонецЕсли;

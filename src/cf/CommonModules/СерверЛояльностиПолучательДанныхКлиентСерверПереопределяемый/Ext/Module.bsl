...
Процедура ЗаполнитьПараметрыЗапросаОбъединитьДисконтныеКарты(ПараметрыМетода, ЗначенияПараметровМетода) Экспорт
	...
	СерверЛояльностиПолучательДанныхКлиентСерверУНФ.ЗаполнитьПараметрыЗапросаОбъединитьДисконтныеКарты(ПараметрыМетода, ЗначенияПараметровМетода); // НЕ БСЛ
...
Процедура ЗаполнитьПараметрыЗапросаНачислитьБонусыКлиента(ПараметрыМетода, ЗначенияПараметровМетода) Экспорт
	...
	СерверЛояльностиПолучательДанныхКлиентСерверУНФ.ЗаполнитьПараметрыЗапросаНачислитьБонусыКлиента(ПараметрыМетода, ЗначенияПараметровМетода); // НЕ БСЛ
...
Процедура ЗаполнитьПараметрыЗапросаНачислитьПодарочныйСертификат(ПараметрыМетода, ЗначенияПараметровМетода) Экспорт
	...
	СерверЛояльностиПолучательДанныхКлиентСерверУНФ.ЗаполнитьПараметрыЗапросаНачислитьПодарочныйСертификат(ПараметрыМетода, ЗначенияПараметровМетода); // НЕ БСЛ

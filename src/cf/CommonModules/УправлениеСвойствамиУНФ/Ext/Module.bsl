...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Документ_ФормированиеЗаписейКнигиПродаж = Элементы.Добавить();
	Документ_ФормированиеЗаписейКнигиПродаж.ИмяПредопределенногоНабора = "Документ_ФормированиеЗаписейКнигиПродаж";
	Документ_ФормированиеЗаписейКнигиПродаж.Используется = Истина;
	Документ_ФормированиеЗаписейКнигиПродаж.Ссылка = Новый УникальныйИдентификатор("606052c9-3024-4194-8213-2865bc49c998");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_ФормированиеЗаписейКнигиПродаж, "Наименование",
		"ru = 'Формирование записей книги продаж'", КодыЯзыков); // @НСтр-1

	Документ_ФормированиеЗаписейКнигиПокупок = Элементы.Добавить();
	Документ_ФормированиеЗаписейКнигиПокупок.ИмяПредопределенногоНабора = "Документ_ФормированиеЗаписейКнигиПокупок";
	Документ_ФормированиеЗаписейКнигиПокупок.Используется = Истина;
	Документ_ФормированиеЗаписейКнигиПокупок.Ссылка = Новый УникальныйИдентификатор("ee940723-ae11-446a-b5c0-ff94f6dcdf75");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_ФормированиеЗаписейКнигиПокупок, "Наименование",
		"ru = 'Формирование записей книги покупок'", КодыЯзыков); // @НСтр-1

	Документ_ДокументРасчетовСКонтрагентом = Элементы.Добавить();
	Документ_ДокументРасчетовСКонтрагентом.ИмяПредопределенногоНабора = "Документ_ДокументРасчетовСКонтрагентом";
	Документ_ДокументРасчетовСКонтрагентом.Используется = Истина;
	Документ_ДокументРасчетовСКонтрагентом.Ссылка = Новый УникальныйИдентификатор("c40076ba-770a-4612-9330-c059db1bcccd");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_ДокументРасчетовСКонтрагентом, "Наименование",
		"ru = 'Документ расчетов с контрагентом'", КодыЯзыков); // @НСтр-1

	Документ_ОтражениеНДСКВычету = Элементы.Добавить();
	Документ_ОтражениеНДСКВычету.ИмяПредопределенногоНабора = "Документ_ОтражениеНДСКВычету";
	Документ_ОтражениеНДСКВычету.Используется = Истина;
	Документ_ОтражениеНДСКВычету.Ссылка = Новый УникальныйИдентификатор("0463dee5-cfaa-4b5a-87b5-83267a935d56");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_ОтражениеНДСКВычету, "Наименование",
		"ru = 'Документ расчетов с контрагентом'", КодыЯзыков); // @НСтр-1

	Документ_ЗаявлениеОВвозеТоваров = Элементы.Добавить();
	Документ_ЗаявлениеОВвозеТоваров.ИмяПредопределенногоНабора = "Документ_ЗаявлениеОВвозеТоваров";
	Документ_ЗаявлениеОВвозеТоваров.Используется = Истина;
	Документ_ЗаявлениеОВвозеТоваров.Ссылка = Новый УникальныйИдентификатор("1e22e38b-3fb9-45e7-b94b-62ecd1ad5f90");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_ЗаявлениеОВвозеТоваров, "Наименование",
		"ru = 'Заявление о ввозе товаров'", КодыЯзыков); // @НСтр-1

	Документ_ПодтверждениеНулевойСтавкиНДС = Элементы.Добавить();
	Документ_ПодтверждениеНулевойСтавкиНДС.ИмяПредопределенногоНабора = "Документ_ПодтверждениеНулевойСтавкиНДС";
	Документ_ПодтверждениеНулевойСтавкиНДС.Используется = Истина;
	Документ_ПодтверждениеНулевойСтавкиНДС.Ссылка = Новый УникальныйИдентификатор("117fc6be-2e6c-44f1-a276-0c24a8478b56");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_ПодтверждениеНулевойСтавкиНДС, "Наименование",
		"ru = 'Подтверждение нулевой ставки НДC'", КодыЯзыков); // @НСтр-1

	Документ_ПодтверждениеОплатыНДСВБюджет = Элементы.Добавить();
	Документ_ПодтверждениеОплатыНДСВБюджет.ИмяПредопределенногоНабора = "Документ_ПодтверждениеОплатыНДСВБюджет";
	Документ_ПодтверждениеОплатыНДСВБюджет.Используется = Истина;
	Документ_ПодтверждениеОплатыНДСВБюджет.Ссылка = Новый УникальныйИдентификатор("8b83a63e-93e8-4bc1-8445-4646f1903be9");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_ПодтверждениеОплатыНДСВБюджет, "Наименование",
		"ru = 'ППодтверждение оплаты НДС в бюджет'", КодыЯзыков); // @НСтр-1

	Документ_СписаниеНДС = Элементы.Добавить();
	Документ_СписаниеНДС.ИмяПредопределенногоНабора = "Документ_СписаниеНДС";
	Документ_СписаниеНДС.Используется = Истина;
	Документ_СписаниеНДС.Ссылка = Новый УникальныйИдентификатор("11aa7ee6-a2a1-4edf-bd44-d59e1626a3e1");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Документ_СписаниеНДС, "Наименование",
		"ru = 'Списание НДС'", КодыЯзыков); // @НСтр-1
КонецПроцедуры

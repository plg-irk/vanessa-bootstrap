...
// 
Функция ПроверитьВозраст(ЦифровойID, ТокенОрганизации) Экспорт
	...
	РезультатВызова = ВызватьHTTPМетод("GET", ПараметрыСоединения);
...
Функция ВызватьHTTPМетод(Метод, ПараметрыСоединения) Экспорт
	...
	Если ВызовНаСервере Тогда
		...
		Если Результат.Таймаут Тогда
			Результат = ВызватьHTTPМетодКлиент(Метод, ПараметрыСоединения);
		КонецЕсли;
	Иначе
		Результат = ВызватьHTTPМетодКлиент(Метод, ПараметрыСоединения);
		Если Результат.Таймаут Тогда
...
Функция ВызватьHTTPМетодКлиент(Метод, ПараметрыСоединения)
	...
	Если ПараметрыСоединения.Порт = 443 Тогда
		...
		Соединение = Новый HTTPСоединение(
			ПараметрыСоединения.Хост, ПараметрыСоединения.Порт, , , , ПараметрыСоединения.Таймаут, ЗащищенноеСоединение);
	Иначе
		Соединение = Новый HTTPСоединение(
			ПараметрыСоединения.Хост, ПараметрыСоединения.Порт, , , , ПараметрыСоединения.Таймаут);
	КонецЕсли;

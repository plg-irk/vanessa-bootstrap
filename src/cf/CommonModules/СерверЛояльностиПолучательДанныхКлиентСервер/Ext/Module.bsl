...
// Возвращаемое значение:
//  Структура:
//		*BatchUID - Строка - Уникальный идентификатор серии
//
...
// Возвращаемое значение:
//  Структура:
//		*Item - Структура - Номенклатура строки товаров 
//		*Variant - Структура - Характеристика строки товаров 

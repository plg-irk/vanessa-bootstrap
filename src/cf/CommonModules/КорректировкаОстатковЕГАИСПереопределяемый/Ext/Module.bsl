...
Процедура ПриФормированииЗапросаУчетныхОстатков(Запрос, ОрганизацияЕГАИС, ТолькоМаркируемая) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	МИНИМУМ(Т.Серия) КАК Серия
	|ПОМЕСТИТЬ ТипизацияСерий
	|ИЗ
	|	(ВЫБРАТЬ
	...
	|	
	|	ВЫБРАТЬ
	|		ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)) КАК Т
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ТипизацияСерий.Серия КАК Серия,
	...
	|	ТипизацияСерий КАК ТипизацияСерий
	|
	|СГРУППИРОВАТЬ ПО
	|	ЗапасыОстатки.Номенклатура,
	|	ЗапасыОстатки.Характеристика,
	|	ЗапасыОстатки.Номенклатура.ОбъемДАЛ,
	|	ТипизацияСерий.Серия";

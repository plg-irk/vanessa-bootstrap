...
Функция ЛогВыгрузитьЗапросом(УчетнаяЗапись, НачинаяСДаты = Неопределено) Экспорт
	...
	|ГДЕ
	|	ОбменСВнешнимиСистемамиЛогирование.УчетнаяЗапись = &УчетнаяЗапись
	|	И ОбменСВнешнимиСистемамиЛогирование.Дата >= &НачинаяСДаты
	|
	|УПОРЯДОЧИТЬ ПО
	|	Порядок УБЫВ";
	Запрос.УстановитьПараметр("УчетнаяЗапись", УчетнаяЗапись);
	...
	Иначе
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "И ОбменСВнешнимиСистемамиЛогирование.Дата >= &НачинаяСДаты", "");
	КонецЕсли;

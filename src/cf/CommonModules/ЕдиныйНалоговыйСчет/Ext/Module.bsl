...
// Создает таблицу движений по регистру КнигаУчетаДоходовИРасходов по движениям уже существующего документа
// Параметры:
//	Регистратор - ДокументСсылка - документ, движения которого необходимо обновить
//	РеквизитыШапки - Структура
//
// Возвращаемое значение:
//	- РегистрНакопленияНаборЗаписей.КнигаУчетаДоходовИРасходов
//

	...
	Если ОбъектМетаданныхФорма = Неопределено Тогда
		...
		Если ЧастиИмени.Количество() > 1 Тогда
			...
			Если ОбъектМетаданных <> Неопределено Тогда
				Если ЧастиИмени[0] = "Справочник" Тогда
					ОбъектМетаданныхФорма = ОбъектМетаданных.Формы.ФормаСписка;
				ИначеЕсли ЧастиИмени[0] = "Документ" Тогда
					ОбъектМетаданныхФорма = ОбъектМетаданных.Формы.ФормаСпискаДокументов;
				КонецЕсли;
				Если ОбъектМетаданныхФорма <> Неопределено Тогда

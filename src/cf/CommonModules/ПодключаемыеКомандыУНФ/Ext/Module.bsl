...
Функция ОписаниеОбъектовПодключаемыхКоманд() Экспорт
	...
	Результат.Документы.Добавить("ВыплатыСамозанятым");
	Результат.Документы.Добавить("РасходыПредпринимателя");
...
// Изменяет свойство команды согласно отбору по виду, идентификатору, назначению.
// 
// Параметры:
//  Команды - ТаблицаЗначений - Таблица команд
//  Свойство - Строка - Имя свойства
//  Вид - Строка - Вид команды
//  Идентификатор - Строка - Идентификатор команды
//  Назначение - Строка - Назначения команды
//  НовоеЗначение - Произвольный - Новое значение
Процедура ИзменитьСвойствоКоманды(Команды, Свойство, Вид, Идентификатор, Назначение, НовоеЗначение) Экспорт
	
	ПараметрыОтбора = Новый Структура("Вид, Идентификатор, Назначение", Вид, Идентификатор, Назначение);
	
	НайденныеСтроки = Команды.НайтиСтроки(ПараметрыОтбора);
	Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
		НайденнаяСтрока[Свойство] = НовоеЗначение;
	КонецЦикла;
		
КонецПроцедуры

// Осуществляет поиск команд с назначением "ДляОбъекта" и добавляет условие видимости согласно переданным параметрам.
// 
// Параметры:
//  Команды - ТаблицаЗначений - Таблица команд
//  Вид - Строка - Вид команды
//  Идентификатор - Строка - Идентификатор команды
//  РеквизитОбъекта - Строка - Реквизит объекта, влияющего на отображение
//  Значение - Строка - Значение реквизита объекта, влиющее на отображение
//  ВидСравнения - ВидСравненияКомпоновкиДанных - Вид сравнения
Процедура ДобавитьУсловиеВидимостиКомандыОбъекта(Команды, Вид, Идентификатор, РеквизитОбъекта, Значение,
	ВидСравнения) Экспорт
	
	Назначение = "ДляОбъекта";
	ПараметрыОтбора = Новый Структура("Вид, Идентификатор, Назначение", Вид, Идентификатор, Назначение);
	
	НайденныеКоманды = Команды.НайтиСтроки(ПараметрыОтбора);
	Для Каждого НайденнаяКоманда Из НайденныеКоманды Цикл
		ПодключаемыеКоманды.ДобавитьУсловиеВидимостиКоманды(НайденнаяКоманда, РеквизитОбъекта, Значение, ВидСравнения);
	КонецЦикла;

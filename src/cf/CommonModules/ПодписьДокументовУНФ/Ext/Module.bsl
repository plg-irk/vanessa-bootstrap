...
Функция ПолучитьЗначенияНастроекПользователя(Организация = Неопределено)
	...
	Результат = Новый Структура("ПодписьРуководителя, ПодписьГлавногоБухгалтера, ПодписьКладовщика, ПодписьМОЛ,
								|ПодписьКассира, ПодписьБухгалтера, ПодписьСтаршегоКассира");	
	Результат.ПодписьГлавногоБухгалтера = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьГлавногоБухгалтера", Организация);
	Результат.ПодписьРуководителя = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьРуководителя", Организация);
	Результат.ПодписьКладовщика = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьМОЛ", Организация);
	Результат.ПодписьМОЛ = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьМОЛ", Организация);
	Результат.ПодписьКассира = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьКассира", Организация);
	Результат.ПодписьБухгалтера = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьБухгалтера",
		Организация);
	Результат.ПодписьСтаршегоКассира = ПерсональныеНастройкиРУНФ.Прочитать("ПодписьСтаршегоКассира",
		Организация);

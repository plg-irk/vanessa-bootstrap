...
Процедура РассчитатьТорговыйСбор()
    ...
    Если Объект.КодОбъектаОсуществленияТорговли = "08"
        ...
        Объект.ИсчисленнаяСумма = Окр(Объект.СтавкаЗаКвМ * Объект.ПлощадьТорговогоЗала * Коэф); 
    ...
    ИначеЕсли Объект.КодОбъектаОсуществленияТорговли = "07" Тогда
        ...
        Объект.ИсчисленнаяСумма = Окр(ДанныеТарифа.СтавкаДо50квм * Коэф);
    ...
    Иначе
        ...
        Объект.СтавкаЗаОбъект = Окр(ДанныеТарифа.СтавкаДо50квм * Коэф);
        Объект.ИсчисленнаяСумма = Окр(ДанныеТарифа.СтавкаДо50квм * Коэф);
        Объект.СтавкаЗаКвМ = Окр(ДанныеТарифа.СтавкаБольше50квм * Коэф);
        ...
        Если Объект.ПлощадьТорговогоЗала > 50 И ТребуетсяПлощадьТороговогоЗала(Объект.КодОбъектаОсуществленияТорговли) Тогда
            ...
            СуммаСбораЗаПревышение50м2 = Окр(?(ПлощадьЗалаСвыше50м2 > 100, 100,
            ПлощадьЗалаСвыше50м2)*ДанныеТарифа.СтавкаБольше50квм * Коэф);
            
            СуммаСбораЗаПревышение150м2 = Окр(?(ПлощадьЗалаСвыше50м2 > 250, 150,
                Макс(0, (ПлощадьЗалаСвыше50м2- 100)))*ДанныеТарифа.СтавкаБольше150квм * Коэф);        
                
            СуммаСбораЗаПревышение300м2 = Окр(Макс(0, (ПлощадьЗалаСвыше50м2- 250)*ДанныеТарифа.СтавкаБольше300квм) * Коэф); 

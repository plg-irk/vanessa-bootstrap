...
Функция ОсновнаяКассаНачальногоЗаполнения() Экспорт
	...
	Возврат ПолучитьСсылку(Новый УникальныйИдентификатор("c5bb0ec3-a7db-44fe-9a44-23a5a69df5ca"));
	
КонецФункции

// Получить кассу с учетом прав доступа на уровне записей.
// 
// Параметры:
//  Касса - СправочникСсылка.Кассы
// 
// Возвращаемое значение:
//  Неопределено - Получить кассу с учетом прав доступа на уровне записей

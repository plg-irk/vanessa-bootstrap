...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьОтображениеПолейВводаПроцентаЗаОсобыеКлиматическиеУсловия(
		ЭтотОбъект,
		ТерриториальныеУсловияПФР.ТерриториальныеУсловияПФР,
		ТерриториальныеУсловияПФР.ПрименятьСевернуюНадбавку);
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьОтображениеПолейВводаПроцентаЗаОсобыеКлиматическиеУсловия(Форма, ТерриториальныеУсловия, ПрименятьСевернуюНадбавку) Экспорт
	
	ВидимостьТерриториальныеУсловияПФРПрименятьСевернуюНадбавку = ПрименятьСевернуюНадбавку
		И (ТерриториальныеУсловия = ПредопределенноеЗначение("Справочник.ТерриториальныеУсловияПФР.ОКУ")
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Видимость",
		ВидимостьТерриториальныеУсловияПФРПрименятьСевернуюНадбавку);

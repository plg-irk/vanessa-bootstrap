...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьПравоДобавленияНового Тогда
		...
		ДинамическиеСпискиУНФ.ВыделитьЖирнымОсновнойЭлемент(ПерсональныеНастройкиРУНФ.Прочитать("РабочийПрайсЛистОрганизации"), Список);
	Иначе
...
Процедура ИзменитьРабочийПрайсЛистОрганизации(РабочийПрайсЛистОрганизации)
	...
	Если РабочийПрайсЛистОрганизации = ПерсональныеНастройкиРУНФ.Прочитать("РабочийПрайсЛистОрганизации") Тогда
		
		Возврат;
		
	КонецЕсли;
	
	ПерсональныеНастройкиРУНФ.Установить(РабочийПрайсЛистОрганизации, "РабочийПрайсЛистОрганизации");

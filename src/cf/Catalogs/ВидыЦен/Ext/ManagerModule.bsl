...
// Возвращаемое значение:
//  СправочникСсылка.ВидыЦен - ссылка на вид цены
//	 
...
// Возвращаемое значение:
//  Результат - Массив - массив блокируемых реквизитов объекта
//
...
Функция ПолучитьПредставлениеСпособаРасчетаВидаЦены(ВидЦен) Экспорт
	...
	НайденныйТипВидаЦен = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВидЦен, "ТипВидаЦен");
	
	Если НайденныйТипВидаЦен = Перечисления.ТипыВидовЦен.ДинамическийПроцент Тогда
		
		Возврат СтрШаблон(НСтр("ru = 'Наценка %1%% на %2'"), ВидЦен.Процент, ВидЦен.БазовыйВидЦен);
		
	ИначеЕсли НайденныйТипВидаЦен = Перечисления.ТипыВидовЦен.ДинамическийФормула Тогда
	...
	ИначеЕсли НайденныйТипВидаЦен = Перечисления.ТипыВидовЦен.ПроизвольныйЗапрос Тогда
	...
	ИначеЕсли НайденныйТипВидаЦен = Перечисления.ТипыВидовЦен.Расширение Тогда

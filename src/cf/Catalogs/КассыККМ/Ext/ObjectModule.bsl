...
Процедура ЗаполнитьПоСтруктурнойЕдинице(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если НЕ ТипЗнч(ДанныеЗаполнения) = Тип("ФиксированныйМассив") Тогда
...
Процедура ПередЗаписью(Отказ)
	...
	Если ТипКассы = Перечисления.ТипыКассККМ.ККМED Тогда
		...
		ЗаполнятьОтветственногоВЧекеИзЗаказа	= Ложь;
...
Процедура ПередУдалением(Отказ)
	...
	Если Константы.УдалитьИспользоватьОбменСКассойMinikassir.Получить() Тогда

...
// 
// Возвращаемое значение:
//  СправочникСсылка.ГруппыДоступаКонтрагентов, Произвольный, Дата, Неопределено - Группа доступа по умолчанию
Функция ГруппаДоступаПоУмолчанию(Пользователь = Неопределено) Экспорт
	...
	ОсновнаяГруппаДоступа = ПерсональныеНастройкиРУНФ.Прочитать("ОсновнаяГруппаДоступаКонтрагентов", , Пользователь);

...
// Скопировать пачки прошлого периода.
// 
// Параметры:
...
// Создает массив пачек документов отчетности перс. учета
//
// Параметры:
//   Организация - СправочникСсылка.Организации
//   ОтчетныйПериод - Дата
//   МассивФизЛиц - Массив из СправочникСсылка.ФизическиеЛица
//   			  - Неопределено
//
// Возвращаемое значение:
//   Массив из ДокументСсылка
...
Функция МассивПачекПрошлогоПериода(Организация, ОтчетныйПериод, МассивФизЛиц = Неопределено) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ОписьПачекСЗВ_6ПачкиДокументов.ПачкаДокументов КАК ПачкаДокументов
	|ИЗ

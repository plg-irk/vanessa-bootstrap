...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ТребованияФНСКлиентСервер.ЭтоФормат_ON_DOCNPNO_1_886_00_05_03() Тогда
		
		Элементы.ЗагрузитьСкан.Заголовок = "Сканированные документы и PDF-файлы";
		Элементы.ВыбратьСканыИзПредыдущихОтветов.Заголовок = "Сканированные документ и PDF-файлы из предыдущих ответов";

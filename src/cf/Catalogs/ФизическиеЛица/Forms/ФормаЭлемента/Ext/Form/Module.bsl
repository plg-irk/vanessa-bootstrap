...
Процедура РедактироватьДокументыФизическогоЛица(Результат, ДополнительныеПараметры) Экспорт
	...
	ОткрытьФорму("РегистрСведений.ДокументыФизическихЛиц.Форма.ФормаЗаполненияСведений", ПараметрыФормы, , , , ,
...
Процедура ПолучитьАктуальныйДокументФизическогоЛица()
	...
	ЕстьПравоДоступа = ПравоДоступа("Редактирование", Метаданные.РегистрыСведений.ДокументыФизическихЛиц);

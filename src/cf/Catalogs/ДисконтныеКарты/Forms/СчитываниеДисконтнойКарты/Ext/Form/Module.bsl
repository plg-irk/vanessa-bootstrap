...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Параметры, "КомандаОплаты") Тогда
		КомандаОплаты = Параметры.КомандаОплаты;
	КонецЕсли;
...
Процедура Далее(Команда)
	...
	ИначеЕсли Элементы.Страницы.ТекущаяСтраница = Элементы.Страницы.ПодчиненныеЭлементы.ГруппаСозданиеДисконтнойКарты Тогда
		...
		Если ЗаписатьДисконтнуюКарту() Тогда
			...
			ДисконтныеКартыУНФВызовСервера.НачислитьБаллыПриРегистрациияКарты(Объект.Ссылка);
...
Процедура ОбработатьВыборДисконтнойКартыОбработчикОжидания()
	...
	ПараметрыЗакрытия.Вставить("ДисконтнаяКарта", ДисконтнаяКартаДляЗаполнения);
	ПараметрыЗакрытия.Вставить("СчитанаДисконтнаяКарта", Истина);
	ПараметрыЗакрытия.Вставить("КомандаОплаты", КомандаОплаты);
	Закрыть(ПараметрыЗакрытия);

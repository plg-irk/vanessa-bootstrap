...
//
// Возвращаемое значение:
//  Структура - имя настройки с видом цен, значение - структура с ключами:
...
Функция СтрокаИменНастроекУчетнойЗаписи()
	...
	+ "КонтрагентДляЗаполненияВЗаказы, ДоговорДляЗаполненияВЗаказы, ВидЗаказа, ЗаказСостояниеПоУмолчанию";

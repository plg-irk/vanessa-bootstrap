...
// Формирует структуру с параметрами создания элемента карточки на форме.
//
// Параметры:
//  ВидКарточки - ПеречислениеСсылка.ВидыКарточекАнализаБизнеса - вид карточки, для которой формируются параметры.
//
// Возвращаемое значение:
//  Структура - параметры элемента карточки, содержащая следующие ключи:
//   * ШаблонПутьКДанным - Строка - шаблон пути к данным элемента карточки.
//   * ПутьКДанным - Строка - путь к данным элемента карточки.
//   * Ширина - Число - ширина элемента карточки.
//   * Высота - Число - высота элемента карточки.
//   * Масштабировать - Булево - признак необходимости масштабирования элемента карточки.
//   * Масштаб - Число - масштаб элемента карточки.
//   * Действие - Строка - имя действия, вызываемого при нажатии на элемент карточки.
//   * ИмяЭлемента - Строка - имя элемента карточки.
//   * РодительЭлемента - Неопределено, ГруппаФормы - родительский элемент формы для элемента карточки.
//   * Видимость - Булево - признак видимости элемента карточки.
//
Функция СформироватьПараметрыЭлементаКарточки(ВидКарточки) Экспорт
	...
	ПараметрыЭлемента.Вставить("РодительЭлемента", Неопределено); // Тип: ГруппаФормы
...
//
// Параметры:
//     ВидСравнения - ПеречислениеСсылка.ВидСравненияЗначений
// Возвращаемое значение:
...
Процедура СформироватьТекстSVGСравнениеСоЗначением(ДанныеКарточки)
	...
	СтрокаЗначенияСравнения = СимволВидаСравнения(ДанныеКарточки.ВидСравненияЗначений);
...
Процедура ОбновитьПрогрессЦели(СтрокаSVG, ДанныеКарточки, ЭтоПредыдущийПериод = Ложь)
	...
	Иначе
		...
		Угол = УголВГрадусах * ЗначениеПи / 180;

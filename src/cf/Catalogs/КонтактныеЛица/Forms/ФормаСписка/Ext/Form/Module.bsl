...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Лид") И ЗначениеЗаполнено(Параметры.Отбор.Лид) Тогда
		
		ОтборПоКонтрагенту = Новый Структура("ПроверятьРЛС");
		СвязанныйКонтрагент = Справочники.Лиды.СвязанныйКонтрагент(Параметры.Отбор.Лид, ОтборПоКонтрагенту);
		Если ЗначениеЗаполнено(СвязанныйКонтрагент) И УправлениеДоступом.ЧтениеРазрешено(СвязанныйКонтрагент) Тогда
			Параметры.Отбор.Вставить("Контрагент", СвязанныйКонтрагент);
		КонецЕсли;
...
&НаКлиенте
Процедура РазвернутьОтборыНажатие(Элемент)

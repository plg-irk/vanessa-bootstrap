...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьПравоДобавленияНового Тогда
		...
		ДинамическиеСпискиУНФ.ВыделитьЖирнымОсновнойЭлемент(ПерсональныеНастройкиРУНФ.Прочитать("РабочийПрайсЛистКонтрагентов"), Список);
	Иначе
...
Процедура ИзменитьРабочийПрайсЛистКонтрагентов(РабочийПрайсЛистКонтрагентов)
	...
	Если РабочийПрайсЛистКонтрагентов = ПерсональныеНастройкиРУНФ.Прочитать(
		"РабочийПрайсЛистКонтрагентов") Тогда
		Возврат;
	КонецЕсли;
	
	ПерсональныеНастройкиРУНФ.Установить(РабочийПрайсЛистКонтрагентов, "РабочийПрайсЛистКонтрагентов");

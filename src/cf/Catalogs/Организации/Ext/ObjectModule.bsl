...
Процедура ПередЗаписью(Отказ)
	...
	Если ЮридическоеФизическоеЛицо = Перечисления.ЮридическоеФизическоеЛицо.ФизическоеЛицо
		И НЕ ЗначениеЗаполнено(КатегорияСтрахователяФизическогоЛица) Тогда
		КатегорияСтрахователяФизическогоЛица = Перечисления.КатегорииСтрахователейФизическихЛицСФР.ИП01;
	КонецЕсли;

...
Процедура ЗагрузитьКурсыВалют(Команда)
	...
	ОписаниеОповещениеПриЗавершении =
		Новый ОписаниеОповещения("ЗагрузкаКурсовВалютПриЗавершении", ЭтотОбъект);
	ОткрытьФорму("Обработка.ЗагрузкаКурсовВалют.Форма", ПараметрыФормы, , , , , ОписаниеОповещениеПриЗавершении);
...
Функция ЗагрузитьКурсыВалютВФонеНаСервере()
	...
	Результат = ДлительныеОперации.ВыполнитьВФоне("Обработки.ЗагрузкаКурсовВалют.ЗагрузитьАктуальныйКурс",
...
&НаКлиенте
Процедура ЗагрузкаКурсовВалютПриЗавершении(Результат, Параметры) Экспорт

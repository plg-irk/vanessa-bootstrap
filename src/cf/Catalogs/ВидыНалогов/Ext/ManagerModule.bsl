...
Функция СписокНалоговАгентскогоНДФЛ() Экспорт
	...
	СписокНалоговАгентскогоНДФЛ.Добавить(Справочники.ВидыНалогов.НДФЛДоходыРКИСН);
	СписокНалоговАгентскогоНДФЛ.Добавить(Справочники.ВидыНалогов.НДФЛДоходыРКИСНСвышеПредельнойВеличины);
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	ЭлементНДФЛДоходыРКИСН =  Элементы.Добавить();
	ЭлементНДФЛДоходыРКИСН.ИмяПредопределенныхДанных = "НДФЛДоходыРКИСН";
	ЭлементНДФЛДоходыРКИСН.Наименование = НСтр("ru = 'НДФЛ исчисленный налоговым агентом по РК и СН'",
		КодОсновногоЯзыка);
	ЭлементНДФЛДоходыРКИСН.Код = "00-000029";
	ЭлементНДФЛДоходыРКИСН.КодБК = "18210102210011000110";
	ЭлементНДФЛДоходыРКИСН.ВидНалога = Перечисления.ВидыНалогов.НДФЛ;
	ЗаполнитьСчетаУчета(ЭлементНДФЛДоходыРКИСН);
	ЗаполнитьИзКлассификатора(ЭлементНДФЛДоходыРКИСН); 
        
    // НДФЛ РН и КС 15% 

	ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины = Элементы.Добавить();
	ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины.ИмяПредопределенныхДанных = "НДФЛДоходыРКИСНСвышеПредельнойВеличины";
	ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины.Наименование = НСтр(
		"ru = 'НДФЛ исчисленный налоговым агентом по РК и СН (15%)'", КодОсновногоЯзыка);
	ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины.Код = "00-000030";
	ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины.КодБК = "18210102230011000110";
	ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины.ВидНалога = Перечисления.ВидыНалогов.НДФЛ;
	ЗаполнитьСчетаУчета(ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины);
	ЗаполнитьИзКлассификатора(ЭлементНДФЛДоходыРКИСНСвышеПредельнойВеличины); 

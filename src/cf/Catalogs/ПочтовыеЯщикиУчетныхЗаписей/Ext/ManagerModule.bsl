...
Функция ДанныеЗапросом(УчетнаяЗапись) Экспорт
	...
	Запрос.Текст = 
		...
		|	ПочтовыеЯщикиУчетныхЗаписей.Код КАК Код,
		|	ПочтовыеЯщикиУчетныхЗаписей.Наименование КАК Наименование,
		|	ПочтовыеЯщикиУчетныхЗаписей.НаименованиеНаСервере КАК НаименованиеНаСервере,
		|	ПочтовыеЯщикиУчетныхЗаписей.ПредопределеноПочтовымСервером КАК ПредопределеноПочтовымСервером,
		|	ПочтовыеЯщикиУчетныхЗаписей.ВидПапки КАК ВидПапки,
		|	ПочтовыеЯщикиУчетныхЗаписей.Синхронизировать КАК Синхронизировать,
		|	ПочтовыеЯщикиУчетныхЗаписей.Ответственный КАК Ответственный,
		|	ПочтовыеЯщикиУчетныхЗаписей.ВариантСостояния КАК ВариантСостояния,
		|	ПочтовыеЯщикиУчетныхЗаписей.Предопределенный КАК Предопределенный
		|ИЗ
		|	Справочник.ПочтовыеЯщикиУчетныхЗаписей КАК ПочтовыеЯщикиУчетныхЗаписей
		|ГДЕ

...
Процедура НастроитьЭлементыТекущейСтраницы()
	...
	Если ТекущаяСтраница = Элементы.УчетнаяЗаписьУспешноНастроена Тогда
		...
		КонецЕсли;
		СтатистикаПоПоказателямКлиентСервер.ДобавитьСобытие("НастройкаУчетнойЗаписиПочты.Успешно"); 
	Иначе
		Если ТекущаяСтраница = Элементы.НастройкаУчетнойЗаписи
			...
			СтатистикаПоПоказателямКлиентСервер.ДобавитьСобытие("НастройкаУчетнойЗаписиПочты.ОшибкаПроверки"); 

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// УНФ
	ЭлектроннаяПочтаУНФ.ПриСозданииНаСервереНаФормеУчетнойЗаписи(ЭтотОбъект);
	// Конец УНФ
...
// УНФ
&НаКлиенте
Процедура Подключаемый_ВключитьВыключитьЛог(Команда)
	ЭлектроннаяПочтаУНФКлиент.ВключитьВыключитьЛогНаФормеУчетнойЗаписи(Объект.Ссылка, ЭтотОбъект);
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ВыгрузитьДанныеДляТехподдержки(Команда)
	ЭлектроннаяПочтаУНФКлиент.ВыгрузитьДанныеДляТехподдержкиНаФормеУчетнойЗаписи(Объект.Ссылка);
КонецПроцедуры
// Конец УНФ

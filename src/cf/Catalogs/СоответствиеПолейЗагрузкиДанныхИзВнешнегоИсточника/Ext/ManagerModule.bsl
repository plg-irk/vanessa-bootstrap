...
Функция СтруктураПоискаСтрокОтчетСДетализациейWildberries() Экспорт
	...
	// по умолчанию
	Результат.Вставить("НомерКолонкиПоставка"			, 2);
	Результат.Вставить("НомерКолонкиТипДокумента"		, 10);
	Результат.Вставить("НомерКолонкиОбоснованияДляОплаты"	, 11);
	Результат.Вставить("НомерКолонкиСтрана"				, 51);
	Результат.Вставить("НомерКолонкиКоличество"			, 14);

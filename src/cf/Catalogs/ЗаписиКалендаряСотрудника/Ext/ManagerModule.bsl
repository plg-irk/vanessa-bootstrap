...
// Сохранить изменения записей календарей.
// 
// Параметры:
//  ОбрабатываемыеЭлементы - Массив из Структура
// 
...
Функция ОписаниеРасширенногоВводаЗаписей() Экспорт
	...
	ТипыЗаписей = ЗадачиСотрудника.ДоступныеТипыМенюСозданияСобытияКалендаря();
...
// Возвращает Объект справочника ЗаписиКалендаря по идентификатору.
// 
// Параметры:
...
// 
// Возвращаемое значение:
//  СправочникОбъект.ЗаписиКалендаряСотрудника - Объект идентификатора
Функция ОбъектПоИдентификатору(Идентификатор, Календарь) Экспорт
	...
	Запрос.УстановитьПараметр("Ключ",
		ОбменСGoogle.КлючИзИдентификатора(Идентификатор, ТипЗнч(Справочники.ЗаписиКалендаряСотрудника)));
...
// Состав полей заполнения для рабочего процесса.
// 
// Параметры:

...
Процедура ПодменитьОбъектНаСервере(НовыйКалендарь)
	...
	СохраняемыеСвойства = Новый Структура;
	СохраняемыеСвойства.Вставить("Наименование",         Объект.Наименование);
	СохраняемыеСвойства.Вставить("Начало",               Объект.Начало);
	СохраняемыеСвойства.Вставить("Окончание",            Объект.Окончание);
	СохраняемыеСвойства.Вставить("Описание",             Объект.Описание);
	СохраняемыеСвойства.Вставить("Источник",             Объект.Источник);
	СохраняемыеСвойства.Вставить("НомерСтрокиИсточника", Объект.НомерСтрокиИсточника);

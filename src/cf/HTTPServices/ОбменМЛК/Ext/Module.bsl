...
Функция СоздатьЗаказ(СтруктураЗапроса)
	...
	НовыйОбъект.СтруктурнаяЕдиницаПродажи = ?(ЗначениеЗаполнено(НовыйОбъект.СтруктурнаяЕдиницаПродажи),
		НовыйОбъект.СтруктурнаяЕдиницаПродажи, Справочники.СтруктурныеЕдиницы.ОсновноеПодразделение);

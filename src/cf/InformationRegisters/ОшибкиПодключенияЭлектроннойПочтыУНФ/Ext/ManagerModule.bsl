...
Функция ДанныеЗапросом(УчетнаяЗапись) Экспорт
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ОшибкиПодключенияЭлектроннойПочтыУНФ.ДатаОшибки КАК ДатаОшибки,
		|	ОшибкиПодключенияЭлектроннойПочтыУНФ.ПодробноеПредставлениеОшибки КАК ПодробноеПредставлениеОшибки
		|ИЗ
		|	РегистрСведений.ОшибкиПодключенияЭлектроннойПочтыУНФ КАК ОшибкиПодключенияЭлектроннойПочтыУНФ
		|ГДЕ
		|	ОшибкиПодключенияЭлектроннойПочтыУНФ.УчетнаяЗапись = &УчетнаяЗапись";

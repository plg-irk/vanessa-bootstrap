...
Процедура ЗагрузитьСнова(Команда)
	...
	ПараметрыОткрытия.Вставить("АдресФайлаКОбработке", АдресФайлаКОбработке);
	ПараметрыОткрытия.Вставить("БанковскийСчет", Параметры.БанковскийСчет);
	ПараметрыОткрытия.Вставить("Организация", Параметры.Организация);
	ПараметрыОткрытия.Вставить("Период", Параметры.Период);

...
Процедура ПротоколОбмена(Команда)
	ОткрытьФорму("РегистрСведений.УдалитьНастройкиКассыШтрихМ.Форма.ФормаПротокола",Новый Структура("Касса", Запись.КассаККМ));
КонецПроцедуры
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	МенеджерЗаписи = РегистрыСведений.УдалитьНастройкиКассыШтрихМ.СоздатьМенеджерЗаписи();

	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Если ПакетныйРежим Тогда
			...
			Попытка
				...
				ЭлементБлокировки.ИспользоватьИзИсточникаДанных("ДатаВремяОперации", "ДатаВремяОперации");
				ЭлементБлокировки.ИспользоватьИзИсточникаДанных("РабочееМесто", "РабочееМесто");
				БлокировкаЖурналаДействий.Заблокировать();
				
				НаборЗаписей = РегистрыСведений.ЖурналДействийКассира.СоздатьНаборЗаписей();

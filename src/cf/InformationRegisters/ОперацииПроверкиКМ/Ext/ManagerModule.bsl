	...
	Для Каждого РезультатПроверки Из РезультатыПроверки Цикл
		...
		Если ЗапросКМ.ЗапросРазрешенияПродажиКМ Тогда
			...
			Если Результат.ЕстьКриптоХвост Тогда
				...
				КонецЕсли;
			КонецЕсли;
			ТекстЗапросаРазрешения = ОбщегоНазначенияБПО.УдалитьНедопустимыеСимволыXML(ТекстЗапросаРазрешения);
			...
			Если Результат.ЕстьКриптоХвост Тогда
				...
				КонецЕсли;
			КонецЕсли;
			РезультатЗапросаРазрешения = ОбщегоНазначенияБПО.УдалитьНедопустимыеСимволыXML(РезультатЗапросаРазрешения);

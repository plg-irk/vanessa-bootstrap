...
Функция ДанныеЗапросом(УчетнаяЗапись) Экспорт
	...
	Запрос.Текст = 
		...
		|	ДействияСПисьмами.Действие КАК Действие,
		|	ДействияСПисьмами.ПочтовыйЯщик КАК ПочтовыйЯщик,
		|	ДействияСПисьмами.СтарыйПочтовыйЯщик КАК СтарыйПочтовыйЯщик,
		|	ДействияСПисьмами.НовыйПочтовыйЯщик КАК НовыйПочтовыйЯщик
		|ИЗ
		|	РегистрСведений.ДействияСПисьмами КАК ДействияСПисьмами
		|ГДЕ
		|	ДействияСПисьмами.УчетнаяЗапись = &УчетнаяЗапись";

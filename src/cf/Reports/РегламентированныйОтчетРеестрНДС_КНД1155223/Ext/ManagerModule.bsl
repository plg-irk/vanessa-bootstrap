...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Утверждена приказом ФНС России от 15.11.2024 № ЕД-7-15/1034@.";
	НоваяФорма.РедакцияФормы      = "от 15.11.2024 № ЕД-7-15/1034@.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1155223", '2024-11-15', "ЕД-7-15/1034@", "ФормаОтчета2025Кв1");

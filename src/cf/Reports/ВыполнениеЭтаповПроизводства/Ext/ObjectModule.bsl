...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ВыполнениеЭтапов"].Теги = Нстр("ru = 'Производство,Продукция'");
	НастройкиВариантов["ВыполнениеЭтапов"].Вставить("ИмяМакетаОбразца", "ОбразецВыполнениеЭтапов");
	
	НастройкиВариантов["ВыпускПродукцииПоЭтапам"].Теги = Нстр("ru = 'Производство,Продукция'");
	НастройкиВариантов["ВыпускПродукцииПоЭтапам"].Вставить("ИмяМакетаОбразца", "ОбразецВыпускПродукцииПоЭтапам");

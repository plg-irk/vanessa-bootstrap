...
//
// Параметры:
//  НастройкиОтчета		 - Структура - Настройки отчета, подробнее см. ОтчетыУНФ.ИнициализироватьНастройкиОтчета 
//  НастройкиВариантов	 - Структура - Настройки варианта отчета, подробнее см. ОтчетыУНФ.ИнициализироватьНастройкиВарианта:
//  * Основной - Структура - Настройки основного варианта
//
...
Функция ИнициализироватьДанныеОтчета()
	...
	// Структура для хранения данных отчета
	ДанныеОтчета = Новый Структура;
	ДанныеОтчета.Вставить("ВидОтчетаОтбор", Неопределено);
	ДанныеОтчета.Вставить("ПериодОтчета", Неопределено);
	ДанныеОтчета.Вставить("ПланФакт", Неопределено);
	ДанныеОтчета.Вставить("Периодичность", Неопределено);
	ДанныеОтчета.Вставить("СценарийПланирования", Неопределено);
...
Процедура ИнициализироватьДеревьяОтчета(ДанныеОтчета)
	...
	Для каждого ИмяДерева Из МассивИменДеревьев Цикл
		...
		Дерево.Колонки.Добавить("ЭтоПроцент", Новый ОписаниеТипов("Булево"));
		Дерево.Колонки.Добавить("НеИспользоватьВИтогах", Новый ОписаниеТипов("Булево"));

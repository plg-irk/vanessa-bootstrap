...
// Настраивает варианты отчета для отчета "АнализБизнеса".
//
// Параметры:
...
//
// Параметры:
//  Объект - ОтчетОбъект.АнализБизнеса - объект отчета, настройки которого необходимо сохранить.
...
//
// Параметры:
//  Объект - ОтчетОбъект.АнализБизнеса - объект отчета, настройки которого необходимо восстановить.
...
Процедура ВосстановитьНастройкиОтборов(Объект, ДанныеМеток) Экспорт
	...
	// Обработка некорректной комбинациии настроек
	Если Объект.СценарийПланирования = Справочники.СценарииПланирования.Фактический Тогда
		Объект.ПланФакт = Перечисления.ПланФакт.Факт;
	КонецЕсли;
...
// Инициализирует пустую структуру с настройками формы.
//
//
// Возвращаемое значение:
//  Структура - структура с настройками формы, содержащая следующие ключи:
//   * АктивнаяГиперссылка - Строка - имя активной гиперссылки;
//   * ОтображатьПодсказкуПроверки - Булево - флаг отображения подсказки проверки;
//   * ОтображатьПодсказкуЦели - Булево - флаг отображения подсказки цели.
//
...
Процедура ВывестиОтчет(ДанныеОтчета, ДокументРезультат, Области)
	...
	Если ДанныеОтчета.ГруппировкаАнализаБизнеса <> Перечисления.ГруппировкаАнализаБизнеса.Показатели Тогда
		...
		ПакетЗапроса.КонтрольныеТочкиИтогов.Добавить("Аналитика");

...
Процедура РезультатОбработкиРасшифровки(ПараметрыРасшифровки, Отбор)
	...
	Если ПараметрыРасшифровки.ТипСчета = Перечисления.ТипыСчетов.ПрочиеРасходы Тогда
		Макет.Параметры.Найти("ТипСчета2").Значение = Перечисления.ТипыСчетов.ПроцентыПоКредитам;
	Иначе
		Макет.Параметры.Найти("ТипСчета2").Значение = ПараметрыРасшифровки.ТипСчета;
	КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УчетНДСПереопределяемый.ЗаполнитьСписокОрганизаций(Элементы.ПолеОрганизация, СоответствиеОрганизаций);
...
Процедура ПриОткрытии(Отказ)
	...
	УчетНДСКлиентПереопределяемый.ПриОткрытии(ЭтаФорма, Отказ);
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	УчетНДСКлиентПереопределяемый.ПередЗакрытием(ЭтаФорма, Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка);
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	УчетНДСКлиентПереопределяемый.ПриЗакрытии(ЭтотОбъект, ЗавершениеРаботы);
...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(Настройки)
	...
	ОтчетыУНФ.ПеренестиПараметрыЗаголовкаВНастройки(Отчет.КомпоновщикНастроек.Настройки, Настройки);
...
Процедура ПолеОрганизацияПриИзменении(Элемент)
	...
	УчетНДСКлиентПереопределяемый.ОбработкаОтменыВыбораОрганизации(
		ПолеОрганизация,
		Отчет.Организация,
...
Процедура ПолеОрганизацияОткрытие(Элемент, СтандартнаяОбработка)
	...
	УчетНДСКлиентПереопределяемый.ПолеОрганизацияОткрытиеКлиент(Элемент, СтандартнаяОбработка,
...
Процедура ПолеОрганизацияОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	УчетНДСКлиентПереопределяемый.ПолеОрганизацияОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка, 
...
Процедура СохранитьКак(Команда)
	...
	УчетНДСКлиентПереопределяемый.ОтчетСохранитьКак(ЭтотОбъект); 
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru='Книга продаж'")
					+ РегламентированнаяОтчетностьУСНКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода,
																				 Отчет.КонецПериода);

	Если ЗначениеЗаполнено(Отчет.Организация) И Форма.ИспользуетсяНесколькоОрганизаций Тогда
		ЗаголовокОтчета = ЗаголовокОтчета + " " + РегламентированнаяОтчетностьУСНВызовСервера.ПолучитьТекстОрганизация(Отчет.Организация, Отчет.ВключатьОбособленныеПодразделения);
	КонецЕсли;
...
Функция СформироватьОтчетНаСервере()
    ...
    Иначе
        РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
            ...
            ПараметрыОтчета, 
            УчетНДСПереопределяемый.ПолучитьНаименованиеЗаданияВыполненияОтчета(ЭтаФорма));
...
Процедура ВычислитьСуммуВыделенныхЯчеекТабличногоДокументаВКонтекстеНаСервере()
	...
	ПолеСумма = УчетНДСПереопределяемый.ВычислитьСуммуВыделенныхЯчеекТабличногоДокумента(
...
Процедура Подключаемый_РезультатПриАктивизацииПодключаемый()
	...
	УчетНДСКлиентПереопределяемый.ВычислитьСуммуВыделенныхЯчеекТабличногоДокумента(

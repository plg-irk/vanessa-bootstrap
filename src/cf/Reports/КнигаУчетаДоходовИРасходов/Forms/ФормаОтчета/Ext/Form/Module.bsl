...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(Настройки)
	...
	НастройкиПриОткрытии = Новый Структура("Организация, НачалоПериода, КонецПериода");
	ЗаполнитьЗначенияСвойств(НастройкиПриОткрытии, Отчет);
	...
	Если СформироватьПриОткрытии Тогда
		ЗаполнитьЗначенияСвойств(Отчет, НастройкиПриОткрытии);
	КонецЕсли;
...
Процедура УстановитьНачальныеНастройки()
	...
	Иначе
		Отчет.Организация = ПерсональныеНастройкиРУНФ.Прочитать("ОсновнаяОрганизация");
		Если Не ЗначениеЗаполнено(Отчет.Организация) Тогда

...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	Если РазделениеВключено Тогда
		Если ДоступноИспользованиеРазделенныхДанных Тогда
			...
			СкрыватьБольшиеСинхронизации = ЭтоБизнесПриложение И ЭтоРозница;   
		Иначе
			СкрыватьБольшиеСинхронизации = Ложь;
		КонецЕсли;
	Иначе
		ЭтоРозница = Константы.ФункциональнаяОпцияУчетРозничныхПродаж.Получить();
		СкрыватьБольшиеСинхронизации = ЭтоБизнесПриложение И ЭтоРозница;   
	...
	Если ИдентификаторНастройки = "ОбменБП30" ИЛИ ИдентификаторНастройки = "ОбменУНФ_БП3" Тогда
		...
		ОписаниеВарианта.ИспользоватьПомощникСозданияОбменаДанными = Не СкрыватьБольшиеСинхронизации;

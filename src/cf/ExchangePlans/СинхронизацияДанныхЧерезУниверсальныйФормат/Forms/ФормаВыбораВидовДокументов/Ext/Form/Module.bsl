...
&НаСервере
Процедура ДобавитьСтрокуДереваВидовДокументов(ОбъектМетаданных, СтрокаВерхнегоУровня, Представление = "")
	...
	Если Представление <> "" Тогда
		СтрокаДетальныеЗаписи.Представление = Представление;
	Иначе
...
Процедура СформироватьДеревоВидовДокументов(МассивВыбранныхЗначений)
	...
	ДобавитьСтрокуДереваВидовДокументов(МетаДокументы.ЧекККМ, СтрокаВерхнегоУровня, "Чек ККМ (предоплата)");
	ДобавитьСтрокуДереваВидовДокументов(МетаДокументы.ЧекККМВозврат, СтрокаВерхнегоУровня, "Чек ККМ на возврат (предоплата)");
	...
	СтрокаВерхнегоУровня = ДеревоОтбора.Строки.Добавить();
	СтрокаВерхнегоУровня.Представление = "Склад";

...
Процедура ЗапуститьЗагрузку(Команда)
	...
	Если ЗагружатьЦены И НЕ ЗначениеЗаполнено(ДатаУстановкиЦен) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю("Обязательное поле ""Дата установки цен"".",,"ДатаУстановкиЦен",,Отказ);
	КонецЕсли;
	
	Если ЗагружатьЦены И НЕ ЗначениеЗаполнено(ВидЦеныНоменклатуры) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю("Обязательное поле ""Вид цены номенклатуры"".",,"ВидЦеныНоменклатуры",,Отказ);
	КонецЕсли;
	
	Если ЗагружатьОстатки И НЕ ЗначениеЗаполнено(ДатаЗагрузкиОстатков) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю("Обязательное поле ""Дата загрузки остатков"".",,"ДатаЗагрузкиОстатков",,Отказ);
	КонецЕсли;
	
	Если ЗагружатьОстатки И НЕ ЗначениеЗаполнено(Организация) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю("Обязательное поле ""Организация"".",,"Организация",,Отказ);
	КонецЕсли;
	
	Если ЗагружатьОстатки И НЕ ЗначениеЗаполнено(СкладДляПодстановкиВЗаказыИОстатков) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю("Обязательное поле ""Склад"".",,"СкладДляПодстановкиВЗаказыИОстатков",,Отказ);
	КонецЕсли;
...
Функция НаименованиеФоновойЗагрузки()

...
Процедура ДекорацияСписокВыбранныхГруппНажатие(Элемент)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ДекорацияСписокВыбранныхГруппНажатиеЗавершение" , ЭтотОбъект);
	...
	ОткрытьФорму("ПланОбмена.ИнтеграцияСМагазинамиСоцСетей.Форма.ФормаВыбораКатегорийВКонтакте", ПараметрыФормы, 
...
Процедура ДеревоТоваровНачалоПеретаскивания(Элемент, ПараметрыПеретаскивания, Выполнение)
	...
	Выполнение = Ложь;
	ОбщегоНазначенияКлиент.СообщитьПользователю("Выберите хотя бы 1 категорию Магазина ВКонтакте для выгрузки!",
	,"ДекорацияСписокВыбранныхГрупп","ЭтаФорма");
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыДеревоВыбранныхТоваров 
...
Процедура ЗаписатьИзмененияНаСервере()
	...
	НаборЗаписей = РегистрыСведений.НоменклатураХарактеристикДляМагазинаСоцСетей.СоздатьНаборЗаписей();
...
Процедура ОткрытьФормОшибок(ТекущиеДанные)
	...
	ОткрытьФорму("ПланОбмена.ИнтеграцияСМагазинамиСоцСетей.Форма.ФормаОшибок", ПараметрыФормы, ЭтотОбъект);

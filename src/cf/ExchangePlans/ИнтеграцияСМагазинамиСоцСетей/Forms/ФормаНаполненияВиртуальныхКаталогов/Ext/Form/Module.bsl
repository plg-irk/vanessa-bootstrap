...
#Область ОбработчикиСобытийЭлементовТаблицыФормыДеревоВиртуальныхКаталогов
...
Процедура ОткрытьПодборки(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ОткрытьПодборкиЗавершение", ЭтотОбъект);
	...
	ОткрытьФорму("Справочник.ВиртуальныеКаталогиТоваровМагазиновСоцСетей.Форма.ФормаСписка",ПараметрыФормы,
...
Процедура ЗаписатьИзмененияНаСервере()
	...
	НаборЗаписей = РегистрыСведений.НоменклатураХарактеристикДляМагазинаСоцСетейВиртуальныеКаталоги.СоздатьНаборЗаписей();
